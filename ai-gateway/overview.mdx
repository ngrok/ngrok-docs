...
The ngrok AI Gateway routes requests to AI providers like OpenAI and Anthropic. Get started with an API key from ngrok — no provider accounts needed. [Bring your own keys](/ai-gateway/bring-your-own-keys/overview) to access additional providers like Google, DeepSeek, and more.
...
<CardGroup cols={2}>
  ...
  <Card title="Automatic Failover" icon="rotate">
    If one provider fails, the gateway automatically tries another. Failover across models, providers, and API keys happens transparently.
  </Card>
  <Card title="Compatible With Popular SDKs" icon="plug">
    Works with official and third-party SDKs. Simply change the base URL and use your AI Gateway API Key.
  </Card>
  <Card title="Self-Hosted Models" icon="server">
    Route to local models like Ollama or vLLM alongside cloud providers using [Bring Your Own Keys](/ai-gateway/bring-your-own-keys/overview).
  </Card>
</CardGroup>
...
| **Self-hosted models** | Route to Ollama, vLLM, or other local inference servers (requires [BYOK](/ai-gateway/bring-your-own-keys/overview)) |
...
<CardGroup cols={2}>
  ...
  <Card title="Bring Your Own Keys" icon="key" href="/ai-gateway/bring-your-own-keys/overview">
