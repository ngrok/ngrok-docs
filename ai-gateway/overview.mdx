...
<Note>
AI Gateway is available on **Free** and **Pay-as-you-go** plans. **Hobbyist** plans cannot use AI Gateway. See [Credits](/ai-gateway/concepts/credits) for pricing details.
</Note>
