...
Point your SDK at `https://gateway.ngrok.ai` with an [access key](/ai-gateway/concepts/api-keys) from [app.ngrok.ai](https://app.ngrok.ai). OpenAI and Anthropic work without provider accounts—add [provider keys](/ai-gateway/guides/attaching-provider-keys) or [custom providers](/ai-gateway/concepts/custom-providers) for other models.
