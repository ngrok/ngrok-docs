...
When you [bring your own provider keys](/ai-gateway/concepts/bring-your-own-keys), you configure them in your Traffic Policy:
...
<CardGroup cols={2}>
  ...
  <Card title="Configuring Providers (BYOK)" icon="building" href="/ai-gateway/concepts/bring-your-own-keys">
