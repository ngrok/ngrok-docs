...
<CardGroup cols={2}>
  <Card
    title="Modifying Requests" icon="arrow-right-to-bracket" href="/ai-gateway/guides/modifying-requests" > {" "} Redact PII, inject prompts, add headers
  </Card>
  <Card
    title="Modifying Responses" icon="arrow-right-from-bracket" href="/ai-gateway/guides/modifying-responses" > {" "} Sanitize responses and streaming content
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card
    title="Configuring Providers" icon="building" href="/ai-gateway/guides/configuring-providers" > {" "} Set up providers and provider API keys
  </Card>
  <Card
    title="Model Selection Strategies" icon="route" href="/ai-gateway/guides/model-selection-strategies" > {" "} Define custom routing logic
  </Card>
</CardGroup>
