...
1. **Your app sends a request** with your [access key](/ai-gateway/concepts/api-keys) to `https://gateway.ngrok.ai`
...
| `my-provider:my-model` | Your [custom provider](/ai-gateway/concepts/custom-providers) |
...
See [Multi-key failover](/ai-gateway/guides/key-selection-failover).
...
<CardGroup cols={2}>
  ...
  <Card title="Model Selection" icon="route" href="/ai-gateway/guides/model-selection-strategies">
    Choose models and failover in requests
  </Card>
