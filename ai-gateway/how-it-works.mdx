...
<Note>
  Unknown models (not in the catalog) are automatically passed through if you
  include a known provider prefix. This lets you use new models immediately
  without waiting for catalog updates.
</Note>
...
<Tip>
  Use `ngrok/auto` as the model name to let your selection strategy choose
  entirely. See [Model Selection
  Strategies](/ai-gateway/guides/model-selection-strategies) for detailed
  examples.
</Tip>
...
<CardGroup cols={2}>
  <Card
    ...
    href="/ai-gateway/guides/modifying-requests"
  >
  ...
  <Card
    ...
    href="/ai-gateway/guides/modifying-responses"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="building"
    href="/ai-gateway/guides/configuring-providers"
  >
  ...
  <Card
    ...
    icon="route"
    href="/ai-gateway/guides/model-selection-strategies"
  >
