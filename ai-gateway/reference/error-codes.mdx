...
**Solutions**
- [Purchase additional credits](https://dashboard.ngrok.com/ai-gateways/credit/add) to restore access
...
**Solutions**
- [Purchase credits](https://dashboard.ngrok.com/ai-gateways/credit/add) (minimum $5.00)
...
**Causes**
- Your account is on the Hobbyist plan, which does not support AI Gateway API Keys
- The AI Gateway API Keys feature is not enabled for your account

**Solutions**
- Use a Free or Pay-as-you-go plan
...
- See [Creating Endpoints](/ai-gateway/guides/creating-endpoints) for setup instructions
