...
<ConfigField title="total_timeout" type="string" defaultValue="5m">
  <p>Maximum total time for all retry attempts across all providers and keys. Must be specified as a duration string (for example, <code>"2m"</code>, <code>"90s"</code>).</p>
