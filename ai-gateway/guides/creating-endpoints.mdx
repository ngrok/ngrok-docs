...
This guide shows how to create an AI Gateway endpoint manually. For the fastest setup, use the [dashboard quickstart](/ai-gateway/quickstart) instead.
...
2. Choose a URL for your endpoint (e.g., `https://your-ai-subdomain.ngrok.app`)
