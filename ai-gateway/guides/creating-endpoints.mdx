...
<Note>  After saving, your endpoint will appear in the [AI Gateways](https://dashboard.ngrok.com/ai-gateways) section of the dashboard since it uses the `ai-gateway` action.
...
<Tip>  Once you [configure server-side API keys](#configuring-server-side-api-keys), clients won't need to provide their own keys.
