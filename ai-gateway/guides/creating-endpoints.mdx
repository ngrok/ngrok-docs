...
Once your endpoint is created, test it with a simple request. Provide your [AI Gateway API Key](/ai-gateway/concepts/api-keys):
...
<Tip>
Create an [AI Gateway API Key](/ai-gateway/concepts/api-keys) to authenticate requests to your gateway.
</Tip>

## Using your own provider keys (BYOK)

If you prefer to manage your own provider API keys instead of using AI Gateway API Keys, you can configure them directly in your Traffic Policy. See [Bring Your Own Keys](/ai-gateway/bring-your-own-keys/overview) for details.
...
<Warning>
When you configure server-side API keys, your endpoint becomes publicly accessible. Anyone with the URL can make requests using your keys. See [Securing Endpoints (BYOK)](/ai-gateway/bring-your-own-keys/securing-endpoints) to add authorization.
</Warning>
...
- [Configuring Providers](/ai-gateway/bring-your-own-keys/configuring-providers) - Set up providers, models, and API keys
