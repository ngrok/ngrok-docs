...
## 1. Register your model with the gateway
...
<Tabs>
  ...
  <Tab title="Anything else">
    ...
    The gateway serves these endpoints, so tools that use the Responses API or the legacy completions endpoint work too:
