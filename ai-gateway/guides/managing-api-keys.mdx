...
<Warning>
  When you configure provider keys in the gateway, anyone with your endpoint URL can make requests using your provider keys.
...
**Key ordering matters**: Keys are tried in the order listed.
Place your highest-capacity keys first.
...
<Steps>
  ...
  <Step title="Deploy and monitor">
    ...
    Monitor traffic to ensure the new key works correctly.
  </Step>
