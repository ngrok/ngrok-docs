...
<Warning>
When you configure provider keys in the gateway, anyone with your endpoint URL can make requests using your provider keys. See [Securing Your Gateway](/ai-gateway/guides/securing-endpoints) to add authorization.
</Warning>
