...
<Prompt description="Test PII redaction — the provider should receive redacted values, not the originals: Summarize this: John's email is john@example.com and SSN is 123-45-6789" actions={["copy"]}>
