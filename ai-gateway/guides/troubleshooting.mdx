...
**Solutions**
- Purchase additional credits in the [ngrok dashboard](https://dashboard.ngrok.com/ai-gateways/credit/checkout)
...
**Solutions**
- Purchase credits in the [ngrok dashboard](https://dashboard.ngrok.com/ai-gateways/credit/checkout) (minimum $5.00)
