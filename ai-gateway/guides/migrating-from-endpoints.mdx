...
sidebarTitle: Migrating from endpoints
...
| Endpoint-bound gateway key | [Access key](/ai-gateway/concepts/api-keys) (account-scoped) |
...
<Steps>
  ...
  <Step title="Create access keys">
    Create an [access key](/ai-gateway/concepts/api-keys) for each client and assign the appropriate configuration.
  </Step>
