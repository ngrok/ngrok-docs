...
Create access keys with the [Access Keys API](/api-reference/access-keys/create). Authorize the request with your [AI Gateway API key](/ai-gateway/concepts/access-keys#credentials-overview).
...
Delete access keys with the [Access Keys API](/api-reference/access-keys/delete). Authorize the request with your [AI Gateway API key](/ai-gateway/concepts/access-keys#credentials-overview).
