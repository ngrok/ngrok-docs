...
The **Settings** page also shows the gateway URL (`https://gateway.ngrok.ai`) and lets you manage [AI Gateway API keys](/ai-gateway/concepts/api-keys#credentials-overview) for automation.
...
See the [Gateway configuration API reference](/api-reference/gateway-config/get).

## Next steps

- [How It Works](/ai-gateway/how-it-works): Request flow and failover
- [Configuring Providers](/ai-gateway/guides/configuring-providers): Built-in and custom providers
