...
Your application sends only an [access key](/ai-gateway/concepts/api-keys)—provider keys are stored in app.ngrok.ai and referenced by the configuration.
...
- [Provider Keys](/ai-gateway/guides/attaching-provider-keys): Store credentials
