...
<Steps>
  ...
  <Step title="Create the custom provider">
    Azure requires the deployment path and `api-version` in the base URL. See [Create a custom provider](/ai-gateway/concepts/custom-providers#create-a-custom-provider) with:
