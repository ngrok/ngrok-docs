...
The AI Gateway can route requests to any OpenAI-compatible endpoint beyond the [built-in providers](/ai-gateway/reference/model-catalog). This enables you to use self-hosted models, private deployments, or alternative AI services.
...
<CardGroup cols={2}>
  ...
  <Card title="Docker Model Runner" icon="server" href="/ai-gateway/custom-providers/docker-model-runner">
    Run models with Docker Model Runner (llama.cpp or vLLM engines)
  </Card>
</CardGroup>
