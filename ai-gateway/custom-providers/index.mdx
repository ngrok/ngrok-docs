...
The AI Gateway can route requests to any OpenAI or Anthropic Claude API endpoint beyond the [built-in providers](/ai-gateway/reference/model-catalog), including self-hosted models, private deployments, and alternative AI services.
