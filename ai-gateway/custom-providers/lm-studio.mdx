...
<Steps>
  ...
  <Step title="Create the custom provider">
    See [Create a custom provider](/ai-gateway/concepts/custom-providers#create-a-custom-provider). Use provider ID `lm-studio`, base URL `https://lm-studio.internal`, and your model IDs.
