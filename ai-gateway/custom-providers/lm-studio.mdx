...
[LM Studio](https://lmstudio.ai) is a desktop application for running large language models locally. It exposes an [OpenAI-compatible API](https://lmstudio.ai/docs/developer/openai-compat), so it works with the ngrok AI Gateway.
