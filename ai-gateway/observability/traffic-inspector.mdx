...
<Steps>
  <Step title="Open Dashboard Settings">Go to [ngrok Dashboard Settings](https://dashboard.ngrok.com/settings#observability)</Step>
  <Step title="Enable Full Capture Mode">Under **Observability**, enable **Full Capture Mode**</Step>
  <Step title="View Traffic">Access the [Traffic Inspector](https://dashboard.ngrok.com/observability/traffic-inspector) to see captured requests</Step>
</Steps>
...
<Warning>
  ...
  **Not currently available:**
  ...
  Email [niji@ngrok.ai](mailto:niji@ngrok.ai) to tell us what you'd like to see—your feedback directly influences our roadmap.
</Warning>
...
| Plan | Retention | | ---------- | --------- | | Free | 3 days | | Personal | 7 days | | Pro | 30 days | | Enterprise | 90 days |
