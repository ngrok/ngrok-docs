...
<Note>
  **Prerequisite**: You need an AI Gateway endpoint before using these SDK
  guides. Create one using the [dashboard quickstart](/ai-gateway/quickstart) or
  follow the [manual setup guide](/ai-gateway/guides/creating-endpoints).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card
    title="Anthropic SDK"
    icon="message-bot"
    href="/ai-gateway/sdks/anthropic"
  >
  ...
  <Card
    title="Vercel AI SDK"
    icon="triangle"
    href="/ai-gateway/sdks/vercel-ai-sdk"
  >
  ...
  <Card
    title="TanStack AI"
    icon="layer-group"
    href="/ai-gateway/sdks/tanstack-ai"
  >
