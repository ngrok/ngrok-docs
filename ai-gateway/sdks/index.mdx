...
<Note>
  **Prerequisite**: You need an AI Gateway endpoint before using these SDK guides.
...
<CardGroup cols={2}>
  ...
  <Card
    title="Anthropic SDK" icon="message-bot" href="/ai-gateway/sdks/anthropic" > {" "} Official SDKs for Python, TypeScript, Java, Go, Ruby, C#, and PHP
  </Card>
  <Card
    title="Vercel AI SDK" icon="triangle" href="/ai-gateway/sdks/vercel-ai-sdk" > {" "} Build AI apps with React, Next.js, and streaming
  </Card>
  <Card
    title="TanStack AI" icon="layer-group" href="/ai-gateway/sdks/tanstack-ai" > {" "} Type-safe AI library for React and Solid
  </Card>
...
| Feature | Supported | | --------------------- | ------------------------ | | Chat Completions API | ✅ | | Messages API | ✅ (for Anthropic SDKs) | | Responses API | ✅ | | Streaming | ✅ | | Function/tool calling | ✅ | | Embeddings | ✅ | | Async clients | ✅ | | Retries | ✅ (enhanced by gateway) |
