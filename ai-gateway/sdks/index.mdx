...
<Note>**Prerequisite**: You need an AI Gateway endpoint before using these SDK guides. Create one using the [dashboard quickstart](/ai-gateway/quickstart) or follow the [manual setup guide](/ai-gateway/guides/creating-endpoints).</Note>

The AI Gateway works with official and third-party SDKs.
Simply change the base URL configuration option for your SDK and you're connected.
