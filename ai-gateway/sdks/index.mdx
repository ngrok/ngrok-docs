...
description: Connect any OpenAI-compatible SDK to the ngrok AI Gateway.
---
...
The AI Gateway works with official and third-party SDKs. Just change the `baseURL` to your gateway endpoint and you're connected.
...
Point your SDK at your ngrok endpoint—just change the base URL:
...
client = anthropic.Anthropic(
    base_url="https://your-ai-subdomain.ngrok.app",
    api_key="your-api-key"
)
```
...
const client = new Anthropic({
  baseURL: "https://your-ai-subdomain.ngrok.app",
  apiKey: "your-api-key",
});
```
...
- [Other SDKs](/ai-gateway/sdks/other) - cURL, HTTP, any OpenAI-compatible client
