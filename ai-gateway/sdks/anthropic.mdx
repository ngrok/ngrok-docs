...
The AI Gateway is compatible with Anthropic's official SDKs. Set the base URL to `https://gateway.ngrok.ai` and authenticate with your [access key](/ai-gateway/concepts/api-keys).
...
Specify fallback models in the request body. See [Model selection](/ai-gateway/guides/model-selection-strategies).
