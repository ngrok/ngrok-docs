...
<Prompt description="Try this prompt to verify your gateway connection is working." actions={["copy", "cursor"]}>
  Hello! Can you confirm you're responding through the ngrok AI Gateway?
</Prompt>
...
<Prompt description="Try this streaming prompt — you should see the response appear word by word." actions={["copy", "cursor"]}>
...
<Prompt description="Test function calling — the model should call your tool to look up real-time data." actions={["copy", "cursor"]}>
