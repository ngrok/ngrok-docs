...
<Prompt description="Verify your gateway connection: State your exact model name and provider." actions={["copy", "cursor"]}>
...
<Prompt description="Test streaming — tokens should appear one by one: Write a haiku about APIs" actions={["copy", "cursor"]}>
...
<Prompt description="Test tool calling — your get_weather function should be invoked: What is the current weather in Paris?" actions={["copy", "cursor"]}>
