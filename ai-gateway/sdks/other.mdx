...
<Note>
**Prerequisite**: Complete the [Quickstart](/ai-gateway/quickstart) to get an [access key](/ai-gateway/concepts/api-keys). All requests go to `https://gateway.ngrok.ai`.
</Note>
...
Pass your [access key](/ai-gateway/concepts/api-keys) (`ng-xxxxx-g1-xxxxx`) as the API key. The AI Gateway injects upstream provider credentials from your [access key configuration](/ai-gateway/guides/access-key-configurations).
