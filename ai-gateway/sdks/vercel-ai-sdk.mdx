...
The [Vercel AI SDK](https://sdk.vercel.ai/) provides a unified interface for building AI applications. It works seamlessly with the ngrok AI Gateway, giving you provider failover, key rotation, and observability while using Vercel's powerful streaming and UI components.
