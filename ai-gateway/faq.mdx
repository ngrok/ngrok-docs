...
$5.00. Credits are purchased through the [ngrok dashboard](https://dashboard.ngrok.com/ai-gateways/credit/checkout).
...
**All** AI Gateway usage stops—both AI Gateway API Key requests and BYOK requests. Clients receive HTTP 403 with error [`ERR_NGROK_4026`](/errors/err_ngrok_4026). Purchase more credits to restore access.
