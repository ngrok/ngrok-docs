...
Prepaid balance that funds AI Gateway API Key usage. Credits cover both the processing fee and upstream provider costs. BYOK does not require credits — you pay providers directly. See [Credits](/ai-gateway/concepts/credits).
