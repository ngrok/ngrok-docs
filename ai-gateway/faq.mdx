...
Currently **OpenAI** and **Anthropic** are supported with ngrok-managed keys. For other providers (Google, DeepSeek, etc.), use [Bring Your Own Keys](/ai-gateway/bring-your-own-keys/overview).
