...
No. The AI Gateway is a routing and observability layer—you use your own API keys from providers like OpenAI, Anthropic, and Google. ngrok doesn't resell or provide AI provider access. You maintain your own provider accounts and billing relationships.
