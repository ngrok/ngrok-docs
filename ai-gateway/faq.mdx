...
<Note>
  Strategies control which models are considered, not failover order. For
  cross-provider failover when requests fail, have clients specify multiple
  models: `models: ["openai:gpt-4o", "anthropic:claude-3-5-sonnet-20241022"]`.
</Note>
