---
title: Securing Endpoints (BYOK)
description: Add authorization to your AI Gateway when managing your own provider API keys.
---

When using your own provider API keys (BYOK), you need to add your own authorization layer to prevent unauthorized access. If you're using [AI Gateway API Keys](/ai-gateway/concepts/api-keys), authorization is built-in — see [Securing Endpoints](/ai-gateway/guides/securing-endpoints).
...
- [Managing Provider Keys](/ai-gateway/bring-your-own-keys/managing-provider-keys) - Secure provider API key storage
