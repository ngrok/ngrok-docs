...
- **Type**: `array`
- **Optional**: Yes
- **Description**: List of API keys for this provider. See [Managing Provider Keys](/ai-gateway/bring-your-own-keys/managing-provider-keys).
...
- [Managing Provider Keys](/ai-gateway/bring-your-own-keys/managing-provider-keys) - Secrets and key rotation
- [Restricting Access](/ai-gateway/bring-your-own-keys/restricting-access) - Limit providers and models
- [Model Selection Strategies](/ai-gateway/bring-your-own-keys/model-selection-strategies) - Custom routing logic
