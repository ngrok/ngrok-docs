...
<Warning>
When you configure provider keys in the gateway, anyone with your endpoint URL can make requests using your provider keys. See [Securing Your Gateway](/ai-gateway/bring-your-own-keys/securing-endpoints) to add authorization.
</Warning>
...
- **Add authorization** to your gateway when using server-side keys—see [Securing Your Gateway](/ai-gateway/bring-your-own-keys/securing-endpoints)
...
- [Securing Your Gateway](/ai-gateway/bring-your-own-keys/securing-endpoints) - Add authorization when using server-side keys
- [BYOK Overview](/ai-gateway/bring-your-own-keys/overview) - Understanding Bring Your Own Keys
- [Key Selection & Failover](/ai-gateway/bring-your-own-keys/key-selection-failover) - Intelligent key selection with CEL expressions
- [Configuring Providers](/ai-gateway/bring-your-own-keys/configuring-providers) - Full provider setup
