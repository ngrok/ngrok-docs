...
Complete the ngrok AI Gateway SDK integration (I've already created the gateway, purchased credits, and have an API key):

1. Ask me for my AI Gateway endpoint URL and API key (format: ng-xxxxx-g1-xxxxx)
2. Install the OpenAI SDK: `npm install openai` or `pip install openai`
3. Write a script that routes OpenAI SDK requests through my gateway by setting baseURL to my gateway URL and apiKey to my ng-xxxxx key
...
Ask me for my gateway URL and API key before writing any code.
</Prompt>
...
<Steps>
  ...
  <Step title="Make your first request">
    ...
    <Prompt description="Try using this prompt on your agent to verify routing is working: 'State your exact model name and provider.'" actions={["copy", "cursor"]}>
