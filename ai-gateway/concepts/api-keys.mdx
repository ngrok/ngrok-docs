...
<Note>
AI Gateway API Keys currently work with **OpenAI** and **Anthropic**. For other providers like Google, DeepSeek, or self-hosted models, use [Bring Your Own Keys](/ai-gateway/concepts/bring-your-own-keys). You can also combine both—use AI Gateway API Keys for OpenAI and Anthropic while bringing your own keys for other providers in the same gateway.
</Note>
