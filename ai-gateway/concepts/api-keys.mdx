...
<Note>
AI Gateway API Keys work with **OpenAI** and **Anthropic** only. For Google, DeepSeek, self-hosted models, and other providers, use [Bring Your Own Keys](/ai-gateway/concepts/bring-your-own-keys). Both can coexist in the same gateway.
</Note>
