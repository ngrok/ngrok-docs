...
This is equivalent to omitting the model field entirely. The gateway selects from available models based on your strategy (e.g., lowest latency, lowest cost).
...
1. The model name includes a provider prefix (e.g., `openai:gpt-5-preview`)
