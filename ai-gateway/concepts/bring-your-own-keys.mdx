...
Bring your own key when you want upstream billing on your provider account, need built-in providers beyond OpenAI and Anthropic, or run [custom providers](/ai-gateway/concepts/custom-providers).
...
Custom providers are endpoints you define—Ollama, vLLM, or any OpenAI- or Anthropic-compatible API. See [Create a custom provider](/ai-gateway/concepts/custom-providers#create-a-custom-provider).
