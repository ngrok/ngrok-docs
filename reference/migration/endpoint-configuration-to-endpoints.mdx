...
<Steps>
  ...
  <Step title="Retrieve existing endpoint configurations">
  ...
  <Step title="Retrieve reserved domains and addresses">
  ...
  <Step title="Build a Traffic Policy for each endpoint">
  ...
  <Step title="Create a new Cloud Endpoint">
    Once your Traffic Policy YAML is ready:

<<<<<<< HEAD:guides/migration/endpoint-configuration-to-endpoints.mdx
...
>>>>>>> origin/main:reference/migration/endpoint-configuration-to-endpoints.mdx
  ...
  <Step title="Delete the old endpoint configuration">
  ...
  <Step title="Repeat for all endpoint configurations">
...
<<<<<<< HEAD:guides/migration/endpoint-configuration-to-endpoints.mdx
- Learn how to take advantage of ngrok's [load balancing and traffic forwarding capabilities with Cloud Endpoints](/gateway/cloud-endpoints/forwarding-and-load-balancing).
- Use Cloud Endpoints for [path-based traffic routing and Traffic Policy decentralization](/gateway/cloud-endpoints/routing-and-policy-decentralization).
=======
- Learn how to take advantage of ngrok's [load balancing and traffic forwarding capabilities with Cloud Endpoints](/gateway/endpoints/cloud-endpoints/forwarding-and-load-balancing).
- Use Cloud Endpoints for [path-based traffic routing and Traffic Policy decentralization](/gateway/endpoints/cloud-endpoints/routing-and-policy-decentralization).
>>>>>>> origin/main:reference/migration/endpoint-configuration-to-endpoints.mdx
