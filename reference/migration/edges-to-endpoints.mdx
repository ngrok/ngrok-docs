...
<Steps>
  ...
  <Step title="Determine the target URL">
  ...
  <Step title="Migrate routes (HTTPS only)">
  ...
  <Step title="Convert modules to actions">
...
<<<<<<< HEAD:guides/migration/edges-to-endpoints.mdx
    **Example Policy (HTTPS):**
=======
- [📚 Guide: How to Migrate Each Endpoint Configuration Module to Traffic Policy Actions](/reference/migration/modules-to-traffic-policy-actions)
>>>>>>> origin/main:reference/migration/edges-to-endpoints.mdx
