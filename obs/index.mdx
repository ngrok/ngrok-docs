...
description: Understand ngrok's traffic observability features including Traffic Inspector and event logging for monitoring endpoint traffic.
---
...
view of requests and a full-fledged event system to export events to your own
logging systems.
