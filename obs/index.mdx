...
<Columns cols={2}>
	<Card
		...
		icon="check-circle"
		href="/gateway/endpoints/load-balancing-multiple-clouds/"
	>
	...
	<Card
		...
		icon="chart-line"
		href="/gateway/api-gateway/monitor-ngrok/"
	>
	...
	<Card
		...
		icon="file-text"
		href="/gateway/traffic-policy/examples/event-logging/"
	>
	...
	<Card
		...
		icon="database"
		href="/gateway/traffic-policy/actions/log/"
	>
