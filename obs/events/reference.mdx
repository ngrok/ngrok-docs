...
description: Reference documentation for all ngrok Event Sources.
---
...
| [`event_destination_created.v0`](#event_destination_createdv0)                 | Triggers when an Log Destination is created                     |
| [`event_destination_deleted.v0`](#event_destination_deletedv0)                 | Triggers when an Log Destination is deleted                     |
| [`event_destination_updated.v0`](#event_destination_updatedv0)                 | Triggers when an Log Destination is updated                     |
...
| [`secret_created.v0`](#secret_createdv0)                                       | Triggered when a secret is created                              |
| [`secret_deleted.v0`](#secret_deletedv0)                                       | Triggered when a secret is deleted                              |
| [`secret_updated.v0`](#secret_updatedv0)                                       | Triggered when a secret is updated                              |
...
| [`vault_created.v0`](#vault_createdv0)                                         | Triggered when a vault is created                               |
| [`vault_deleted.v0`](#vault_deletedv0)                                         | Triggered when a vault is deleted                               |
| [`vault_updated.v0`](#vault_updatedv0)                                         | Triggered when a vault is updated (name, description, metadata) |
...
| traffic_policy.logs           | List&lt;Map&lt;string, any&gt;&gt;    | The collection of logs generated by any configured [Traffic Policy Log](/traffic-policy/actions/log) actions                                                                                                                                     |
...
Triggers when an Log Destination is created

| Field                                                     | Type   | Description                                                                                                                        |
| --------------------------------------------------------- | ------ | ---------------------------------------------------------------------------------------------------------------------------------- |
| `id`                                                      | string | Unique identifier for this Log Destination.                                                                                        |
| `metadata`                                                | string | Arbitrary user-defined machine-readable data of this Log Destination. Optional, max 4096 bytes.                                    |
| `created_at`                                              | string | Timestamp when the Log Destination was created, RFC 3339 format.                                                                   |
| `description`                                             | string | Human-readable description of the Log Destination. Optional, max 255 bytes.                                                        |
| `format`                                                  | string | The output format you would like to serialize logs into when sending to their target. Currently the only accepted value is `JSON`. |
...
| `target.firehose.delivery_stream_arn`                     | string | An Amazon Resource Name specifying the Firehose delivery stream to deposit logs into.                                              |
...
| `target.kinesis.stream_arn`                               | string | An Amazon Resource Name specifying the Kinesis stream to deposit logs into.                                                        |
...
| `target.cloudwatch_logs.log_group_arn`                    | string | An Amazon Resource Name specifying the CloudWatch Logs group to deposit logs into.                                                 |
| `uri`                                                     | string | URI of the Log Destination API resource.                                                                                           |

#### event_destination_deleted.v0

Triggers when an Log Destination is deleted
...
Triggers when an Log Destination is updated
...
| `sources.uri`      | string | URI of the Log Source API resource.                                                                |
...
| `vault_id`        | string | unique identifier for the vault containing this secret      |
...
| `metadata`        | string | arbitrary user-defined machine-readable data of this secret |
| `name`            | string | name of the secret                                          |
| `created_by`      | string | unique identifier for the user who created this secret      |
| `last_updated_by` | string | unique identifier for the user who last updated this secret |
...
| `certificate_pem`                     | string             | chain of PEM-encoded certificates, leaf first. See [Certificate Bundles](/universal-gateway/tls-certificates/#certificate-bundles). |
