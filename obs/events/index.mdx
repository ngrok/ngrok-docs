...
- **[Log Destinations](#destinations)**: Where logs are sent, e.g.
...
- **[AWS CloudWatch Logs](/integrations/event-destinations/amazon-cloudwatch-event-destination.mdx)**
- **[AWS Firehose](/integrations/event-destinations/amazon-firehose-event-destination.mdx)**
- **[AWS Kinesis](/integrations/event-destinations/amazon-kinesis-event-destination.mdx)**
- **[Azure Logs Ingestion](/integrations/event-destinations/azure-logs-ingestion-event-destination.mdx)**
- **[Datadog Logs](/integrations/event-destinations/datadog-event-destination.mdx)**
...
Log Exporting API Resource](/api/resources/event-subscriptions/#create-event-subscription).
...
- [Amazon CloudWatch](/integrations/event-destinations/amazon-cloudwatch-event-destination.mdx)
- [Amazon Firehose](/integrations/event-destinations/amazon-firehose-event-destination.mdx)
- [Amazon Kinesis](/integrations/event-destinations/amazon-kinesis-event-destination.mdx)
...
The `principal` object in every log describe the user or bot user responsible
