...
Everyone gets three days of traffic retention, after which the traffic events are purged from the system. If you would like a longer look back window, you can purchase up to [90 days of retention with production plans](https://ngrok.com/pricing).
