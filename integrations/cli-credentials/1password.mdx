...
<Tip>One of the easiest mistakes is failing to connect the app to the CLI. In the 1Password app, go to **Settings** > **Developer** and select **Connect with the 1Password CLI**.</Tip>
