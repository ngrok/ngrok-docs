...
![Initialize the 1Password ngrok shell plugin](../img/1password/1password-connect-app-to-cli.png)
...
![Import your ngrok credentials into 1Password](../img/1password/1password-add-ngrok-authtoken.png)
...
![Import your ngrok credentials into 1Password](../img/1password/1password-add-ngrok-authtoken.gif)
...
![Import your ngrok credentials into 1Password](../img/1password/1password-start-ngrok.gif)
