...
1. [Configure Wallix Trustelem SSO](#1-configure-wallix-trustelem)
2. [Configure ngrok](#2-configure-ngrok)
3. [Test access to ngrok with Wallix Trustelem SSO](#test-the-integration)
</Tip>
...
1. Access the WALLIX Trustelem administration console and sign in using your Trustelem account.
...
1. On the left menu of the WALLIX Trustelem administration console, click **Users** and then click **Create User**.
