...
3. [Test access to ngrok with Descope SSO](#test-sso)
</Tip>
...
To integrate ngrok with Descope SSO, you need to:

1. Configure Descope with the ngrok app.
2. Configure ngrok with the SSO settings provided by Descope.
...
5. **Optional**: If you wish to change the [Auth Hosting URL](https://docs.descope.com/knowledgebase/general/authhostingapp/#usage) to use a different flow for ngrok SSO, you can change that on this page, and click **Save**.
...
5. On the **SAML** page, click **Begin setup**, click **Upload XML**, and then open the XML metadata file you downloaded from Descope (See [Fetch IdP Metadata](#idp-metadata)).
