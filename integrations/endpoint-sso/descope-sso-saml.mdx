...
1. On the **ngrok** application page, click the download button next to **Descope Metadata (XML)** to download the Metadata file that you'll need later on. Make sure to leave this page open.
...
1. Access your ngrok endpoint (that is, `https://descope-sso-test.ngrok.app` or use the copied URL).
