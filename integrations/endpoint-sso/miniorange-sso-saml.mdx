...
<Steps titleSize="h2">
  ...
  <Step title="Link miniOrange with ngrok">
    ...
    - On the **Edit Application** page, enter the SP Entity ID and ACS URL from the [SAML action documentation](/gateway/traffic-policy/actions/saml/) (see the [Obtain the SP metadata](#obtain-the-sp-metadata) step) into the corresponding fields.
