...
5. On the **SAML** page, click **Begin setup**, click **Upload XML**, and then open the XML metadata file you downloaded from Wallix Trustelem (See [Configure Wallix Trustelem](#1-configure-wallix-trustelem)).
...
1. On the WALLIX Trustelem administration console, click **Apps** on the left menu, and then click your application.
