...
description: This guide walks you through configuring Microsoft Entra ID as an Identity Provider for your ngrok endpoints using SAML single sign-on (SSO).
---
...
>>>>>>> origin/main
  ...
  <Step title="Update the ngrok configuration with the IdP metadata">
