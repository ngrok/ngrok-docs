...
1. Click **Begin setup** and enter the following:
   ...
   ![FusionAuth config in ngrok](../img/fusionauth/ngrok-edge.png)
...
1. Click the **copy icon** next to the tunnel command.
    ...
    ![tunnel config](../img/fusionauth/fa-2.png)
