...
1. [Configure FusionAuth SSO](#1-configure-fusionauth)
2. [Configure ngrok](#2-configure-ngrok)
3. [Test access to ngrok with FusionAuth SSO](#3-test-the-integration)
</Tip>
...
1. You should see values in the **Client Id** and **Client secret** fields. Copy them; you'll use them in the [Configure ngrok](#2-configure-ngrok) step.
