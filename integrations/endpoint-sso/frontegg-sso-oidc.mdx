...
description: How to secure access to your ngrok endpoints with Frontegg SSO (OpenID Connect)
---
...
1. On the left menu, click **Authentication**, click **Login method**, enter the URL `https://idp.ngrok.com/oauth2/callback` under the **Hosted login** field, and then click **Save**.
   ![Frontegg configuration](../img/frontegg/img/ngrok_url_configuration_frontegg.png)
...
1. Enter the following command to launch an ngrok tunnel with Frontegg SSO:
   ...
   **Note**: Replace the following with the values:
   - FRONTEGG_OAUTH_URL: Your Frontegg **Domain name** URL (that is, `https://app-123456.frontegg.com`).
...
1. Click **Begin setup** and enter the following values into the fields:
   ![Frontegg config in ngrok](../img/frontegg/img/frontegg-1.png)
   - **Issuer URL**: Your Frontegg **Domain name** URL (that is, `https://app-123456.frontegg.com`).
...
1. In the test edge, copy the **endpoint URL** (you use this URL to test the Frontegg Authentication).
   ![tunnel url](../img/frontegg/img/frontegg-4.png)

## 3. Test the integration 

1. In your browser, launch an incognito window.

1. Access your ngrok tunnel (that is, `https://frontegg-sso-test.ngrok.app`). Use the copied endpoint URL.
