...
<Steps titleSize="h2">
  ...
  <Step title="Configure Azure AD B2C custom policies">
  ...
  <Step title="Create an Azure AD B2C SAML application">
    ...
    - Some hints:
      ...
      - Use the following mapping of Azure AD B2C configuration properties to ngrok generated values (retrieved from the SAML action as described in the [SAML action documentation](/gateway/traffic-policy/actions/saml/)) to configure your application:
