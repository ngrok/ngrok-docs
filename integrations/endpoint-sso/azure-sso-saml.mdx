...
1. Configure the SAML module for this Edge:
    ...
    1. Note that ngrok has now generated values for the fields in the Service Provider section. These will be used to configure Azure AD B2C later
...
1. Some hints
   ...
   1. Skip the steps of `Register a web application` and `Enable ID token implicit grant` unless you'd like to test this now. A SAML application will be registered and tested later
...
1. Some hints
   ...
   ![img/3-2.png](../img/azure-ad-b2c/img/3-2.png)

   ![img/3-2b.png](../img/azure-ad-b2c/img/3-2b.png)
...
1. Copy the tunnel command
   ...
   ![img/5-1b.png](../img/azure-ad-b2c/img/5-1b.png)
...
1. Confirm that the tunnel is connected to your edge
   ...
   ![img/5-2.png](../img/azure-ad-b2c/img/5-2.png)
...
1. Access your Edge application
   ...
   ![img/5-3.png](../img/azure-ad-b2c/img/5-3.png) 4. After login, you should be able to see the application
