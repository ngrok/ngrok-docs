...
2. [Configure Azure AD B2C custom policies](#create-policies)
3. [Create an Azure AD B2C SAML application](#create-app)
4. [Update the ngrok Edge with the IdP metadata](#update-ngrok-edge)
5. [Test your integration](#test-integration)
6. [Bonus: Update your Azure AD B2C custom policies to support the password reset flow](#bonus)
</Tip>
