...
1. Follow the Azure AD B2C documentation to create user flows and custom policies.
2. Some hints:
...
1. Follow the Azure AD B2C documentation to register your SAML application and configure custom policies for SAML.
2. Some hints:
