...
![Salesforce Setup](../img/salesforce/external_client_create.png)
...
2. Go to the OAuth Settings section
   - Under App Settings--> OAuth Policies
     ...
     - Make sure the following scopes are selected
       ![OAuth Scopes](../img/salesforce/oauthscopes.png)
...
![Final OAuth Config](../img/salesforce/oauthconfig.png)
...
![Client ID and Client Secret](../img/salesforce/keyandsecret.png)
