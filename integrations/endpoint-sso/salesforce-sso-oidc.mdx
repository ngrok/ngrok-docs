...
![Salesforce Setup](../img/salesforce/img/external_client_create.png)
...
2. Go to the OAuth Settings section
   - Under App Settings--> OAuth Policies
     ...
     - Make sure the following scopes are selected
       ![OAuth Scopes](../img/salesforce/img/oauthscopes.png)
...
![Final OAuth Config](../img/salesforce/img/oauthconfig.png)
...
![Client ID and Client Secret](../img/salesforce/img/keyandsecret.png)
...
to use Agent vs Cloud endpoints, check out the [documentation on endpoints](/universal-gateway/endpoints/).
