...
<Steps titleSize="h2">
  <Step title="Create a Salesforce external client app">
    Navigate to the **App Manager** in Salesforce.
    Click **New External Client App**.
  </Step>

  <Step title="Configure the external client app">
  ...
  <Step title="Obtain the client ID and client secret">
  ...
  <Step title="Create a Cloud Endpoint and configure OIDC Traffic Policy action">
...
To learn more about when to use Agent vs Cloud endpoints, check out the [documentation on endpoints](/gateway/endpoints/).
