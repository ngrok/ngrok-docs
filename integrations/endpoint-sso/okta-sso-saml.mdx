...
1. Launch a tunnel:
    - Launch a terminal
    - Paste the command. Replace `http://localhost:80` with your local web app addess (such as `http://localhost:3000`)
...
1. Access your ngrok tunnel (for example, `https://okta-sso-test.ngrok.app` or using a copied URL).
