...
1. Navigate to the **Sign On** Tab on the new app and click **Actions** under the Active SHA-2 certificate and select **View IdP metadata**. The metadata will open in a new tab.
   ![view xml metadata](../img/okta/okta-view-cert.png)
1. In the new tab, Select **Save As** from the File menu to save your metadata.xml file for uploading into ngrok in a later step.
   ![download xml](../img/okta/okta-save-as-xml.png)
...
1. Click **Begin setup** and click **Upload XML** beside **IdP Metadata** under **Identity Provider** and select your metadata file saved from the steps above:
   ...
   ![Okta config in ngrok](../img/okta/okta-5.png)
...
1. After you save, the SP Metadata will appear. Copy these values into the Okta where temporary values were placed above:
   ![Update Okta with SP values](../img/okta/okta-6.png)
...
1. Click the **copy icon** next to the tunnel command.
    ...
    ![tunnel config](../img/okta/okta-2.png)
