...
To secure access to ngrok with JumpCloud single sign-on (SSO) using SAML:

1. [Configure JumpCloud SSO](#1-configure-jumpcloud)
2. [Configure ngrok](#3-configure-ngrok)
3. [Test access to ngrok with JumpCloud SSO](#test-the-integration)
</Tip>
...
2. On the left menu, click **SSO**, click **Get Started** or **+ Add New Application**, and then click **Custom SAML App**.
3. On the **New Application** popup, enter `ngrok saml` in the **Display Label** field.
4. Click the **SSO** tab, enter `https://ngrok-jumpcloud` in the **IdP Entity ID** field, enter temporary values (such as `https://temporary`) in both the **SP Entity ID** and the **ACS URL** fields, and then click **Activate**.

## 2. Download the IdP metadata 

1. On the **SSO** page of the JumpCloud Console, click your **Custom SAML App**, click the **SSO** tab, click **Export Metadata**, and then save the XML file on your desktop.
...
5. On the **SAML** page, click **Begin setup**, click **Upload XML**, and then open the XML metadata file you downloaded from JumpCloud (See [Download the IdP metadata](#2-download-the-idp-metadata)).
...
1. Access the JumpCloud Console, click **SSO**, click your **Custom SAML App**, click the **SSO** tab, click **Upload Metadata**, and then open the XML metadata file you downloaded from ngrok (See [Download the SP metadata](#4-download-the-sp-metadata)).
2. Click **Save**.
...
1. On the left menu of the JumpCloud Console, click **SSO** and click the ngrok custom SAML app you created.
