...
1. Access the [JumpCloud Console](https://console.jumpcloud.com/), click **SSO**, click your **Custom SAML App**, click the **SSO** tab, click **Upload Metadata**, and then open the XML metadata file you downloaded from ngrok (See [Download the SP metadata](#4-download-the-sp-metadata)).
2. Click **Save**.
...
1. On the left menu of the [JumpCloud Console](https://console.jumpcloud.com/), click **SSO** and click the ngrok custom SAML app you created.
