...
3. [Configure Frontegg](#configure-frontegg)
4. [Update Frontegg Login Method](#frontegg-login)
5. [Test access to ngrok with Frontegg SSO](#test-sso)
</Tip>
...
To integrate ngrok with Frontegg SSO, you need to:

1. Configure Frontegg with the ngrok app.
2. Configure ngrok with the SSO settings provided by Frontegg.
...
5. On the **SAML** page, click **Begin setup**, click **Upload XML**, and then open the XML metadata file you downloaded from Frontegg (See [Download the IdP metadata](#idp-metadata)).
