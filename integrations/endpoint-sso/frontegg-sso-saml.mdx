...
1. In the first empty field, enter the endpoint URL from your ngrok edge (that is, `https://123456789.ngrok.app/`). In the second field, enter the **ACS URL** from your Edge SAML configuration.
