...
1. [Configure Curity Identity Server](#1-configure-curity-authentication)
2. [Configure ngrok](#3-configure-ngrok)
3. [Test access to ngrok with Curity Identity Server](#4-test-the-integration)
</Tip>
...
2. #### Add Capabilities
   ...
   1. On the **User Authentication** screen, select the `HTML-form` authenticator created in **[Step 1](#1-configure-curity-authentication)**.
   1. Click **Done**.
