...
<Steps titleSize="h2">
  <Step title="Configure Curity authentication">
  ...
  <Step title="Configure Curity for OIDC">
    ...
    - #### Add Capabilities
       ...
       - On the **User Authentication** screen, select the `HTML-form` authenticator created in the [Configure Curity authentication](#configure-curity-authentication) step.
       - Click **Done**.
