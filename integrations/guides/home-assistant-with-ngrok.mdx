...
<Steps titleSize="h2">
  ...
  <Step title="Run Home Assistant in a Docker container">
    Update `compose.yaml`:
  ...
  <Step title="Configure ngrok to expose Home Assistant">
  ...
  <Step title="Allow trusted proxies in Home Assistant">
