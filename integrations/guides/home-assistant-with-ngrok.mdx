...
<Note>
  This guide walks through setting up Home Assistant in a Docker container from
  scratch. The same principles apply if you already have a Home Assistant
  instance set up, or if you set it up using one of their other [installation
  methods](https://www.home-assistant.io/installation/).
</Note>
