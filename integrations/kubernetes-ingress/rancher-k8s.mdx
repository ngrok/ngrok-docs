...
<Note>
  ...
  installing Rancher with Helm. If you choose that option, you can skip ahead to
  [Install a sample application](#install-a-sample-application) once you've
  finalized your K3s cluster.
</Note>
