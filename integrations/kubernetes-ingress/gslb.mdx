...
- Spread the load further by deploying additional VMs in more regions and connecting each agent to `https://gslb-demo.internal`.
  ngrok automatically includes them in load balancing.
