...
This guide shows you how to layer ngrok's [Global Server Load Balancing](/gateway/global-load-balancer/) (GSLB) on top of a VM-based deployment on DigitalOcean.
