...
This guide shows you how to layer ngrok's [Global Server Load Balancing](/domains/global-load-balancer/) (GSLB) on top of a VM-based deployment on DigitalOcean.
...
<Steps>
  <Step title="Reserve your ngrok domain">
    ...
    Next, create a domain that is a subdomain of an [ngrok-managed domain](/domains/).
    ...
    **Custom domains within ngrok:**
    ...
    If you'd prefer to use a custom domain rather than an ngrok-managed one, [follow the guide](/domains/custom-domains/) to set up your DNS and replace your custom domain in the `export` command above.
    </Tip>
  </Step>
  ...
  <Step title="(Optional) Extend with Traffic Policy">
