...
1. Access your tinyllama demo app by navigating to the your domain, for example, `https://one-two-three.ngrok.app`. ngrok's edge
   ...
   !["Navigating directly to the https://one-two-three.ngrok.app domain to see the tinyllama application (note: screenshot shows earlier 2048 app)"](../img/vcluster/img/ngrok-k8s-vcluster_2048.png)
