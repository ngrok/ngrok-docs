...
- Access your tinyllama demo app by navigating to your domain (for example, `https://one-two-three.ngrok.app`).
  ngrok's network and your Operator route traffic to your app from any device or external network as long as your vcluster is running.

## Add OAuth protection to your demo app 

To take your ingress a little further, assume you want to add security, in the form of Google OAuth, to the endpoint where your tinyllama application is running.
...
- Use [expressions](/gateway/traffic-policy/how-it-works#expressions) and [CEL interpolation](/gateway/traffic-policy/how-it-works#cel-interpolation) to filter out and reject OAuth logins that don't contain `example.com`.
...
Because ngrok offloads ingress and middleware execution to its global network, you can follow the same procedure listed above for any Kubernetes environment, like EKS, GKE, and OpenShift, with similar results.
