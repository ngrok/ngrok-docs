...
Now that your demo app is publicly accessible through ngrok, you can quickly layer on [additional capabilities](/universal-gateway/http/), like authentication, without configuring and deploying complex infrastructure.
