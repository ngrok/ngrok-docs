...
1. Follow the MicroK8s get-started tutorial to install the binary for your target system.
...
1. If you don't have an ngrok static domain, create one.
...
1. Create a new Kubernetes manifest (`tinyllama.yaml`) with the YAML below.
