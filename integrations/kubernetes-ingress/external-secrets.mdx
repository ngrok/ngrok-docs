...
- The [External Secrets Operator](https://external-secrets.io/latest/introduction/getting-started/) installed in your Kubernetes cluster.
...
- Learn how to use [secrets in Traffic Policies](/gateway/traffic-policy/secrets/) to reference your synced secrets dynamically in policy actions.
- Explore the [Traffic Policy Actions](/gateway/traffic-policy/actions/) available to secure and manage traffic to your endpoints.
- Learn more about the [ngrok Kubernetes Operator](/gateway/k8s/) and how to configure Traffic Policies directly in your Kubernetes deployments.
