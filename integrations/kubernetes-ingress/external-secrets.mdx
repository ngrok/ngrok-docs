...
The [External Secrets Operator](https://external-secrets.io/) integration allows you to push Kubernetes secrets to ngrok vaults, where they can be referenced in your Traffic Policies for secure configuration management.
