...
<Steps>
  <Step title="Create a cluster and deploy an example app">
    ...
    If you already have a cluster and app, skip to the **Add the ngrok Kubernetes Operator** step.
...
>>>>>>> origin/main
  ...
  <Step title="Test authorization to your app using Microsoft Entra ID">
    ...
    - Enter credentials for a Microsoft account you assigned to your enterprise application in Microsoft Entra ID in the **Create an enterprise app in Microsoft Entra ID** step.
