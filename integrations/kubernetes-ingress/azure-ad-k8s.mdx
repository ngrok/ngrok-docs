...
description: Add ingress to Kubernetes apps and restrict access to users authorized through Microsoft Entra ID with the ngrok Kubernetes Operator.
...
Next, configure and deploy the [ngrok Kubernetes Operator](https://github.com/ngrok/ngrok-operator) to expose your app to the public internet through the ngrok cloud service.
