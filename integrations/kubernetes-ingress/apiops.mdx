...
1. Enable [auto sync](https://argo-cd.readthedocs.io/en/stable/user-guide/auto_sync/) of your app the Git repository that stores your desired state.
   ...
   <Note>
   	The default polling interval, at which Argo CD looks for changes to the
   	desired state in your Git repo, is 3 minutes. You can alter this behavior
   	with the [`timeout.reconciliation`
   	value](https://argo-cd.readthedocs.io/en/stable/faq/#how-often-does-argo-cd-check-for-changes-to-my-git-or-helm-repository)
   	in Argo CD's configuration.
   </Note>
