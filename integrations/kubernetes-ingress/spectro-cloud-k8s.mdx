...
<Steps>
  <Step title="Create a cluster profile in Palette">
    ...
    If you already have a cluster profile, skip to the **Create your cluster with Palette** step.
    If you already have a functioning cluster in Palette, skip to the **Create an add-on cluster profile for an example app** step.
