...
1. Open your [Applications settings](https://gitlab.com/-/user_settings/applications): from your avatar, select **Edit profile**, then in the left sidebar select **Access > Applications**. Select **Add new application**.
