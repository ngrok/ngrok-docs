...
2. Click **Create a New Security Profile**, provide a **Name** and a **Description** for your security profile, enter your application's privacy URL (e.g. `https://ngrok.com/privacy`) in the **Consent Privacy Notice URL**, and then click **Save**.
