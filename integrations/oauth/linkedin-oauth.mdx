...
4. Click the pencil icon for the **Authorized redirect URLs** in the **OAuth 2.0 settings** section, add the ngrok oauth callback URL (that is, `https://idp.ngrok.com/oauth2/callback`), and then click **Update**.
