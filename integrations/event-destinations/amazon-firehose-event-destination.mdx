...
For ngrok to successfully send events into AWS Firehose, a delivery stream is required
...
To send the events to Firehose, assign an Event Destination to the Log Export.
