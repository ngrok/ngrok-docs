...
<Steps titleSize="h2">
  <Step title="Obtain Firehose delivery stream ARN">
    ...
    After you create your AWS Firehose delivery stream, keep the Delivery Stream ARN for the [Create event destination](#create-event-destination) step.
  </Step>
