...
<Steps titleSize="h2">
  ...
  <Step title="Create a DCR-based custom table in the workspace">
    ...
    - Click the workspace you created in the [Create a Log Analytics workspace](#create-a-log-analytics-workspace) step.
    ...
    - Populate the table name with a name of your choice and the DCE field with the existing DCE you created in the [Create a data collection endpoint](#create-a-data-collection-endpoint) step.
  ...
  <Step title="Create a Microsoft Entra Application">
  ...
  <Step title="Assign IAM permissions to the Application for the DCR">
    ...
    - Click the Data collection rule you created in the [Create a DCR-based custom table in the workspace](#create-a-dcr-based-custom-table-in-the-workspace) step.
    ...
    - Search for the app registration you created in the [Create a Microsoft Entra Application](#create-a-microsoft-entra-application) step.
  ...
  <Step title="Gather necessary data for event destination">
    ...
    - In the sidebar, go to **Manage** > **App registrations** and click the application you created in the [Create a Microsoft Entra Application](#create-a-microsoft-entra-application) step.
    ...
    - Click the Data collection endpoint you created in the [Create a data collection endpoint](#create-a-data-collection-endpoint) step.
  ...
  <Step title="Create the new event destination in ngrok">
