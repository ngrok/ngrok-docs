...
![search log analytics workspaces](../img/azure-logs-ingestion/img/search-workspaces.png)
...
![create log analytics workspaces](../img/azure-logs-ingestion/img/create-workspace-review.png)
...
![search data collection endpoints](../img/azure-logs-ingestion/img/search-dce.png)
...
![create dce](../img/azure-logs-ingestion/img/create-dce.png)
...
![create dcr-based table](../img/azure-logs-ingestion/img/create-dcr-table.png)
...
![create dcr drawer](../img/azure-logs-ingestion/img/dcr-create-drawer.png)
...
You can remedy this by using the **Transformation Editor**.
</Tip>
...
![transformation editor](../img/azure-logs-ingestion/img/transformation.png)
...
![create table success](../img/azure-logs-ingestion/img/create-table-success.png)
...
![search Microsoft Entra ID](../img/azure-logs-ingestion/img/search-entra.png)
...
![register app](../img/azure-logs-ingestion/img/register.png)
...
![register app](../img/azure-logs-ingestion/img/role-assignment.png)
...
![review app role](../img/azure-logs-ingestion/img/review-role.png)

You have now granted access for the ngrok application to ingest logs into the DCR, which is the final step before creating an Event Destination.

## 6. Gather necessary data for event destination 

In order to create an event destination in your ngrok Dashboard, gather the following information from what was just created in Azure:
...
1. To gather the first three fields, navigate back to **Microsoft Entra ID**. Search for **Entra** in the top search bar and select the **Microsoft Entra ID** service.
...
![app ids](../img/azure-logs-ingestion/img/app-ids.png)
...
![app secret](../img/azure-logs-ingestion/img/app-secret.png)
...
![immutable id](../img/azure-logs-ingestion/img/immutable-id.png)
...
![stream name](../img/azure-logs-ingestion/img/stream-name.png)
