...
![search log analytics workspaces](../img/azure-logs-ingestion/search-workspaces.png)
...
![create log analytics workspaces](../img/azure-logs-ingestion/create-workspace-review.png)
...
![search data collection endpoints](../img/azure-logs-ingestion/search-dce.png)
...
![create dce](../img/azure-logs-ingestion/create-dce.png)
...
![create dcr-based table](../img/azure-logs-ingestion/create-dcr-table.png)
...
![create dcr drawer](../img/azure-logs-ingestion/dcr-create-drawer.png)
...
![transformation editor](../img/azure-logs-ingestion/transformation.png)
...
![create table success](../img/azure-logs-ingestion/create-table-success.png)
...
![search Microsoft Entra ID](../img/azure-logs-ingestion/search-entra.png)
...
![register app](../img/azure-logs-ingestion/register.png)
...
![register app](../img/azure-logs-ingestion/role-assignment.png)
...
![review app role](../img/azure-logs-ingestion/review-role.png)
...
![app ids](../img/azure-logs-ingestion/app-ids.png)
...
![app secret](../img/azure-logs-ingestion/app-secret.png)
...
![immutable id](../img/azure-logs-ingestion/immutable-id.png)
...
![stream name](../img/azure-logs-ingestion/stream-name.png)
