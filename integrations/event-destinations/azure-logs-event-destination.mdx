...
<Steps>
  ...
  <Step title="Create a DCR-based custom table in the workspace">
    ...
    - Click the workspace you created in the **Create a Log Analytics workspace** step.
    ...
    - Populate the table name with a name of your choice and the DCE field with the existing DCE you created in the **Create a data collection endpoint** step.
  ...
  <Step title="Assign IAM permissions to the Application for the DCR">
    ...
    - Click the Data collection rule you created in the **Create a DCR-based custom table in the workspace** step.
    ...
    - Search for the app registration you created in the **Create a Microsoft Entra Application** step.
  ...
  <Step title="Gather necessary data for event destination">
    ...
    - In the sidebar, go to **Manage** > **App registrations** and click the application you created in the **Create a Microsoft Entra Application** step.
    ...
    - Click the Data collection endpoint you created in the **Create a data collection endpoint** step.
