...
<Note>  **Troubleshooting:** If you receive a 403 error instead of a Success message, double-check your API key and confirm that you selected the correct Datadog site.
</Note>
