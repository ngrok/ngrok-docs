...
ngrok sends logs to the Datadog Logs API and automatically compresses them with gzip. ngrok does not support the events or metrics APIs at this time.
...
<Note>**Troubleshooting:** If you receive a 403 error instead of a Success message, double-check your API key and confirm that you selected the correct Datadog site.</Note>
