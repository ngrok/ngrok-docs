...
For ngrok to successfully send events into Kinesis, a data stream ARN is required. To
...
To send the events to Kinesis, assign an Event Destination to the Log Export.
