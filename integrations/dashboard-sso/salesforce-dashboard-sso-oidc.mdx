...
![Create External Client App](../img/salesforce/external_client_create.png)
...
![Client ID and Secret](../img/salesforce/keyandsecret.png)
...
2. Click **+ New Identity Provider** and select **New OpenID Connect Provider**.
   ![Add Identity Provider](../img/salesforce/new_oidc_provider.png)
...
![ngrok Identity Provider Configuration](../img/salesforce/oidc_settings_dash.png)
