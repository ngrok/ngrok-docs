...
<Note>
	The OIDC flow is initiated from your Applications login page. (OIDC Service
	Provider flow is not supported.)
</Note>
...
![Create External Client App](../img/salesforce/img/external_client_create.png)
...
![Client ID and Secret](../img/salesforce/img/keyandsecret.png)
...
2. Click **+ New Identity Provider** and select **New OpenID Connect Provider**.
   ![Add Identity Provider](../img/salesforce/img/new_oidc_provider.png)
...
![ngrok Identity Provider Configuration](../img/salesforce/img/oidc_settings_dash.png)
