...
1. Back in your Auth0 account, select your Application and click the Addons tab. Again select the SAML2 Web App. In the popup window select the Settings tab.
