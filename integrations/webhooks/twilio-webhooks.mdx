...
You've got an end-to-end example working, but there's even more you can do with ngrok to make development even easier. Check out how to inspect and replay your requests without having to send an SMS.
