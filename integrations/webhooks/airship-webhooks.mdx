...
<Steps>
  ...
  <Step title="Configure Airship to send webhooks">

    Airship sends webhooks through Open Channels.
    Follow [Airship's documentation for configuring an Open Channel](https://www.airship.com/docs/developer/api-integrations/open/getting-started/), and set the following:
    ...
    To trigger a webhook call, send a message to your Open Channel from Airship, selecting it as the delivery channel.
