...
<Steps>
  ...
  <Step title="Configure Signal Sciences to send webhooks">
...
=======
Signal Sciences sends webhook requests to your app when specific events occur in your account.
Follow [Signal Sciences' documentation for the generic webhook integration](https://www.fastly.com/documentation/guides/next-gen-waf/using-ngwaf/integrations/generic-webhooks), and set the following:

- **Webhook URL**: your ngrok URL (for example, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
- **Activity**: the activity you want to receive (for this example, **All activity**).
>>>>>>> origin/main
...
=======
After you create the site integration, Signal Sciences sends requests to your app when the activity you selected occurs.

To trigger a request, change your site display name in Signal Sciences.

Confirm your localhost app receives an event notification and logs both the headers and body in the terminal.
