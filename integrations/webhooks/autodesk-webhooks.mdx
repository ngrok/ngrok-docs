...
<Tip>  Click the eye icon to reveal **Client Secret** or use the copy icon.
</Tip>
...
<Tip>  This tutorial uses **Data Management** as an example; you can select other APIs for different Autodesk services.
</Tip>
