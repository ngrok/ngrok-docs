...
MongoDB sends different request body contents depending on the event. To trigger a call, cause the event you selected, such as inviting a new user to your project.
