...
1. Select the **Chain** and the **Network** you want to monitor activities and then enter the URL provided by the ngrok agent to expose your application to the internet in the **WEBHOOK URL** field (that is, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
