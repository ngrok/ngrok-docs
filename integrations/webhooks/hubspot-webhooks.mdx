...
Set the workflow trigger to the change you want to test. For this example, use a new contact with a specific contact owner.

### Run webhooks with HubSpot and ngrok

To trigger calls from HubSpot to your app, create a record that matches your workflow trigger. For this example, create a contact and set the same **Contact owner** you used in the trigger.
