...
1. On the webhook popup, enter a name in the **Name** field and enter the URL provided by the ngrok agent to expose your application to the internet in the **URL** field (that is, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
   ![hygraph URL to Publish](../img/hygraph/img/ngrok_url_configuration_hygraph.png)
...
1. On the **Assets** page, click **Upload**, select a file from your desktop, click **Upload**, and then click **Save & Publish**.
   ...
   1. On the left menu, click **Webhooks** and then click **View Logs** for your webhook, and then clicke of the messages.
      ![Webhook Logs](../img/hygraph/img/ngrok_logs_hygraph.png)
