...
<Note>
  ...
  The [sample app](#1-start-your-app) does not handle this, so use an app that responds to Zoom's validation request.
...
- Use the **Secret Token** you copied when configuring the webhook (see the **Configure Zoom to send webhooks** step).
