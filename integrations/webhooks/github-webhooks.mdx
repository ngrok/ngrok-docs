...
1. In the **Payload URL**, use the URL provided by the ngrok agent to expose your application to the internet (that is,, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
   ![Payload URL](../img/github/img/ngrok_url_configuration_github.png)
...
![GitHub Recent Deliveries](../img/github/img/review_github_recent_deliveries.png)
