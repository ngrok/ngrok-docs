...
This guide walks you through using ngrok to integrate your localhost app with GitHub so GitHub can send repository events to your app.
...
- An [ngrok account](https://ngrok.com/signup) (free) and your [authtoken](https://dashboard.ngrok.com/get-started/your-authtoken).
...
- In the [ngrok dashboard](https://dashboard.ngrok.com), copy your authtoken.
...
<Note>
  **Free account limit:** Webhook verification is limited to 500 validations per month on free accounts.
  Upgrade to Pro or Enterprise for unlimited validations.
</Note>
