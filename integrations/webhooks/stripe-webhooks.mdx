...
<Tip>  Stripe may show sample code for running an app; for this tutorial use the sample app from [Start your app](#1-start-your-app) instead.
</Tip>
...
<Tip>  Stripe sends different request body contents and headers depending on the event.
</Tip>
