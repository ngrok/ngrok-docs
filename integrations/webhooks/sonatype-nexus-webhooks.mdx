...
1. On the **Create Webhook** page, enter the URL provided by the ngrok agent to expose your application to the internet in the **URL** field (that is, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
   ![Sonatype Nexus URL](../img/sonatype-nexus/img/ngrok_url_configuration_sonatype.png)
...
1. On the **Repositories** page, click **Create Repository**, clicke of the **Recipes** from the list, enter any value in the **Name**, **Distribution**, and **Signing Key**, and then click **Create repository**.
