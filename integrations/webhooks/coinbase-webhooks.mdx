...
<Steps>
  ...
  <Step title="Configure Coinbase to send webhooks">
    Coinbase can send webhook requests to your app when events occur in your account.
    To register for those events:

    - Sign in to the [Coinbase homepage](https://www.coinbase.com/).
...
<<<<<<< HEAD
    Coinbase sends different request body contents depending on the event.
    To trigger new calls from Coinbase to your app:

    - In [Coinbase](https://www.coinbase.com/), go to **Trade**, click **Simple** in the top menu, and click **Buy** for one of the assets.
