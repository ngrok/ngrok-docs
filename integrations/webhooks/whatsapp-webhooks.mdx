...
**Requirements**: You'll need a Facebook app and a business phone number associated with your Facebook app.
...
1. In the **Edit webhook's callback URL** popup, enter the URL provided by the ngrok agent to expose your application to the internet in the **Callback URL** field, with `/webhooks` at the end (that is, `https://myexample.ngrok.app/webhooks`).
   ![Callback URL](../img/whatsapp/ngrok_url_configuration_whatsapp.png)
