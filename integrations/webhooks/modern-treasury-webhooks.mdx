...
1. On the **New webhook** page, enter the URL provided by the ngrok agent to expose your application to the internet in the **Webhook URL** field (for example, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
   ![Webhook URL](../img/modern-treasury/ngrok_url_configuration_moderntreasury.png)
...
1. On the left menu, click **Developers**, click the **Events** tab, and then click the corresponding event received by the localhost application.
   ![Events](../img/modern-treasury/ngrok_logs_moderntreasury.png)
