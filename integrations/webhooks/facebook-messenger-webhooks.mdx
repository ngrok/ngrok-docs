...
## 3. Integrate Facebook Messenger

To register a webhook on your Facebook account follow the instructions below:

**Note**: You'll need a Facebook page associated with your Facebook account.
Create one before continuing this procedure.
...
1. In the **Edit Callback URL** popup, for the **Callback URL** field enter the URL provided by the ngrok agent to expose your application to the internet, with `/webhook` at the end (that is, `https://myexample.ngrok.app/webhook`).
   ![Callback URL](../img/facebook-messenger/ngrok_url_configuration_facebookmessenger.png)
...
Now that you have successfully registered your webhook and tested it, access the Facebook page you have assigned to your webhook and send a message to another Facebook user.
Alternatively, you can sign in to Facebook using another Facebook account, access your page, and then send a message through the Messenger feature.
