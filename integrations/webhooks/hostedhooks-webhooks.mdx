...
1. On the **New Endpoint** page, enter the URL provided by the ngrok agent to expose your application to the internet in the **Webhook URL** field (that is, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
