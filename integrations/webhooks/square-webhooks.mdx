...
<Steps>
  ...
  <Step title="Configure Square to send webhooks">
...
=======
Follow [Square's documentation for subscribing to webhook event notifications](https://developer.squareup.com/docs/webhooks/step2subscribe), and set the following:

- **URL**: your ngrok URL (for example, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
- **Events**: select the events you want (for this example, **catalog.version.updated**).
>>>>>>> origin/main
...
=======
Because this example uses **catalog.version.updated**, creating or updating a catalog item triggers a webhook.
Create or update an item in your Square account to send a request to your app.
>>>>>>> origin/main
...
=======
<Tip>
  Square sends a different request body depending on the event you selected.
</Tip>
