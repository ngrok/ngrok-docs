...
<Steps>
  ...
  <Step title="Configure Mailchimp to send webhooks">
...
=======
Follow [Mailchimp's documentation for creating an audience webhook](https://mailchimp.com/help/about-webhooks/), and set the following:

- **Callback URL**: your ngrok URL (for example, `https://1a2b-3c4d-5e6f-7g8h-9i0j.ngrok.app`).
- **Actions**: choose which audience updates trigger the webhook.

When you save the webhook, Mailchimp sends a verification request to your callback URL.
Confirm your localhost app receives it and logs both headers and body in the terminal.
>>>>>>> origin/main
...
<<<<<<< HEAD
    ...
    <InspectingRequests />
=======
Mailchimp sends different request body contents depending on the audience and the actions you selected.
To trigger a call, cause one of those updates in your audience, such as adding a new subscriber.
>>>>>>> origin/main
