...
<Info>**This integration requires an ngrok Pro or Enterprise license because Microsoft Teams validates your ngrok domain and certificate.**</Info>
...
1. In the **Domain** pane, provide a value for the **Domain** field (that is, `myexample.ngrok.app`), and then click **Continue**.
   ![ngrok New Domain](../img/facebook-messenger/ngrok_new_domain.png) **Tip**: Make sure your domain is available.
...
**Requirements**: You'll need a Microsoft Teams page and a Microsoft Teams app associated with your Microsoft Teams page.
Create one before following the rest of these steps.
...
Microsoft teams Outgoing Webhook acts as a bot sending any text you type using `@mention`.
It sends notifications to your local application through ngrok.
...
**Note:** This ngrok feature is limited to 500 per month on free ngrok accounts.
