...
<CardGroup cols={3}>
  <Card title="Webhooks" icon="webhook" href="/share-localhost/webhooks">
    Receive webhook callbacks from third-party services on your local machine
  </Card>
  <Card title="Mobile apps" icon="mobile" href="/share-localhost/mobile">
    Test mobile apps against your local backend without deploying
  </Card>
  <Card title="API development" icon="code" href="/share-localhost/apis">
...
<CardGroup cols={3}>
  ...
  <Card title="Authentication" icon="shield-halved" href="/share-localhost/auth">
    Add OAuth, basic auth, or other authentication to your endpoints
  </Card>
  <Card title="Network security" icon="network-wired" href="/share-localhost/security">
...
<CardGroup cols={2}>
  <Card title="Quickstart" icon="rocket" href="/share-localhost/quickstart">
