...
- **Inspect traffic:** Use the [Traffic Inspector](/share-localhost/inspection) to see exactly what requests your mobile app is making and what responses it receives.
...
- [Authentication](/share-localhost/auth): add auth to your endpoint to restrict access during testing
- [Traffic inspection](/share-localhost/inspection): debug requests from your mobile app
