...
These can be configured for [Domains](/domains/dedicated-ips/) and [Agent Connect URLs](/agent/connect-url/#dedicated-ips).
...
balancer](/domains/global-load-balancer/) will return a different set
