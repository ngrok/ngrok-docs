...
- [**Actions**](/traffic-policy/how-it-works#actions): Define what happens when a Traffic Policy rule matches (such as adding headers, denying a request, or forwarding traffic).
...
| [conn.bytes_in](/traffic-policy/variables/connection/#connbytes-in)                                      | Free     |
| [conn.bytes_out](/traffic-policy/variables/connection/#connbytes-out)                                    | Free     |
| [conn.client_ip](/traffic-policy/variables/connection/#connclient-ip)                                    | Free     |
| [conn.client_port](/traffic-policy/variables/connection/#connclient-port)                                | Free     |
| [conn.server_ip](/traffic-policy/variables/connection/#connserver-ip)                                    | Free     |
| [conn.server_port](/traffic-policy/variables/connection/#connserver-port)                                | Free     |
| [conn.server_region](/traffic-policy/variables/connection/#connserver-region)                            | Free     |
