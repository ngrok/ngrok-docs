...
The free plan includes one automatically assigned **dev domain** (e.g., `your-assigned-name.ngrok-free.app`) that you can use for public endpoints. 
...
- Choose or customize your domain name (e.g., `--url https://my-custom-name.ngrok.app` will not work)
- Reserve or create custom static domains
- Use random domain generation (e.g., `--url 'https://'` will not work)
- Use your own custom domain (e.g., `app.yourdomain.com`)
