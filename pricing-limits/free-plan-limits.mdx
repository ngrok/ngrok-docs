...
- Choose or customize your domain name (`--url https://my-custom-name.ngrok.app` will not work)
- Reserve or create custom static domains
- Use random domain generation (`--url 'https://'` will not work)
- Use your own custom domain like `app.yourdomain.com`
