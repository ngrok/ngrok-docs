...
<Tip>  See [Pricing and Limits](https://ngrok.com/pricing?ref=docs) to learn how to increase or remove these limits.
</Tip>
...
<Note>  You can check your usage [in the Usage page in the dashboard](https://dashboard.ngrok.com/usage).
</Note>
...
<Note>  This does not impact users serving APIs or accessing ngrok endpoints programmatically.
</Note>
