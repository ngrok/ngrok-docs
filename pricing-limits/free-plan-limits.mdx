...
<Note>
The free tier does NOT have timeouts on tunnels. If you'd like to run your endpoint all the time, you can do so, on the free tier, as a [background service](/agent/#background-service).
</Note>
