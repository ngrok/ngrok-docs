...
The free plan includes one automatically assigned **dev domain** (such as `your-assigned-name.ngrok-free.app`) that you can use for public endpoints. 
...
- Choose or customize your domain name (such as `--url https://my-custom-name.ngrok.app` will not work)
- Reserve or create custom static domains
- Use random domain generation (such as `--url 'https://'` will not work)
- Use your own custom domain (such as `app.yourdomain.com`)
