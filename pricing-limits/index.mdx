...
separately — see [TLS certificates pricing](/domains/tls-certificates/#tls-certificates-pricing).
</Note>
...
For more information on creating and using wildcard endpoints, see the [wildcard endpoints documentation](/endpoints/http/#wildcard-endpoints).
...
The ngrok cloud service automatically protects all Endpoints from attacks with its proprietary, out-of-the-box [DDoS Firewall](/domains/ddos-protection#ddos-firewall). 
