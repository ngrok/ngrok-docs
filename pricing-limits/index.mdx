...
<Tip>For information on free plans, see [Free Plan Limits](/pricing-limits/free-plan-limits/).</Tip>
...
<Note>You can check your usage [in the ngrok dashboard](https://dashboard.ngrok.com/billing).</Note>
...
<Warning>This limit does not refresh at the end of each calendar month.</Warning>
...
<Tip>See [Free Plan Limits and Resources](/pricing-limits/free-plan-limits) for more details on the free plan.</Tip>
