...
For more information on creating and using wildcard endpoints, see the [wildcard endpoints documentation](/gateway/http/#wildcard-endpoints).
...
The ngrok cloud service automatically protects all Endpoints from attacks with its proprietary, out-of-the-box [DDoS Firewall](/gateway/ddos-protection#ddos-firewall). 
