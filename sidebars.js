				...
				"http/openid-connect",
				{
					...
					items: [
						...
						"http/policies/expressions",
						{
							...
							items: [
								"http/policies/actions/index",
								"http/policies/actions/custom-response",
								"http/policies/actions/deny",
								"http/policies/actions/log",
								"http/policies/actions/rate-limit",
								"http/policies/actions/url-rewrite",
							],
						},
					],
				},
