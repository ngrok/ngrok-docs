			...
			items: [
				...
				"http/tls-termination",
				{
					...
					items: [
						...
						"http/traffic-policy/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "http/traffic-policy/actions/index" },
							items: [
								{ type: "autogenerated", dirName: "http/traffic-policy/actions" },
							],
						},
					],
				},
			...
			items: [
				...
				"tls/tls-termination",
				{
					...
					items: [
						...
						"tls/traffic-policy/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "tls/traffic-policy/actions/index" },
							items: [
								{ type: "autogenerated", dirName: "tls/traffic-policy/actions" },
							],
						},
					],
				},
			...
			items: [
				...
				"tcp/ip-restrictions",
				{
					...
					items: [
						...
						"tcp/traffic-policy/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "tcp/traffic-policy/actions/index" },
							items: [
								{ type: "autogenerated", dirName: "tcp/traffic-policy/actions" },
							],
						},
					],
				},
