			...
			items: [
				...
				// },
				{
					...
					items: [
						...
						"traffic-policy/actions/oidc",
						"traffic-policy/actions/saml",
						"traffic-policy/actions/jwt-validation",
					],
				},
				{
					...
					items: [
						...
						"traffic-policy/actions/custom-response",
					],
				},
				{
					...
					type: "category",
					items: [
						"traffic-policy/actions/rate-limit",
						"traffic-policy/actions/deny",
						"traffic-policy/actions/circuit-breaker",
				...
				},
				{
					label: "Terminate TLS",
					type: "doc",
					id: "traffic-policy/actions/terminate-tls",
				},
				{
					label: "Verify Webhooks",
					type: "doc",
					id: "traffic-policy/actions/verify-webhook",
				},
				{
					label: "Log Traffic",
					type: "doc",
					id: "traffic-policy/actions/log",
				},
				{
					label: "References",
					type: "category",
							...
							items: [
								{
									label: "add-headers",
									type: "doc",
									id: "traffic-policy/references/add-headers",
								},
								{
									type: "autogenerated",
