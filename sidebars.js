		...
		},
		{
			...
			items: [
				...
				"http/openid-connect",
				{
					label: "Policies",
					type: "category",
					link: { type: "doc", id: "http/policies/index" },
					items: [
						"http/policies/index",
						"http/policies/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "http/policies/actions/index" },
							items: [{ type: "autogenerated", dirName: "http/policies/actions" }],
						},
					],
				},
		...
		},
		{
			...
			items: [
				...
				"tls/mutual-tls",
				{
					label: "Policies",
					type: "category",
					link: { type: "doc", id: "tls/policies/index" },
					items: [
						"tls/policies/index",
						"tls/policies/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "tls/policies/actions/index" },
							items: [{ type: "autogenerated", dirName: "tls/policies/actions" }],
						}
					]
				},
				"tls/tls-termination",
		...
		},
		{
			...
			items: [
				...
				"tcp/ip-restrictions",
				{
					label: "Policies",
					type: "category",
					link: { type: "doc", id: "tcp/policies/index" },
					items: [
						"tcp/policies/index",
						"tcp/policies/expressions",
						{
							label: "Actions",
							type: "category",
							link: { type: "doc", id: "tcp/policies/actions/index" },
							items: [{ type: "autogenerated", dirName: "tcp/policies/actions" }],
						}
					]
				}
			],
