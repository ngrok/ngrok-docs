...
<ConfigField title="metadata" type="map[string]any" required={true} cel={true}>
	A key-value map of metadata that you would like to include in your events for
	this action.
</ConfigField>
...
<ConfigField title="actions.ngrok.log.metadata" type="object">
	A key-value map containing metadata that was logged during the action. Each
	key represents a metadata attribute, and the value provides its corresponding
	details.
</ConfigField>
