---
title: Add Headers Action Examples
sidebarTitle: Examples
description: Try out some examples that use the Add headers action to modify requests and responses that pass through your endpoint.
---
