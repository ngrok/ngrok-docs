...
- You may not use this action to add the `ngrok-skip-browser-warning` header to skip the ngrok browser warning on free accounts. For more information, check out the [free plan limits guide](/guides/limits/#why-is-there-an-interstitial-in-front-of-my-html-content).
