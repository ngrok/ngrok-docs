...
is successful, the action allows the request to continue through the action chain and finally 
...
8 characters and no more than 128 characters. The username can neither be empty nor can it exceed 
