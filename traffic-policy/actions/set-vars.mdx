...
import { ConfigField } from "/snippets/ConfigTable.jsx"; import { ConfigChildren } from "/snippets/ConfigChildren.jsx"; import NonTerminatingExplanation from "/snippets/traffic-policy/common/non-terminating-explanation.mdx";

The **Set Vars** action is used to define or update global variables in a Traffic Policy's runtime context.
Subsequent actions or expressions can reference these variables for conditional logic through expressions or dynamic interpolation.
...
Variables you define in the `set-vars` action are scoped to the Traffic Policy and are not accessible outside of it.
