...
| `mutual_tls_certificate_authorities` | `[]string` | A list of PEM-encoded certificates or Certificate Authority IDs that are trusted for mutual TLS authentication.                                      |
