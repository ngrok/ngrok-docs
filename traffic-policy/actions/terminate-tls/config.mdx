...
| `mutual_tls_certificate_authorities`   | `[]string` | A list of PEM-encoded certificates that are trusted as Certificate Authorities for mutual TLS authentication.                                        |
| `mutual_tls_certificate_authority_ids` | `[]string` | A list of [Certificate Authority](/docs/api/resources/certificate-authorities/) IDs that are trusted for mutual TLS authentication.                  |
