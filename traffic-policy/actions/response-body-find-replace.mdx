...
The Response Body Find & Replace action enables you to modify HTTP response body content by finding and replacing text patterns using regular expressions.
This is useful for redacting sensitive information in responses, transforming data formats, or modifying AI model outputs before they reach clients.
