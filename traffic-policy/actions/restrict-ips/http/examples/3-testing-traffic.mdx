...
configuration demonstrates how to test restricting IPs using the [`log`](/docs/http/traffic-policy/actions/log/) 
...
without enforcing it, then log the result using the [`log`](/docs/http/traffic-policy/actions/log/) 
action.
