...
<Note>
	This page relates to requiring OAuth for visitors to access your endpoints. To configure OAuth and SSO providers for signing into the ngrok dashboard, see [the dashboard SSO documentation](/iam/sso).
</Note>

The **OAuth** Traffic Policy action restricts access to to your endpoints to only authorized users
