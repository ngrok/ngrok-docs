    ...
    <ConfigItem title="jws" type="object" required={true}>
        ...
        <ConfigChildren>
            ...
            <ConfigItem title="keys" type="array of objects" required={true}>
                ...
                <ConfigChildren>
                    <ConfigItem title="keys[*].identification" type="array of objects" required={true}>
                        <p>JWT metadata.</p>
                        <ConfigChildren>
                            <ConfigItem title="keys[*].identification[*].token_claims" type="array of strings" required={true}>
