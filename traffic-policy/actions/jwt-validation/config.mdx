    ...
    <ConfigItem title="issuer" type="object" required={true}>
        ...
        <ConfigChildren>
            <ConfigItem title="allow_list" type="array of objects" required={true}>
                ...
                <ConfigChildren>
                    <ConfigItem title="allow_list[*].value" type="string" required={true} cel={true}>
        ...
        <ConfigChildren>
            <ConfigItem title="tokens" type="array of objects" required={true}>
                ...
                <ConfigChildren>
                    ...
                    <ConfigItem title="tokens[*].name" type="string" required={true} cel={true}>
                    ...
                    <ConfigItem title="tokens[*].prefix" type="string" cel={true}>
            ...
            <ConfigItem title="keys" type="array of objects" required={true}>
                ...
                <ConfigChildren>
                    ...
                    <ConfigItem title="keys[*].sources" type="array of objects" required={true}>
                        ...
                        <ConfigChildren>
                            <ConfigItem title="keys[*].sources[*].additional_jkus" type="array of strings" required={true} cel={true}>
