...
{/*
Commenting out the max_session_duration as well because it is not being enforced
...
{/*
Commenting this field out until the policy editor doesnt error out when parsing it
