...
This action evaluates rules for request headers and body (when `process_body` is enabled), and each matching rule adds to the overall score of a request. If 
...
Included in these defaults is an inbound anomaly score threshold of 5 and a [paranoia level](https://coreruleset.org/docs/2-how-crs-works/2-2-paranoia_levels/) of 1.
