...
The `owasp-crs-request` action only enables rule detection on *incoming* HTTP requests to your
endpoint. In addition to this action, it is also recommended to enable the [OWASP/CRS Response
action](/traffic-policy/actions/owasp-crs-response/) to analyze *outgoing* HTTP responses from your endpoint 