...
import { ConfigField } from "/snippets/ConfigTable.jsx"; import ActionVariablesDescription from "/snippets/traffic-policy/common/action-variables-description.mdx"; import NonTerminatingExplanation from "/snippets/traffic-policy/common/non-terminating-explanation.mdx";
...
<ConfigField
  title="credentials" type="array of strings" required={true} cel={true} >
  <p>
...
<ConfigField
  title="actions.ngrok.basic_auth.credentials.presented" type="bool" required={false} >
  <p>
...
<ConfigField
  title="actions.ngrok.basic_auth.credentials.username" type="string" required={false} >
  <p>The username of the credentials presented.</p>
</ConfigField>

<ConfigField
  title="actions.ngrok.basic_auth.credentials.authorized" type="bool" required={false} >
  <p>
