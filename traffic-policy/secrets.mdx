...
<Warning>
	Secrets and vaults are free to use during the Developer Preview and Open Beta
	phase. **This feature _will_ be billed and metered in the future, per the plan
	details below**.
</Warning>
