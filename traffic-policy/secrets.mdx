...
<Info>  Secrets interpolated into certain actions may appear in cleartext in Traffic Inspector when full capture mode is enabled
...
<Warning>  Secrets and vaults are currently free to use. **This feature _will_ be billed and metered in the future, per the plan details below**.
