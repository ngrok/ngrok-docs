...
To use secrets, you'll need to create a vault to store them in. REST APIs are provided on the ngrok service for both [Vaults](/api/resources/vaults/) and [Secrets](/api/resources/secrets/).
