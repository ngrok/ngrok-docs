...
A Traffic Policy document is a YAML (or JSON) object.
The top-level keys are phase names: `on_tcp_connect`, `on_http_request`, and `on_http_response`.
Each phase holds an ordered list of rules with optional expressions and required actions.
