...
<Columns cols={2}>
	<Card title="How It Works" href="/traffic-policy/how-it-works" horizontal>
		Learn how Traffic Policy works under the hood.
	</Card>
	<Card title="Get Started" href="/traffic-policy/getting-started/agent-endpoints/cli/" horizontal>
		Create your first Traffic Policy and start an endpoint to see it in action.
	</Card>
	<Card title="Actions" href="/traffic-policy/actions/" horizontal>
		Actions are how you react manage traffic in your Traffic Policies. They allow you to modify request headers, transform response bodies, and more.
	</Card>
	<Card title="Examples" href="/traffic-policy/examples/" horizontal>
