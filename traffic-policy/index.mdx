...
<Card
	arrow={false}
	cta="Get started with Traffic Policy"
...
<Card href="/traffic-policy/examples/">
	<div className="flex-cols">
		...
		<p className="mt-4">
			Dive into practical examples, use-cases, and guides to see traffic
			policies in action.
		</p>
	</div>
</Card>
...
<Columns cols={3}>
	...
	<Card href={`/traffic-policy/variables/`}>
		<div className="flex-cols">
			...
			<p className="mt-4">
				Use variables to filter, segment, and dynamically configure traffic
				rules and actions based on specific conditions.
			</p>
		</div>
	</Card>
	<Card href={`/traffic-policy/macros/`}>
		<div className="flex-cols">
			...
			<p className="mt-4">
				Apply macros in rule conditions to refine traffic segmentation and
				configure actions with dynamic precision.
			</p>
		</div>
	</Card>
</Columns>
