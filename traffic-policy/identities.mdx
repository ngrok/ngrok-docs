...
![Diagram showing users authenticating via OAuth, OpenID Connect, or SAML through ngrok to reach apps, with app and user session data providing identity context](/img/docs/identities-app-user-session-diagram.png)
