...
Available in [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request) and [`on_http_response`](/traffic-policy/concepts/phases/#on_http_response) phases.
...
Available in [`on_http_response`](/traffic-policy/concepts/phases/#on_http_response) phase only.
...
For more information on secrets, see [Traffic Policy Secrets](https://ngrok.com/docs/traffic-policy/secrets/).
