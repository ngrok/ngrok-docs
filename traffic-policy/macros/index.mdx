...
<Warning title="Security Notice">
  MD5 is considered cryptographically broken and should not be used for security
  purposes. Use SHA-256 or higher for security-sensitive applications.
</Warning>
...
<Warning title="Security Notice">
  SHA-1 is considered cryptographically weak and should not be used for security
  purposes. Use SHA-256 or higher for security-sensitive applications.
</Warning>
