...
ngrok offers a variety of CEL macros that can be used within the Traffic Policy engine to simplify [traffic management](../concepts/expressions) and [dynamic configuration](/traffic-policy/how-it-works#cel-interpolation).  
