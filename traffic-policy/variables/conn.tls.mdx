...
| [`conn.tls.negotiated_alpn`](#conntlsnegotiatedalpn)             | `string` | TLS Application-Layer Protocol Negotiation (ALPN) Protocol ID of the protocol agreed upon in the TLS handshake                           |
...
<ConfigExample
	config={{
		expressions: ["conn.tls.negotiated_alpn == 'h2'"],
	}}	
>
...
<ConfigExample
	config={{
		expressions: ["conn.tls.session_resumed == false"],
	}}
>
