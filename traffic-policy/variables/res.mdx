...
| [`res.cookies[k][i].unparsed_attributes`](#rescookieskiunparsed_attributes) | `map[string]strin`g | Any non-standard attributes of the cookie parsed as a map of names to values . |
