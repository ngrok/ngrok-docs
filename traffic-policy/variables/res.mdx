...
| [`res.cookies`](#rescookies)                                                | map[string][]cookie | The HTTP cookie objects included in this response. If there are multiple cookies with the same name, they will be ordered path length, with longest path first. |
