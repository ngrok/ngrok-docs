...
- **Conditionally handle traffic** through [Expressions](/traffic-policy/how-it-works#expressions).
- **Dynamically configure actions** using [CEL interpolation](/traffic-policy/how-it-works#cel-interpolation).
