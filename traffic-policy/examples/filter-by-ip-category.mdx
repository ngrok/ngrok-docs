...
You can reference these in Traffic Policy [expressions](/traffic-policy/concepts/cel-interpolation) to allow or block traffic without maintaining lists of CIDRs by hand.
...
Other common provider categories include `com.aws`, `com.google`, `com.azure`, and `com.cloudflare`.
