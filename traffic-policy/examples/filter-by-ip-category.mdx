...
You can reference these in Traffic Policy [expressions](/traffic-policy/concepts/cel-expressions) to allow or block traffic without maintaining lists of CIDRs by hand.
