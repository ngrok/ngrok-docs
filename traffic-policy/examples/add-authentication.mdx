...
This rule adds key-based rate limiting to your endpoints based on your consumers' JWTs. See the [Auth0 guide](/integrations/jwt/auth0-jwt.mdx) for more information.
