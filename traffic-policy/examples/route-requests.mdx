...
Traffic Policy uses [CEL expressions](/traffic-policy/how-it-works#expressions) and [interpolation](/traffic-policy/concepts/cel-interpolation) to dynamically route requests to different internal endpoints.
