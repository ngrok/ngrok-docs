...
<Note>
  All routing examples use the [`forward-internal`
  action](/traffic-policy/actions/forward-internal/) to send traffic to internal
  endpoints. See the action reference for configuration details.
</Note>
