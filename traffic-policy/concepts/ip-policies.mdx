...
In the dashboard UI, you can apply [IP Restrictions](/traffic-policy/examples/add-authentication#ip-restrictions) to users trying to sign into your ngrok dashboard, traffic trying to access your API or Endpoints, and source IPs trying to start Agent Endpoints on your account.
