...
In Traffic Policy, Actions define what happens when a [Rule](/traffic-policy/how-it-works#phase-rules) on a [Phase](/traffic-policy/how-it-works#phases) conditions are met. 
