...
[Traffic Policy](/traffic-policy/) enables you to manage traffic to your ngrok endpoints by dynamically implementing logic based on the request before it reaches your upstream services. This guide will teach you how to configure an [Agent Endpoint](/endpoints/agent-endpoints) with a custom Traffic Policy using the [ngrok Agent CLI](/agent/cli/).
