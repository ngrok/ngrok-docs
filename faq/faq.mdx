...
Equinox is 100% owned by ngrok (if you visit equinox.io you’ll see it redirect to https://ngrok.com/downloads). We have exclusive access to its source code and its operational infrastructure. No other software is distributed via equinox.
