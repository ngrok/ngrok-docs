---
title: Configure Site-to-Site Connectivity for Databses
...
to locally running databases. The connection will be end-to-end encrypted using mutual TLS (mTLS).
...
```curl
curl -H "Content-Type: application/json" \
-X POST https://agent.configurable-domain.com/api/tunnels \
