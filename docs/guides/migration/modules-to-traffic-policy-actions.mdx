...
| `webhook_validation`               | [`webhook-verification`](/docs/traffic-policy/actions/webhook-verification)                                                                                            | [`on_http_request`](/docs/traffic-policy/concepts/phases/#on_http_request)   | Validate webhook secrets.               |
...
- [`webhook-verification`](/docs/traffic-policy/actions/webhook-verification)
