...
## 🛡️ 1. OAuth Authentication (`oauth`)
...
## 🔑 2. OpenID Connect Authentication (`oidc`)
...
## 🔒 4. Mutual TLS and TLS Termination (`mutual_tls`, `tls_termination`)
...
## 📨 5. Request Headers (`request_headers`)
...
## 📤 6. Response Headers (`response_headers`)
...
## 📜 8. Webhook Validation (`webhook_validation`)
...
## 🧯 9. Circuit Breaker (`circuit_breaker`)
...
## 🚫 10. SAML Authentication (`saml`)

⚠️ **Manual Note:**

- Traffic Policy **does not currently** natively support SAML.
- You may want to try out OIDC or reach out to ngrok support.
