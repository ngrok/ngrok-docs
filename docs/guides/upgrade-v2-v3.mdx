...
- The following command flags have changed:
  - `-auth` -> [`--basic-auth`](/agent/cli/#ngrok-http-flags)
  - `-bind-tls` -> [`--scheme`](/agent/cli/#ngrok-http-flags)
  - `-hostname` -> [`--domain`](/agent/cli/#ngrok-http-flags)
  - `-subdomain` -> [`--domain subdomain.ngrok-free.dev`](/agent/cli/#ngrok-http-flags)
