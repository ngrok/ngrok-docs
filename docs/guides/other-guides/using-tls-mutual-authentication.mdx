...
1. ngrok will not generate CA and client certificates for you; you must generate them.
1. Though your CA certificate must be uploaded and hosted on the ngrok SaaS platform, your client certificates will need to be distributed to any client/device that needs access to your endpoints.
