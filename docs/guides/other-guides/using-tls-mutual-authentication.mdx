...
You'll need a certificate authority (CA) for mTLS. The CA is responsible for issuing, digitally signing, and verifying the authenticity of client certificates.
...
3. ngrok will not generate CA and client certificates for you; you must generate them.
