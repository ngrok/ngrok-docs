...
For custom domains, use ngrok's [Automated TLS certificates](/universal-gateway/tls-certificates/what-is-automatic-certificate-management/) to have ngrok automatically provision a TLS certificate for your endpoint from Let's Encrypt.
