...
TLS Encryption is terminated at different locations depending on the ngrok endpoint type and configuration. See the documentation on [Terminating TLS Connections](/universal-gateway/tls-termination/) for more details.
