---
title: Use ngrok with Claude's MCP
...
[Claude.ai](https://www.anthropic.com/news/introducing-claude) now supports **Custom MCP (Messages Control Protocol) Integrations** — allowing it to interact with your own tools and APIs via structured function calls.
...
Some of the smartest folks on the internet are already using **ngrok** to do this in seconds. [See Skylar's announcement tweet here](https://x.com/scottjswanson/status/1779928604896129399).
...
### 1. Install and set up ngrok locally

Follow the instructions in [the getting started guide](https://ngrok.com/docs/getting-started/#1-install-ngrok) to set up ngrok on your local machine and connect your account.
