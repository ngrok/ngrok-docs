...
`ngrok config edit` - Opens the configuration file in an editor defaulting to nano or Notepad depending on OS. You may also open the configuration file in an editor of your choice.
