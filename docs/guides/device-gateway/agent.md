...
[global load balancing](/docs/network-edge/gslb/). You can also specify 
any of the default locations in the `server_addr` property and the agent will always 
connect using the address provided.  
