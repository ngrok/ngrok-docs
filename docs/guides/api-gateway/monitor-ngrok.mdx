...
You can monitor API services in two ways in ngrok: with the [Traffic Inspector](/docs/obs/traffic-inspection/) and with [Logs](/docs/obs/events).
...
As mentioned earlier, ngrok emits [audit logs](/docs/obs/events/reference/#audit-events) for any security changes.
