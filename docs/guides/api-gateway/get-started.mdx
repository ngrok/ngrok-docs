...
[endpoint](/traffic-policy/examples/#rate-limit-for-specific-endpoint),
[authentication status](/traffic-policy/examples/#rate-limit-api-consumers-based-on-authentication-status),
or [pricing tier](/traffic-policy/examples/#rate-limit-api-consumers-based-on-pricing-tiers).
