...
[endpoint](/traffic-policy/templates/#rate-limit-for-specific-endpoint),
[authentication status](/traffic-policy/templates/#rate-limit-api-consumers-based-on-authentication-status),
or [pricing tier](/traffic-policy/templates/#rate-limit-api-consumers-based-on-pricing-tiers).
...
[rules gallery](/traffic-policy/templates/) to learn how to extend your traffic policy rules.
