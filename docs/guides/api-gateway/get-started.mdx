...
[ngrok-managed domain](/universal-gateway/domains-and-tcp-addresses/#ngrok-managed-domains), but you can use
your own [branded domain](/universal-gateway/domains-and-tcp-addresses/#branded-domains) when you're ready for production.
