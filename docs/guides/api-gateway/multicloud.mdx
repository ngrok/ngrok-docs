...
1. Learn [how to monitor your API traffic](/guides/other-guides/monitor-ngrok/), so you'll know how your service is performing at all times, and be alerted to errors.
