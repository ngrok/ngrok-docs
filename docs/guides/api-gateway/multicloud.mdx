...
3. Learn [how to monitor your API traffic](/docs/guides/api-gateway/monitor-ngrok/), so you'll know how your service is performing at all times, and be alerted to errors.
