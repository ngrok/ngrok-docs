...
```
ngrok http 4000 --url https://foo.internal --pooling-enabled=true
```
...
You can now start to send requests.
...
```json
{"message":"Hello from cloud A!","host":"localhost:4000","req_headers":{"host":"localhost:4000","user-agent":"curl/8.5.0","accept":"*/*"},"method":"GET","url":"/","time":"2025-02-06T21:44:23.116Z","status":200}
```
...
- Continue your API gateway tutorial by [adding and composing traffic management
  policies](/docs/guides/api-gateway/add-traffic-policy) to finish offloading
