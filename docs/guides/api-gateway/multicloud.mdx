...
running multiple "replicas" of [httpbin](https://httpbin.org/), a simple
...
`https://foo.internal`. Replace `8080` if you've brought your own API service.
...
All requests to `{YOUR_NGROK_DOMAIN}` are forwarded to your load-balanced pool
of replicas


At this point, you have a front door to your multicloud API gateway with a
cloud endpoint! It's ready to forward to your endpoint pool for automatic load
...
At this point, you have a functional multicloud API gateway with ngrok.
