...
- **A Kubernetes cluster**—see our [local cluster options](/docs/k8s/guides/local-cluster) doc for some options.
...
4. Learn [how to monitor your API traffic](/docs/guides/api-gateway/other-guides/monitor-ngrok/), so you'll know how
