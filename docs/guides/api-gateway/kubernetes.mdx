...
To deploy the ngrok API service to your cluster, create the `prod` namespace.

```bash
kubectl create namespace prod
```

Next, apply the [`deployment.yaml` file](https://github.com/ngrok-samples/ngrok-api-service/blob/main/kubernetes/deployment.yaml) to your cluster.
