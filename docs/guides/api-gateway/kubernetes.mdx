...
to ngrokuction with additional features and protection, like rate limiting,
...
<Tabs groupId="config_example" queryString="config">
	<TabItem value="step-00" label="Current state">
		<img src={require("./img/api-g-k8s_step0.png").default} className="border-1" />
	</TabItem>
	<TabItem value="step-01" label="Step 1">
		<img src={require("./img/api-g-k8s_step1.png").default} className="border-1" />
	</TabItem>
	<TabItem value="step-02" label="Step 2">
		<img src={require("./img/api-g-k8s_step2.png").default} className="border-1" />
  </TabItem>
	<TabItem value="step-03" label="Step 3">
		<img src={require("./img/api-g-k8s_step3.png").default} className="border-1" />
	</TabItem>
	<TabItem value="step-result" label="Result">
		<img src={require("./img/api-g-k8s_result.png").default} className="border-1" />
	</TabItem>
</Tabs>
...
<div className="ngrok--cards ngrok--cards-row">
	<div className="ngrok--card ngrok--card-sm">
		...
		<p>
			Any tier will do&mdash;<a href="">register now</a>.
		</p>
	</div>
	<div className="ngrok--card ngrok--card-sm">
		<div className="ngrok--card-heading jc-space-between">
		...
		<p>
			Grab yours in the <a href="">ngrok dashboard</a>.
		</p>
	</div>
</div>
<div className="ngrok--cards ngrok--cards-row">
...
Edit your existing `ngrok-api-gateway.yaml` `HTTPRoute` to include the reference to the rate limiting policy.
