---
title: How to do Weighted Round-Robin Load Balancing with ngrok Cloud Edges
...
**Weighted Round-robin load balancing** while similar to [round-robin load balancing](/docs/guides/how-to-round-robin-load-balance-tunnels-with-ngrok-cloud-edges/) 
