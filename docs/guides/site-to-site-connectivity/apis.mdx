...
Next, create a custom [wildcard domain](/docs/universal-gateway/domains-and-tcp-addresses/#wildcard-domains), which will allow you to
...
These are custom addresses for ngrok’s global [Points of Presence (POPs)](http://localhost:3000/docs/universal-gateway/#points-of-presence).
