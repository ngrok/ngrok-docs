...
:::tip 
Ready to educate the customers you’re using site-to-site connectivity with to with additional
information about what ngrok is, our security practices, and how to operate the
ngrok agent? Send them to our [end customer installation guide](end-customers.mdx).
:::
