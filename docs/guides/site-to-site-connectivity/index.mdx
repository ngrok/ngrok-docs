...
![A diagram outlining the site-to-site connectivity architecture that will be configured in thi](./img/scenario.png)
...
### Step 1: Create a bot user and authtoken to enable isolated agent management
...
### Step 2: Define internal endpoints in ngrok.yml for privatized device access
...
### Step 3: Reserve a custom wildcard domain
...
### Step 4: Reserve a TCP address for your TCP-based cloud endpoint
...
### Step 5: Create your cloud endpoints for persistent API and database access
...
### Step 6: Secure your endpoints with Traffic Policy
...
You officially made it! You have now integrated a system that allows you to seamlessly and securely access any and all remote resources within your customer's network. Let's recap what what you've built:
...
Not sure how to explain ngrok to your end users? Check out [the guide on ngrok's standards on security, trust, compliance, and privacy](
/docs/guides/site-to-site-connectivity/end-customers/).
