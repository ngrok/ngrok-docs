...
2. **TLS termination at the ngrok agent**. Often referred to as [zero-knowledge TLS](/tls/termination/#zero-knowledge-tls), this model encrypts your TLS tunnels end-to-end, using filesystem paths to your TLS certificate and key, without requiring you to reconfigure your upstream service for TLS termination.
3. **TLS termination at your upstream service**. This model implements [end-to-end zero-knowledge encryption](/tls/termination/#zero-knowledge-tls), where the ngrok network forwards unterminated connections through to your upstream application.
