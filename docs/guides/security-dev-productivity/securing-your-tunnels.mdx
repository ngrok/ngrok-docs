...
It is possible to specify the minimum TLS version that clients are required to use to talk to the ngrok cloud service for your endpoint. See [the mTLS guide](/docs/agent/mutual-tls-termination/) for more details.
