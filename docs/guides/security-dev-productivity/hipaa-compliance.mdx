...
- [Use managed certificates](https://ngrok.com/docs/universal-gateway/tls-certificates/#automated). ngrok will automatically provision and renew TLS certificates on your behalf. 
