...
| Salesforce        | [ngrok's Dashboard SSO with Salesforce OAuth and OIDC guide](https://ngrok.com/docs/integrations/salesforce/dashboardssowithoidc) and the [official documentation](https://developer.salesforce.com/docs/atlas.en-us.api_rest.meta/api_rest/intro_oauth_and_connected_apps.htm) |
