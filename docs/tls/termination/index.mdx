...
import AtEdgeJavascriptSdkExample from "/examples/javascript-sdk/tls-terminate-at-edge.mdx";
...
import CustomCertJavascriptSdkExample from "/examples/javascript-sdk/tls-terminate-at-edge-custom-cert.mdx";
...
<Tabs groupId="connectivity" queryString="cty">
	...
	<TabItem value="javascript-sdk" label="Javascript">
		<CustomCertJavascriptSdkExample />
	</TabItem>
	<TabItem value="python-sdk" label="Python">
