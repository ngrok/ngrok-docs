...
import Variables from "/docs/traffic-policy/variables/tls.mdx";
...
### Supported Variables and Macros

Here is a list of variable namespaces and macros supported in expressions:
