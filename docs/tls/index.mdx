...
import CustomDomainNodejsSdkExample from "/examples/nodejs-sdk/tls-terminate-at-edge-custom-domain.mdx";
...
import ReencryptUpstreamNodejsSdkExample from "/examples/nodejs-sdk/tls-reencrypt-upstream.mdx";
...
import ProxyProtoNodejsSdkExample from "/examples/nodejs-sdk/tls-proxyproto.mdx";
...
<TabItem value="nodejs-sdk" label="NodeJS">
<ReencryptUpstreamNodejsSdkExample />
</TabItem>
<TabItem value="python-sdk" label="Python">
