...
If the expressions of a traffic policy rule evaluate to true, the policy's actions will be executed. If multiple actions are defined
on a traffic policy rule, the actions will execute sequentially.
