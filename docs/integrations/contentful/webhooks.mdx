...
1. On the home page, click **Settings** on the top menu, click **Webhooks**, and then click **Add Webhook**.
...
1. On the home page, click **Media** on the top menu, click **Add Asset**, and then click **Single asset**.
...
1. On the home page the [Contentful site](https://contentful.com/), click **Settings** on the top menu, click **Webhooks**, click the name of your webhook, and then click the **Activity log** tab.
