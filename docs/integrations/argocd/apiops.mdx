...
1. Create a new domain or use your [dev domain](/universal-gateway/domains/#dev-domains). Navigate to the [**Domains** section](https://dashboard.ngrok.com/domains) of the ngrok dashboard and click **Create Domain** or **New Domain**. This domain will be your `$NGROK_DOMAIN` for the remainder of this guide.
...
1. Register the demo app with Argo CD, replacing `<YOUR-GITHUB-USERNAME>` to point to your fork of the demo API repository.
   ...
   ![Viewing all applications registered to an Argo CD instance](img/argo-tile.png)
