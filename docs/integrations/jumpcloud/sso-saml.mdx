...
1. On the **SAML** page of your [ngrok edge](https://dashboard.ngrok.comedges), click the three dots close to the **SP Metadata** field, click **Download XML File**, and then save the XML file on your desktop.
