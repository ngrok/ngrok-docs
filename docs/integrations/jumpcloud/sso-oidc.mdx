...
This article details how to configure JumpCloud as the primary Identity Provider for ngrok endpoints.
...
To configure ngrok endpoints with JumpCloud, you must have:
