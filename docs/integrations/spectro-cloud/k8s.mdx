...
1. Create a domain for ingress or use your [dev domain](/universal-gateway/domains/#dev-domains). Navigate to the [**Domains** section](https://dashboard.ngrok.com/domains) of the ngrok dashboard and click **Create Domain** or **New Domain**. This domain will be your `$NGROK_DOMAIN` for the remainder of this guide.
