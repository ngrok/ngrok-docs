...
**Note:** This integration requires an ngrok Pay-as-you-go plan because Facebook validates your ngrok domain.
...
1. On the left menu, under **Universal Gateway**, select **Domains**.
   **Tip:** If you don't have an ngrok Pay-as-you-go plan, subscribe for one by clicking **Update Subscription** and following the subscribe procedure.
