...
1. On the **Webhooks** page, scroll down to the **Address Activity** section, click the 3 dots for the webhook you registered, and then click **Send Teste Notification**.
