...
1. Access the [Alchemy dashboard](https://wwww.alchemy.io/) and sign in using your Alchemy account.
...
Alchemy sends different request body contents depending on the event that is being triggered.
