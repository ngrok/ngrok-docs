...
1. On the **Webhooks** page, click **Create Webhook** for one of the types presented on the screen. In this tutorial, click **Create Webhook** for the **Address Activity** type.
...
1. Access the [Alchemy dashboard](https://dashboard.alchemy.io/) and sign in using your Alchemy account.
...
1. Restart your ngrok agent by running the command, replacing `{your api secret}` with the value you have copied before:
   ...
   ```bash
   ngrok http 3000 --verify-webhook Alchemy --verify-webhook-secret {your api secret}
   ```
