...
This guide walks you through enabling Salesforce as an Identity Provider to allow single sign-on into your ngrok dashboard. 
...
Begin by creating and configuring a new External Client App in Salesforce:

### Create a new External Client App

   ![Create External Client App](img/external_client_create.png)

### Configure the new External Client App
...
### Get your Salesforce Client ID and Client Secret 

These can be found in OAuth Settings.

   ![Client ID and Secret](img/keyandsecret.png)

## 2. Configure ngrok

Now, configure Single Sign-On (SSO) for your ngrok account:
