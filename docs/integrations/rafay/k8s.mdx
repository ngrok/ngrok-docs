...
1. Add a repository for the ngrok Kubernetes Operator to Rafay by clicking **Integrations&rarr;Repositories**. Give the repository a name like `ngrok-kubernetes-ingress-controller`.
