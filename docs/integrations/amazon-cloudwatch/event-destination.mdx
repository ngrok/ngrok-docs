...
1. Using a browser, go to the [ngrok dashboard](https://dashboard.ngrok.com) and navigate to **Events** under the **Observability** section on the left hand navigation and select **Create Subscription**.
