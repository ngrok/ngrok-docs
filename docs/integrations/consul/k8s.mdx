...
1.  Install the ngrok Kubernetes Operator
    ...
    Check out our [Operator installation doc](/docs/k8s/installation/install/) for details on how to use Helm to install with your ngrok credentials. Once you've done that, you can run the command below to set the appropriate annotations.
