...
We recommend reserving a domain for ingress if you don't have one already.
Navigate to the [**Domains** section](https://dashboard.ngrok.com/domains) of
the ngrok dashboard and click **Create Domain** or **New Domain**. This will be
your `NGROK_DOMAIN` for the remainder of this guide.

Now that you have a Kubernetes cluster running on AKS, you can install
