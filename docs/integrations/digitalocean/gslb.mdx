...
- Using `curl` with the ngrok API's [`/edges/https/{edge_id}/routes/{id}/policy` endpoint](/docs/api/resources/edge-route-traffic-policy-module.mdx). For this step, you will need to have exported the `ROUTE_ID` environment variable in step #4.
