...
This article details how to configure Curity as the primary Identity Provider for ngrok endpoints.
...
- **Use Curity security policies, MFA authenticators** — including BankId, SITHS, and WebAuthn — **to control access to ngrok endpoints**.
- **Use Curity's Dashboard to facilitate access to ngrok apps**.

## Requirements

To configure ngrok endpoints with Curity, you must have:
