...
Next, you need to reserve your subdomain with an [ngrok-managed domain](/universal-gateway/domains/) like `.ngrok.app`, `.ngrok.dev`, `.ngrok.pro`, or even `.ngrok.pizza`. For an example deployment like this, `YOUR_COMPANY-linode-gslb.ngrok.app` would work great.
