...
title: ngrok Kubernetes Operator on GKE
description: ngrok Kubernetes Operator on Google Kubernetes Engine (GKE)
tags:
  - kubernetes
  - k8s
...
1. To confirm the circuit breaking configuration is successfully applied:
   ...
   1. Go to [ngrok Dashboard](https://dashboard.ngrok.com) > [Edge Configurations](https://dashboard.ngrok.comedges).
