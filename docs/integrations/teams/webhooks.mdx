...
1. On the left menu, under **Universal Gateway**, select **Domains**.
   **Tip:** If you don't have an ngrok Pay-as-you-go plan, sign up for one by clicking **Update Subscription** and following the subscribe procedure.
