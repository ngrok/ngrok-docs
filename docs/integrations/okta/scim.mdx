...
This document assumes you have already set up [Okta for dashboard SSO](/guides/other-guides/dashboard-sso-okta-setup). Once you've completed those steps, you can continue here.
