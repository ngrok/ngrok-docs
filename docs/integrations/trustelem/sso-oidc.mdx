...
This article details how to configure Wallix Trustelem as the primary Identity Provider for ngrok endpoints.
...
To configure ngrok endpoints with Wallix Trustelem, you must have:
