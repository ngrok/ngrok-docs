...
**Note:** This integration requires a ngrok Pro or Enterprise license because Instagram validates your ngrok domain.
...
1. Access the [Meta for Developers](https://developers.facebook.com/) page, log in using your Instagram account, and then click **My Apps** on the top right corner.
