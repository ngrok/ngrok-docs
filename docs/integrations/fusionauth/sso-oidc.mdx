...
This article details how to configure FusionAuth as the primary Identity Provider for ngrok endpoints.
...
To configure ngrok endpoints with FusionAuth, you must have:
