...
**Note:** This integration requires an ngrok Pay-as-you-go plan because Facebook validates your ngrok domain and certificate.
...
1. On the left menu, under **Universal Gateway**, select **Domains**.
   **Tip:** If you don't have an ngrok Pay-as-you-go plan, sign up for one by clicking **Update Subscription** and follow the subscribe procedure.
