...
Alternatively, clone your repository locally, add some content, commit, and then push the content to your repository on Bitbucket:
`bash
...
- If you are running Bitbucket Cloud, use ngrok IP Restrictions to allow ingress access for a list of IP addresses.
  ...
  **Note:** This feature requires an ngrok Pay-as-you-go plan.
