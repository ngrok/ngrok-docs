...
**Note:** This integration requires a ngrok Pro or Enterprise license because WhatsApp validates your ngrok domain.
...
1. ngrok will display a URL where your localhost application is exposed to the internet (copy this URL for use with WhatsApp).
...
1. Access the [Meta for Developers](https://developers.facebook.com/) page, log in using your WhatsApp account, and then click **My Apps** on the top right corner.
