...
- **[Audit Events](/docs/events/reference/#audit-events)**: Changes to your account like create/update/delete of Domains, API Keys, IP Policies, etc.
...
- **[Audit Events](/docs/events/reference/#audit-events)**:
...
For [Audit Events](/events/reference#audit-events), the `object`
