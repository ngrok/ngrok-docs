...
a **Log Export** to _subscribe_ to a set of **Event Sources** and
_publish_ those events to one or more **Event Destinations**.

- **[Log Exporting](#log-exporting)**: Define which Event
...
You can create your first Log Export on the [Events page of your ngrok
...
## Log Exporting {#log-exporting}

Log Exporting defines which [Event Sources](/obs/events/reference/) to capture and which
...
Event Sources choose which events a Log Export captures. Other event
