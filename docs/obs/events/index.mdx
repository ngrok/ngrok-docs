...
Events](/docs/obs/reference/#traffic-events) since the velocity of these events can be quite high. Filters are a boolean
...
- [Azure Logs Ingestion](/docs/integrations/azure-logs-ingestion/event-destination/)
- [Datadog Logs](/docs/integrations/datadog/event-destination/)
