...
| `ua_filter_allow`            | Array of Strings                                                             | Allows User-Agents that match against these regexes                                                                                                                                                                                                                                               |
| `ua_filter_deny`             | Array of Strings                                                             | Denies User-Agents that match against these regexes                                                                                                                                                                                                                                               |
