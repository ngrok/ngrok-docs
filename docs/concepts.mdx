...
When adding a wildcard domain, you will need to configure two CNAME records in your DNS provider, a domain record as well as an automated TLS record, also known as an [ACME Challenge](https://letsencrypt.org/docs/challenge-types/#dns-01-challenge).
