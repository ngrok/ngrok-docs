...
- **API Gateway**: Use ngrok's [HTTP modules](/traffic-policy/actions/) to secure, protect,
...
- Load Balancer: Use [endpoint pooling](/universal-gateway/endpoint-pooling/) to load balance traffic for
