...
| `twitch` | [EndpointOAuthTwitch](#api-edge-route-o-auth-module-replace-parameters-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edge-route-o-auth-module-replace-parameters-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
...
| `twitch` | [EndpointOAuthTwitch](#api-edge-route-o-auth-module-replace-fields-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edge-route-o-auth-module-replace-fields-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
...
| `twitch` | [EndpointOAuthTwitch](#api-edge-route-o-auth-module-get-fields-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edge-route-o-auth-module-get-fields-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
#### EndpointOAuthGitHub fields
