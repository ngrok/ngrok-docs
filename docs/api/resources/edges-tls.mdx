...
| `mutual_tls` | [EndpointMutualTLS](#endpointippolicy-fields) |  |
...
| `uri` | string | URI of the edge API resource |
| `hostports` | List&lt;string&gt; | hostports served by this edge |
| `backend` | [EndpointBackend](#endpointbackend-fields-1) | edge modules |
| `ip_restriction` | [EndpointIPPolicy](#endpointippolicy-fields-1) |  |
| `mutual_tls` | [EndpointMutualTLS](#endpointippolicy-fields-1) |  |
| `tls_termination` | [EndpointTLSTermination](#endpointtlstermination-fields-1) |  |
...
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `backend` | [Ref](#ref-fields-1) | backend to be used to back this endpoint |
#### Ref fields
...
| `uri` | string | URI of the edge API resource |
| `hostports` | List&lt;string&gt; | hostports served by this edge |
| `backend` | [EndpointBackend](#endpointbackend-fields-2) | edge modules |
| `ip_restriction` | [EndpointIPPolicy](#endpointippolicy-fields-2) |  |
| `mutual_tls` | [EndpointMutualTLS](#endpointmutualtls-fields-2) |  |
| `tls_termination` | [EndpointTLSTermination](#endpointtlstermination-fields-2) |  |
#### EndpointBackend fields

| &nbsp; | &nbsp; | &nbsp; |
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `backend` | [Ref](#ref-fields-2) | backend to be used to back this endpoint |
#### Ref fields
...
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `ip_policies` | [Ref](#ref-fields-2) |  |
#### EndpointMutualTLS fields

| &nbsp; | &nbsp; | &nbsp; |
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `certificate_authorities` | [Ref](#ref-fields-2) | PEM-encoded CA certificates that will be used to validate. Multiple CAs may be provided by concatenating them together. |
#### EndpointTLSTermination fields
...
| `metadata` | string | arbitrary user-defined machine-readable data of this edge. Optional, max 4096 bytes. |
| `hostports` | List&lt;string&gt; | hostports served by this edge |
| `backend` | [EndpointBackendMutate](#endpointbackendmutate-parameters-1) | edge modules |
| `ip_restriction` | [EndpointIPPolicyMutate](#endpointippolicymutate-parameters-1) |  |
| `mutual_tls` | [EndpointMutualTLSMutate](#endpointmutualtlsmutate-parameters-1) |  |
| `tls_termination` | [EndpointTLSTermination](#endpointtlstermination-parameters-1) |  |
...
| `uri` | string | URI of the edge API resource |
| `hostports` | List&lt;string&gt; | hostports served by this edge |
| `backend` | [EndpointBackend](#endpointbackend-fields-3) | edge modules |
| `ip_restriction` | [EndpointIPPolicy](#endpointippolicy-fields-3) |  |
| `mutual_tls` | [EndpointMutualTLS](#endpointmutualtls-fields-3) |  |
| `tls_termination` | [EndpointTLSTermination](#endpointtlstermination-fields-3) |  |
...
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `backend` | [Ref](#ref-fields-3) | backend to be used to back this endpoint |
#### Ref fields
...
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `ip_policies` | [Ref](#ref-fields-3) |  |
#### EndpointMutualTLS fields

| &nbsp; | &nbsp; | &nbsp; |
|---|---|---|
| `enabled` | boolean | `true` if the module will be applied to traffic, `false` to disable. default `true` if unspecified |
| `certificate_authorities` | [Ref](#ref-fields-3) | PEM-encoded CA certificates that will be used to validate. Multiple CAs may be provided by concatenating them together. |
#### EndpointTLSTermination fields
