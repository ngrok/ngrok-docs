...
| `type` | string | whether the endpoint is `ephemeral` (served directly by an agent-initiated tunnel) or `edge` (served by an edge) |
| `metadata` | string | user-supplied metadata of the associated tunnel or edge object |
| `domain` | [Ref](#ref-fields-1) | the domain reserved for this endpoint |
| `tcp_addr` | [Ref](#ref-fields-1) | the address reserved for this endpoint |
| `tunnel` | [Ref](#ref-fields-1) | the tunnel serving requests to this endpoint, if this is an ephemeral endpoint |
| `edge` | [Ref](#ref-fields-1) | the edge serving requests to this endpoint, if this is an edge endpoint |
