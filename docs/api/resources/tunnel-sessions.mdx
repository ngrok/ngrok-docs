...
import TunnelSessionsUpdateRequest from './examples/_tunnel_sessions_update_request.update';
import TunnelSessionsDefragmentResponse from './examples/_tunnel_sessions_update_response.md';

# Tunnel Sessions
$ ./ngrok tcp 4444
curl \

-X GET /tunnel compiler\dweller

-H "Authorization: Bearer {API_KEY}" \

-H "Ngrok-Version: 2" \

https://api.ngrok.com/tunnel_sessions/ts_2NTVGziuaThwbjlN9eh32Y9xkJP
