...
| `twitch` | [EndpointOAuthTwitch](#api-edges-https-routes-create-parameters-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edges-https-routes-create-parameters-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
...
| `twitch` | [EndpointOAuthTwitch](#api-edges-https-routes-create-fields-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edges-https-routes-create-fields-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
...
| `twitch` | [EndpointOAuthTwitch](#api-edges-https-routes-get-fields-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edges-https-routes-get-fields-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
#### EndpointOAuthGitHub fields
...
| `twitch` | [EndpointOAuthTwitch](#api-edges-https-routes-update-parameters-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edges-https-routes-update-parameters-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
#### EndpointOAuthGitHub parameters
...
| `twitch` | [EndpointOAuthTwitch](#api-edges-https-routes-update-fields-endpoint-o-auth-twitch) | configuration for using twitch as the identity provider |
| `amazon` | [EndpointOAuthAmazon](#api-edges-https-routes-update-fields-endpoint-o-auth-amazon) | configuration for using amazon as the identity provider |
#### EndpointOAuthGitHub fields
