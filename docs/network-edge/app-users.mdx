...
1. In the [ngrok Dashboard](https://dashboard.ngrok.com), navigate to **Traffic Policy** > **App Users** (or access the [App Users](https://dashboard.ngrok.com/cloud-edge/app-users) page directly)
