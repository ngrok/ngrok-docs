...
Edges will soon be deprecated in favor of [Cloud Endpoints](/network-edge/cloud-endpoints). 
Cloud Endpoints offer all the functionality of Edges and more, while simplifying the complex 
module of Edges. Cloud Endpoint are currently in preview mode.
