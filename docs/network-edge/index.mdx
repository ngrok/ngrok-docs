...
[Domains](/core-concepts/#domains), [TCP Addresses](/core-concepts/#tcp-addresses),
...
[Domains](/core-concepts/#domains) and the host portion of all [TCP
Addresses](/core-concepts/#tcp-addresses) will return `AAAA` DNS records.
