...
Cloud endpoints are the new edges. Cloud endpoints offer all the functionality of edges and simplifies the module
and backends system of modules by putting everything behind traffic policies.
