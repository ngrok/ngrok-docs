...
examples:
  ...
  - slug: canary-deployments
    name: "Distribute Traffic Between Canary Deployments"
  ...
  - slug: blue-green-deployments
    name: "Switch Traffic Between Blue-Green Deployments"
  ...
  - slug: route-by-oidc
    ...
    description: "Use the data returned by your OIDC provider to route authenticated requests to specific upstream services."
    categories:
      - authn-authz
      - traffic-control
  ...
  - slug: ip-restrictions-jwt
    name: "Enforce IP Restrictions or JWT Validation"
  ...
  - slug: paas-alternative-gateway
    name: "Self-Hosted PaaS Alternative Gateway"
  ...
  - slug: agent-assisted-gateway
    name: "Agent-Assisted Gateway"
