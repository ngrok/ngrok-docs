...
- Read our [best practices for developer productivity](/docs/guides/security-best-practices/) guide for ways to improve this example with developer-specific authtokens and custom connect URLs.
