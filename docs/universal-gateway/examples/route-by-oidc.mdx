...
This pattern allows you to run management UI or API services on your internal ngrok network, but allow speciifc users or remote devices to access them without having to establish and maintain a routing topology based on subdomains or paths.
...
Start a second agent endpoint for another service you want to route to.
...
- Explore other examples of using the [`openid-connect` Traffic Policy action](/docs/traffic-policy/actions/oidc-connect/#examples).
