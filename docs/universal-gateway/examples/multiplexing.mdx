---
title: 'Multiplex to Mulpiple Internal Services from a Single Hostname'
description: ""
...
Multiplexing is a common gateway design where you host multiple services from a single top-level domain name.
...
1. Create [internal Agent Endpoints](/docs/universal-gateway/agent-endpoints/) that are only accessible from a Cloud Endpoint operating as your ["front door"](/docs/universal-gateway/examples/front-door-pattern) gateway.
...
4. Standardize how traffic gets moved and managed across all your services.
