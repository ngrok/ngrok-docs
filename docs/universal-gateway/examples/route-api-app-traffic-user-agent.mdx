...
sidebar_label: Routing by User Agent
---
...
In the first section, Traffic Policy checks whether the request's user agent comes from an API user, then applies the `jwt-validation` action.
