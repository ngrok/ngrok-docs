...
<ContentSwitcher language="bash">
    ...
    :::note
    If your Agent Config doesn't have hostname specified, and you create an endpoint, the hostname will also be randomly assigned. For example, if your Agent Config looks like this:
