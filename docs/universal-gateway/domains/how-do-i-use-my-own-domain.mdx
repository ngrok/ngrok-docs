...
1. When you create a Domain, you'll be given a `CNAME` value such as `exampledata.otherdata.ngrok-cname.com`. Copy it.
1. In a new tab, navigate to your domain hosting provider's dashboard and create a CNAME record. Check your hosting provider's support content or documentation to learn how.
