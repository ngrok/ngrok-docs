...
[binding](/universal-gateway/endpoints/overview/#binding). Consult the
...
- [Internal Endpoint URLs](/universal-gateway/endpoints/internal/#urls)
...
[Traffic Inspector](/obs/traffic-inspector) gives you a real-time view in the
...
[Domain](/univseral-gateway/domains) with automated certificate management
