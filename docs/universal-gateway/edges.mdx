...
::::warning
Edges, Routes, Modules, Backends and Labeled Tunnels are deprecated and will be sunset on December 25th, 2025. See the [Migration Guide](#migration-guide).
::::

### Sunset Date

Edges will be sunset and turned off on December 25th, 2025.
