...
create a public [cloud endpoint](/universal-gateway/cloud-endpoints/) where you
...
endpoints](/universal-gateway/agent-endpoints/).
...
- Internal endpoints support both [Endpoint
  Types](/universal-gateway/endpoints-overview/#type) (`agent` and `cloud`).
