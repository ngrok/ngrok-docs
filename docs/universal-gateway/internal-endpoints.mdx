...
- **Scheme** - Internal endpoints support all [Endpoint Protocols](/universal-gateway/endpoints/#protocol) (`http`, `https`, `tcp` and `tls`).
...
- Internal endpoints support both [Endpoint Types](/universal-gateway/endpoints/#type): `agent` and `cloud`.
...
[Endpoints API documentation](/universal-gateway/endpoints/#api).
