...
- **TLC** — Learn how [ngrok automatically handles TLS](/universal-gateway/tls-certificates/how-does-ngrok-handle-tls/) and [TLS termination](/universal-gateway/tls-termination/) for HTTP/S endpoints for you.
...
HTTP/S endpoints are available on all plans. Consult the [pricing](/pricing-limits/) documentation for billing details.

For limits, see the [HTTP/S Limits documentation](/pricing-limits/http-s-limits/).
