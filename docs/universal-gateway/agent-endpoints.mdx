---
sidebar_label: Using Agent Endpoints
title: What are Agent Endpoints?
description: Learn about creating endpoints managed by Secure Tunnel agents run on your local machines.
---
...
:::tip
The counterpart to Agent Endpoints are Cloud Endpoints, which are always-on and centrally managed via the ngrok API or Dashboard. See [the Cloud Endpoints documentation](/universal-gateway/cloud-endpoints/) for more information.
:::
