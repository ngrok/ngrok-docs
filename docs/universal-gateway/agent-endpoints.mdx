...
:::note
See the [Endpoint Types](/universal-gateway/endpoints/types) page for a full comparison between Agent and Cloud Endpoints.
:::
...
- **Bindings** - Agent endpoints support all [Endpoint
  Bindings](/universal-gateway/endpoints/#bindings) (`public`,
