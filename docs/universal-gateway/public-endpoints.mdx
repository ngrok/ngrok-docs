...
Public endpoints enable you to receive traffic from the internet via ngrok’s [global points of presence](/docs/network-edge/). This is the most common type of endpoint and the easiest way to start.
