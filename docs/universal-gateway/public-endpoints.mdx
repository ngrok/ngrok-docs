...
You can create a public endpoint using [the ngrok dashboard](https://dashboard.ngrok.com/endpoints) or [the ngrok API](/docs/api/resources/endpoints/#create-endpoint). Follow the [Getting Started](/docs/getting-started/) guide to set up an ngrok account and create your first public endpoint.
