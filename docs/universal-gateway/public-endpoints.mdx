...
Public endpoints enable your services to receive geo-balanced internet traffic using [ngrok's global points of presence](https://ngrok.com/docs/network-edge/).

All public endpoint URLs:

- Use HTTPS by default, with [TLS terminated at the ngrok edge](https://ngrok.com/docs/http/tls-termination/).
