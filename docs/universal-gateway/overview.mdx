---
title: What is a Universal Gateway?
pagination_next: universal-gateway/domains/what-are-domains
---
...
- [Domains →](/universal-gateway/domains/what-are-domains/)
- [TCP Addresses →](/universal-gateway/tcp-addresses/what-are-tcp-addresses/)
...
- [Learn more about TLS Certificates →](/universal-gateway/tls-certificates/how-does-ngrok-handle-tls/)
- [Learn more about the TLS Termination →](/universal-gateway/tls/tls-termination/)
