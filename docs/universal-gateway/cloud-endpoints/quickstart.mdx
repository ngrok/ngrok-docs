...
Now visit the URL you specified to ensure that your Cloud Endpoint is online. You should see the content available at the internal endpoint you're forwarding traffic to. If your internal endpoint is down, you should see the custom response you configured in your policy, which in thise case reads `Agent offline!`.
