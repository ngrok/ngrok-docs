...
| ----------------- | --------------------------------------------------------- |
| [HTTP](/http/)    | None                                                      |
| [HTTPS](/http/)   | Always at ngrok's cloud service.                          |
| [TLS](/tls/)      | Default no termination, configurable with `terminate-tls` |
| [TCP](/tcp/)      | Default no termination, configurable with `terminate-tls` |
