...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/kubernetes/crds/cloudendpoint/`}>
    ...
    <Link to={`/kubernetes/crds/agentendpoint/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/kubernetes/crds/ngroktrafficpolicy/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
    ...
    <Link to={`/kubernetes/crds/boundendpoint/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/kubernetes/crds/domain/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
    ...
    <Link to={`/kubernetes/crds/tunnel/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
	<Link to={`/kubernetes/crds/kubernetesoperator/`}>
		<div className="ngrok--card hover:bg-card-hover">
			<div className="ngrok--card-heading">
				<h3 className="text-md sm:text-base">KubernetesOperator</h3>
			</div>
			<p className="text-md flex-grow sm:text-sm">
				Configuration language that offers you the flexibility to filter, match,
				manage and orchestrate traffic to your endpoints.
			</p>
		</div>
	</Link>
</div>
