...
<Tabs groupId="full-path-kind" queryString="full-path-kind">
...
<Tabs groupId="path-prefix-kind" queryString="path-prefix-kind">
	<TabItem value="agent-endpoint" label="AgentEndpoint" default>
	Check out the [URL rewrite traffic policy action](/traffic-policy/actions/url-rewrite/) page for more details about how it functions and the parameters it accepts.
	...
	### 8. Create an `HTTPRoute` with a URLRewrite Filter
...
<Tabs groupId="port-kind" queryString="port-kind">
	<TabItem value="agent-endpoint" label="AgentEndpoint" default>
	Check out the [URL rewrite traffic policy action](/traffic-policy/actions/url-rewrite/) page for more details about how it functions and the parameters it accepts.
...
<Tabs groupId="hostname-kind" queryString="hostname-kind">
	<TabItem value="agent-endpoint" label="AgentEndpoint" default>
	Check out the [URL rewrite traffic policy action](/traffic-policy/actions/url-rewrite/) page for more details about how it functions and the parameters it accepts.
