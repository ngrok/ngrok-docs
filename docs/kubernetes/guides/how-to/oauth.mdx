...
❌ `Ingress` and Gateway API resources do not natively support OAuth enforcement, but they can be extended to take advantage of ngrok's [OAuth traffic policy action](/traffic-policy/actions/oauth/).
