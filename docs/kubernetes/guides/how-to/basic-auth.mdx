...
<Tabs groupId="kind" queryString="kind">
	...
	❌ `Ingress` resources do not natively support Basic Authentication, but they can be extended to take advantage of ngrok's [basic auth traffic policy action](/traffic-policy/actions/basic-auth/).
  </TabItem>
	<TabItem value="gateway-api" label="Gateway API">
	❌ Gateway API resources do not natively support Basic Authentication, but they can be extended to take advantage of ngrok's [basic auth traffic policy action](/traffic-policy/actions/basic-auth/).
  </TabItem>
</Tabs>
<!-- prettier-ignore-end -->
