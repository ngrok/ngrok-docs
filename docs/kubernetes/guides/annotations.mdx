...
For more information about using traffic policies with `Ingresses` and Gateway API, see [the using Ingresses page](/kubernetes/guides/using-ingresses) and [the using Gateway API page](/kubernetes/guides/using-gwapi).
      ...
      - name: custom-response-example
        ...
        actions:
          - type: custom-response
            config:
              status_code: 200
              content: "Custom response from your traffic policy"
              headers:
...
For more information about how the operator translates resources, see [the using Ingresses page](/kubernetes/guides/using-ingresses) and [the using Gateway API page](/kubernetes/guides/using-gwapi).
...
For more information about endpoint pooling, see [the pooling page](/kubernetes/guides/pooling)
