...
For a more in-depth guide on using `CloudEndpoints` to forward requests to other endpoints, see the [request routing guide](/kubernetes/guides/request-routing)
