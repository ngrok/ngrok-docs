...
The manager deployment is primarilly responsible for synchronizing the state of your resources with the ngrok API.
...
- `IPPolicy` (deprecated, will be removed soon)
...
For more information about bindings, see [the bindings guide](/kubernetes/guides/bindings)
