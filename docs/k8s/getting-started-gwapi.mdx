...
additional charge. You only incur costs if the resources provisioned by your usage of the Gateway API, such as endpoints or traffic policies, incur a cost. More information can be found on the [pricing page](https://ngrok.com/pricing)
