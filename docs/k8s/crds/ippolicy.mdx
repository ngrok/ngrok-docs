...
| 🚧 [`status.conditions`](#statusconditions) | `[]Object`        | TODO: Conditions describe the current conditions of the IP Policy                                                                       |
| 🚧 [`status.rules`](#statusrules)            | `[]Object`        | TODO: Status array of the different rules with a status for each rule                                                                   |
...
🚧 **TODO:** Conditions describe the current conditions of the IP Policy.

**Type:** `[]Object`

### 🚧 `status.rules`

🚧 **TODO:** Status array of the different rules with a status for each rule.
...
🚧 **TODO:** The ngrok operator will use several condition types to track the IP Policy lifecycle and provide detailed status information.
...
🚧 **TODO:** Future enhancement will allow referencing IP Policies by name in traffic policies for a more Kubernetes-native experience.