---
title: CloudEndpoint
pagination_next: kubernetes/crds/agentendpoint
---
...
They exist pemanently until they are explicitly deleted. Cloud Endpoints do not forward their traffic to an agent by default and instead only use their attached Traffic Policy to handle connections.
