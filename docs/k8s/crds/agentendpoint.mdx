...
Conditions describe the current conditions of the AgentEndpoint. The ngrok operator uses several condition types to track the endpoint lifecycle and provide detailed status information.
