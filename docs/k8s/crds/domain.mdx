...
| 🚧 [`status.acmeChallengeCnameTarget`](#statusacmechallengecnametarget) | `string` | TODO: ACMEChallengeCNAMETarget is the CNAME target for ACME challenge (wildcards only)                                                         |
| 🚧 [`status.certificate`](#statuscertificate)   | `Object`          | TODO: Certificate contains information about the TLS certificate                                                                               |
| 🚧 [`status.certificateManagementPolicy`](#statuscertificatemanagementpolicy) | `Object` | TODO: CertificateManagementPolicy contains the certificate management configuration                                                             |
| 🚧 [`status.certificateManagementStatus`](#statuscertificatemanagementstatus) | `Object` | TODO: CertificateManagementStatus contains the certificate management status                                                                   |
| 🚧 [`status.conditions`](#statusconditions)     | `[]Object`        | TODO: Conditions represent the latest available observations of the domain's state                                                             |
...
### 🚧 `status.acmeChallengeCnameTarget`

🚧 **TODO:** ACMEChallengeCNAMETarget is the CNAME target for ACME challenge (wildcards only).

**Type:** `string`

### 🚧 `status.certificate`

🚧 **TODO:** Certificate contains information about the TLS certificate.
...
### 🚧 `status.certificateManagementPolicy`

🚧 **TODO:** CertificateManagementPolicy contains the certificate management configuration.
...
🚧 **TODO:** CertificateManagementStatus contains the certificate management status.
...
🚧 **TODO:** Conditions represent the latest available observations of the domain's state. The ngrok operator uses several condition types to track the domain lifecycle and provide detailed status information.
