...
To get started with this, go to your dashboard and [create](https://dashboard.ngrok.comdomains) a custom ingress domain. Once created, you can configure the operator by using the following command:
