...
More details on how these are derived can be found [here](/docs/k8s/user-guide/ingress-to-edge-relationship).

Other ngrok features such as TCP Edges can be configured via [CRDs](/docs/k8s/user-guide/crds).

If you are looking to install the controller for the first time, see our [deployment-guide](/docs/k8s/deployment-guide/README).
If it's already installed and you are looking to configure ingress for an app or service, see our [user-guide](/docs/k8s/user-guide/README).
