...
You'll need to reserve a new domain or use your dev domain. To reserve a new domain, navigate to the dashboard, visit [the **Domains** section](https://dashboard.ngrok.com/domains), and select **+ New Domain**.
