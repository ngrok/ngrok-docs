...
The [ngrok Agent CLI](/agent/) is a zero-dependency CLI program that runs on all major operating systems.

This quickstart uses the ngrok CLI to put an app running on your local device online and secure it by requiring visitors to log in with a Google account to access it.
