---
title: ngrok Agent Endpoints CLI Quickstart
...
One of the most common use cases is to put an app running on your local device online—for example, to share a work in progress on the internet without hosting and publishing it.
...
This quickstart shows you how to use the CLI for this purpose, as well as how to implement basic security measures by requiring visitors to log in with a Google account to access it.
