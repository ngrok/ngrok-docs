...
After logging in, you will either see your app or service, or, if you used the example app in this quickstart, you'll see "Hello from Go HTTP Server!" displayed in your browser.
