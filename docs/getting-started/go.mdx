...
- **Line 39**: Print the authenticated user's email address from a request header. [See what headers are populated by the OAuth Module.](/traffic-policy/actions/oauth/#upstream-headers)
