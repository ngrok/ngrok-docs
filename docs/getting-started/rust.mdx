...
```rust filename="ngrok-rust-server/src/main.rs"
...
```rust filename="ngrok-rust-demo/src/main.rs"
#![deny(warnings)]
...
Assuming everything is set up correctly, this should print reserved domain URL to the terminal.
