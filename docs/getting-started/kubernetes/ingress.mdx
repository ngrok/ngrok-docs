...
You can also choose to add it as the backend for a specific rule or the default backend—see our [Ingresses doc](/docs/k8s/guides/using-ingresses/#using-ngroktrafficpolicy-with-ingress) for details and why you would choose option over another.
