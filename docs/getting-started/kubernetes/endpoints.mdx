...
- No need to expose your local services to the public internet
- No modifications or ingress rules required to your clusters
- Works with both cloud and agent endpoints
...
Read our [blog post](https://ngrok.com/blog-post/kubernetes-dev-loop-projection) on the process and *why* it's easier for both platform engineers and API/app developers.
