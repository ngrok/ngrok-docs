...
This quickstart uses the [ngrok Kubernetes Operator](/docs/k8s) and a [ngrok's custom resources](/docs/k8s/crds) (CRs) to make the services you've deployed to Kubernetes available on the public internet.
...
- Are okay with using Kubernetes-native resources, but not necessarily Kubernetes standards.
...
Change these three values according to your specific deployment.
