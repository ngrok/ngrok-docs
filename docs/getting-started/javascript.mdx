...
This quickstart uses ngrok's JavaScript SDK to put a Node.js app running on your local device online and secure it so anyone with a Google account can access it.
...
If you don't have an app to work with, you can create a JavaScript file with the following code to set up a basic HTTP server at port `8080`.
