...
This quickstart uses ngrok's Python SDK to put a Python app running on your local device online and secure it so only you can access it.
...
This file needs to be in a new directory with the Python script we'll create in the next step that'll use ngrok's SDK to create an endpoint.
...
You'll need to install [the `python-dotenv` package](https://pypi.org/project/python-dotenv/) to access your environment variable.
