...
## 3. Export your authtoken to your environment

For the example in this quickstart, you'll need to export your ngrok authtoken as an environment variable in the terminal. If you're running your service already, make sure you open a new terminal window or tab to run the following commands.
