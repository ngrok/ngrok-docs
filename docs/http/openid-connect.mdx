...
The OpenID Connect module works similar to the OAuth module. For more information,
see [OAuth module documentation](/http/oauth).
:::
...
See [oidc_issuer_url](https://ngrok.github.io/ngrok-javascript/interfaces/Config.html#oidc_issuer_url) in the Javascript SDK docs.
