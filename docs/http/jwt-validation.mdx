...
If multiple tokens are defined within the HTTP configuration parameter, all tokens must be present in the request. I all tokens are not present a 401 status code will be returned.
