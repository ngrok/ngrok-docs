...
import AuthnJavascriptSdkExample from "/examples/javascript-sdk/http-oauth-authn.mdx";
...
import AuthzJavascriptSdkExample from "/examples/javascript-sdk/http-oauth-authz.mdx";
...
import ByoAppJavascriptSdkExample from "/examples/javascript-sdk/http-oauth-byo-app.mdx";
...
import CustomizeScopesJavascriptSdkExample from "/examples/javascript-sdk/http-oauth-customize-scopes.mdx";
...
<Tabs groupId="connectivity" queryString="cty">
	...
	<TabItem value="javascript-sdk" label="Javascript">
		<CustomizeScopesJavascriptSdkExample />
	</TabItem>
	<TabItem value="python-sdk" label="Python">
...
ngrok's [App Users](/docs/universal-gateway/app-users/) feature can be used to observe
...
session](/universal-gateway/app-users/#revoke-sessions).
