...
| `${res.ts.body_sent}`            | The timestamp when ngrok sent the body of the response. This may not be present if the response does not contain a body.                                                                        |
| `${res.ts.header_sent}`          | The timestamp when ngrok sent the header of the resposne.                                                                                                                                       |
