...
A number of these examples come from a longer article about how ngrok [makes policy management accessible](https://ngrok.com/blog-post/api-gateway-policy-management-examples#template-8-enforce-the-tls-version-of-requests) to developers, including a simple Go-based application for testing these and other configurations.
