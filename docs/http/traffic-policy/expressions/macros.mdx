...
| [`getReqCookie(string)`](#getreqcookiestring)                              | cookie      | Returns the cookie struct for the specified cookie name, if it exists on the request. If there are multiple cookies of the same name, the first will be returned.  |
...
| [`getResCookie(string)`](#getrescookiestring)                              | cookie      | Returns the cookie struct for the specified cookie name, if it exists on the response. If there are multiple cookies of the same name, the first will be returned. |
...
Returns the cookie struct for the specified cookie name, if it exists on the request. If there are multiple cookies of the same name, the first will be returned.
...
Returns the cookie struct for the specified cookie name, if it exists on the response. If there are multiple cookies of the same name, the first will be returned.
