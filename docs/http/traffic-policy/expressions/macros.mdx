...
| -------------------------------------------------------------------------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`hasReqHeader(string)`](#hasreqheaderstring)                              | bool        | Returns true or false if the provided header key is present on the request. Header keys must be written in lowercase.                             |
| [`getReqHeader(string)`](#getreqheaderstring)                              | list        | Returns a list of header values for the provided key on the request. Header keys must be written in lowercase.                                    |
...
| [`hasResHeader(string)`](#hasresheaderstring)                              | bool        | Returns true or false if the provided header key is present on the response. Header keys must be written in lowercase.                            |
| [`getResHeader(string)`](#getresheaderstring)                              | list        | Returns a list of header values for the provided key on the response. Header keys must be written in lowercase.                                   |
...
Returns `true` or `false` if the provided header key is present on the request. Header keys must be written in lowercase.
...
Returns a list of header values for the provided key on the request. Header keys must be written in lowercase.
...
Returns true or false if the provided header key is present on the response. Header keys must be written in lowercase.
...
Returns a list of header values for the provided key on the response. Header keys must be written in lowercase.
