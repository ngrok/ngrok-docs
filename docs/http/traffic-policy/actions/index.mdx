...
| ---------------------------------- | ---------------------------------------------------------------------------------------- | ----------------- |
| [add-headrs](add-headers)          | Add headers from incoming requests or outgoing responses.                                | Inbound, Outbound |
...
| [remove-headrs](remove-headers)    | Remove headers from incoming requests or outgoing responses.                             | Inbound, Outbound |
