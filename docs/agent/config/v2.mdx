...
| [`policy.inbound.name`](/http/traffic-policy/index.mdx)                                     | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.expressions`](/http/traffic-policy/expressions/index.mdx)                  | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.actions.type`](/http/traffic-policy/actions/index.mdx)                     | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.actions.config`](/http/traffic-policy/actions/index.mdx)                   | custom                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.name`](/http/traffic-policy/index.mdx)                                    | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.expressions`](/http/traffic-policy/expressions/index.mdx)                 | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.actions.type`](/http/traffic-policy/actions/index.mdx)                    | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.actions.config`](/http/traffic-policy/actions/index.mdx)                  | custom                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
...
| [`traffic_policy.on_http_request.name`](/http/traffic-policy/index.mdx)                     | String                                                                       | The name of an `on_http_request` rule that is part of a traffic policy                                                                                                                                                                                                                            |
| [`traffic_policy.on_http_request.expressions`](/http/traffic-policy/expressions/index.mdx)  | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_request` policy rule applies to                                                                                                                                                              |
| [`traffic_policy.on_http_request.actions.type`](/http/traffic-policy/actions/index.mdx)     | String                                                                       | The type of action that should be executed when this `on_http_request` policy rule is activated                                                                                                                                                                                                   |
| [`traffic_policy.on_http_request.actions.config`](/http/traffic-policy/actions/index.mdx)   | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
| [`traffic_policy.on_http_response.name`](/http/traffic-policy/index.mdx)                    | String                                                                       | The name of an `on_http_response` rule that is part of a traffic policy                                                                                                                                                                                                                           |
| [`traffic_policy.on_http_response.expressions`](/http/traffic-policy/expressions/index.mdx) | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_response` policy rule applies to                                                                                                                                                             |
| [`traffic_policy.on_http_response.actions.type`](/http/traffic-policy/actions/index.mdx)    | String                                                                       | The type of action that should be executed when this `on_http_response` policy rule is activated                                                                                                                                                                                                  |
| [`traffic_policy.on_http_response.actions.config`](/http/traffic-policy/actions/index.mdx)  | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
...
| [`traffic_policy.inbound.name`](/http/traffic-policy/index.mdx)                     | String                         | The name of an inbound rule that is part of a traffic policy                                                                                                                                                                  |
| [`traffic_policy.inbound.expressions`](/http/traffic-policy/expressions/index.mdx)  | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the inbound policy rule applies to                                                                                                    |
| [`traffic_policy.inbound.actions.type`](/http/traffic-policy/actions/index.mdx)     | String                         | The type of action that should be executed when this inbound policy rule is activated                                                                                                                                         |
| [`traffic_policy.inbound.actions.config`](/http/traffic-policy/actions/index.mdx)   | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
| [`traffic_policy.outbound.name`](/http/traffic-policy/index.mdx)                    | String                         | The name of an outbound rule that is part of a traffic policy                                                                                                                                                                 |
| [`traffic_policy.outbound.expressions`](/http/traffic-policy/expressions/index.mdx) | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the outbound policy rule applies to                                                                                                   |
| [`traffic_policy.outbound.actions.type`](/http/traffic-policy/actions/index.mdx)    | String                         | The type of action that should be executed when this outbound policy rule is activated                                                                                                                                        |
| [`traffic_policy.outbound.actions.config`](/http/traffic-policy/actions/index.mdx)  | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
