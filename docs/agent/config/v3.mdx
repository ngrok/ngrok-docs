...
| [`upstream.protocol`](#upstreamprotocol)             |          | http1, http2 | The application layer protocol the agent should use when talking to your upstream application for HTTP endpoints.                                                                                                 |
