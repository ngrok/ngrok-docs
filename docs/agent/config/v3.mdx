...
The allowed values are `internal`, `public`, and `kubernetes` which allow you to create [public](/docs/universal-gateway/public-endpoints/), [internal](/docs/universal-gateway/internal-endpoints/), and [kubernetes endpoints](/docs/universal-gateway/kubernetes-endpoints/).
