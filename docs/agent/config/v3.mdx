...
| [connect_cas (previously `root_cas`)](#connect_cas) | The root certificate authorities used to validate the TLS connection to the ngrok server.                                                                                                            |
...
This is the root certificate authorities used to validate the TLS connection to the ngrok server. In the Version 2 configuration file, this field is called `root_cas`.
