...
The `ngrok tunnel` command is used to start labeled tunnels for use with [Tunnel Group backends](/cloud-edge/edges/#tunnel-group) as part of [Edges](/cloud-edge/edges/).
