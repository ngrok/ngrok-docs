...
Server Load Balancing](/universal-gateway/gslb/), but you can also explicitly choose
a region.
...
- You can't terminate TLS at the agent when using [end-to-end encryption](/universal-gateway/network/tls-termination/#end-to-end-encryption)
