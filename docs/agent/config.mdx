...
| [`policy.inbound.expressions`](/docs/http/traffic-policy/expressions/index.mdx)  | Array of Strings               | Expressions written using CEL that filter traffic the inbound policy rule applies to                                                                                                                                          |
...
| [`policy.outbound.expressions`](/docs/http/traffic-policy/expressions/index.mdx) | Array of Strings               | Expressions written using CEL that filter traffic the outbound policy rule applies to                                                                                                                                         |
