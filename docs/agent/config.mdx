...
| `policies.inbound.name`            | String                                                                       | The name of an inbound rule that is part of a traffic policy                                                                                                                                                                                                                                      |
| `policies.inbound.expressions`     | Array of Strings                                                             | Expressions written using CEL that filter traffic the inbound policy rule applies to                                                                                                                                                                                                              |
| `policies.inbound.actions.type`    | String                                                                       | The type of action that should be executed when this inbound policy rule is activated                                                                                                                                                                                                             |
| `policies.inbound.actions.config`  | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
| `policies.outbound.name`           | String                                                                       | The name of an outbound rule that is part of a traffic policy                                                                                                                                                                                                                                     |
| `policies.outbound.expressions`    | Array of Strings                                                             | Expressions written using CEL that filter traffic the outbound policy rule applies to                                                                                                                                                                                                             |
| `policies.outbound.actions.type`   | String                                                                       | The type of action that should be executed when this outbound policy rule is activated                                                                                                                                                                                                            |
| `policies.outbound.actions.config` | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
