...
| ------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--module.enabled`  | true if the module will be applied to traffic, false to disable. default true if unspecified                                                                                                                                                                                  |
| `--module.provider` | a string indicating which webhook provider will be sending webhooks to this endpoint. Value must be one of the [supported providers](/http/webhook-verification) |
...
| `--webhook-verification.provider`              | a string indicating which webhook provider will be sending webhooks to this endpoint. Value must be one of the [supported providers](/http/webhook-verification)                                                            |
...
| `--webhook-validation.provider`                | a string indicating which webhook provider will be sending webhooks to this endpoint. Value must be one of the [supported providers](/http/webhook-verification)                                                            |
...
| Flag                | Description                                                                                                                              |
| ------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `--certificate-pem` | chain of PEM-encoded certificates, leaf first. See Certificate Bundles (/http#certificate-chains). |
...
| `--private-key-pem` | private key for the TLS certificate, PEM-encoded. See Private Keys (/http#private-keys).           |
| `--api-key`         | API key to use                                                                                                                           |
| `--config`          | path to config files; they are merged if multiple                                                                                        |
| `--log`             | path to log file, 'stdout', 'stderr' or 'false'                                                                                          |
| `--log-format`      | log record format: 'term', 'logfmt', 'json'                                                                                              |
