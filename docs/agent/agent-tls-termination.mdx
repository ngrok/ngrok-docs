...
:::tip
If your service doesn't support TLS termination, you can still use Agent TLS termination with [Zero-Knowledge TLS](/traffic-policy/actions/terminate-tls/#end-to-end-encryption).
:::
