...
You can run `ngrok diagnose` within your Kubernetes cluster to troubleshoot network connectivity issues. See [Testing in a Kubernetes Cluster](/guides/other-guides/running-behind-firewalls/#testing-in-a-kubernetes-cluster).
