...
:::note
If running on Windows, version 3.6.0+ require Windows 10 or higher. If you are using Windows 7 or 8, 3.5.0 is the last supported version of the ngrok agent.
:::
