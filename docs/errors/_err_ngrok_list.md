...
Install your authoken: https://dashboard.ngrok.com/get-started/your-authtoken |
		...
		| [ERR_NGROK_4109](/error_details/4109) | Bot name must not be empty. |
		| [ERR_NGROK_4110](/error_details/4110) | Bot name exceeds max length, `LENGTH` bytes, max: `MAX`. |
		| [ERR_NGROK_4111](/error_details/4111) | You must be an admin to create, update, or delete Bots. |
...
"`ERROR`" |
		...
		| [ERR_NGROK_5502](/error_details/5502) | Authorization with `PROVIDER` succeeded, but these required scopes not were granted: `SCOPES`.
...
Please reauthorize and grant all requested scopes to the application. |
		...
		| [ERR_NGROK_5508](/error_details/5508) | Authorization with `PROVIDER` succeeded, but these required scopes not were granted: `SCOPES`.

Please reauthorize and grant all requested scopes to the application. |
		| [ERR_NGROK_5510](/error_details/5510) | `PROVIDER` did not provide an email for your account.
...
Check that you have a primary email and that it's confirmed before trying again. |
		...
		| [ERR_NGROK_5513](/error_details/5513) | Email domain failed to normalize to a FQDN "`DOMAIN`":

"`ERROR`" |
		| [ERR_NGROK_5517](/error_details/5517) | `PROVIDER` denied access to your data during the final step of authorization: `DESCRIPTION`.

Please contact the owner of this application to ensure it is properly installed for your organization. |
		| [ERR_NGROK_5518](/error_details/5518) | `PROVIDER` rejected authorization with access denied: `DESCRIPTION`.

You must authorize this application before continuing. |
		| [ERR_NGROK_5520](/error_details/5520) | `PROVIDER` rejected authorization due to a invalid or unknown scope requested by this application: `DESCRIPTION`.
...
The owner of this application must correct the application configuration before you can continue. |
		...
		| [ERR_NGROK_5523](/error_details/5523) | `PROVIDER` rejected authorization as the redirect URL for this application is improperly configured: `DESCRIPTION`.

Please contact the owner of this application in order to fix this error. |
		| [ERR_NGROK_5524](/error_details/5524) | `PROVIDER` rejected authorization: `DESCRIPTION`.

The owner of this application should verify the OAuth application client ID and secret are valid before you can continue. |
		| [ERR_NGROK_5525](/error_details/5525) | `PROVIDER` has throttled this application and cannot be reached right now.
...
Please try again in a few minutes. |
		...
		| [ERR_NGROK_5527](/error_details/5527) | `PROVIDER` rejected the final step of authorization due to invalid credentials.

The owner of this application should verify the OAuth application client ID and secret are valid before you can continue. |
		| [ERR_NGROK_5528](/error_details/5528) | The access code from `PROVIDER` has expired and cannot be used.

Please authorize again more quickly. |
		| [ERR_NGROK_5529](/error_details/5529) | `PROVIDER` denied access to your data during the final step of authorization.

Please contact the owner of this application to ensure it is properly installed for your organization. |
		| [ERR_NGROK_5530](/error_details/5530) | OAuth is not enabled on the domain "`HOSTNAME`". |
		| [ERR_NGROK_5531](/error_details/5531) | `PROVIDER` denied access to your account as the correct account could not be chosen automatically.

Please try authorizing again or contacting the owner of this application if the issue persists. |
		| [ERR_NGROK_5532](/error_details/5532) | `PROVIDER` denied access to your account as reauthentication is required.

Please try logging in again or contact the owner of this application if the issue persists. |
		| [ERR_NGROK_5533](/error_details/5533) | `PROVIDER` had an internal server error when refreshing your information.
...
"`ERROR`". |
		...
		| [ERR_NGROK_5536](/error_details/5536) | Encountered an error while fetching user data: `PROVIDER` did not provide a user ID for your account. |
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_6515](/error_details/6515) | Tunnel Group Backend `ID` did not match any tunnels.

Please start tunnels matching its labels in order to serve traffic. |
		| [ERR_NGROK_6516](/error_details/6516) | HTTP Reseponse Backend `ID` had too large of a body.
The maximum is length `MAX` bytes, but the supplied body was `VAL` bytes long. |
		| [ERR_NGROK_6517](/error_details/6517) | HTTP Response Backend `ID` had an invalid status code.
...
Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_6600](/error_details/6600) | The account `NAME` has reached its team size limit and may not add additional users.
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_7165](/error_details/7165) | An unsupported OAuth Provider was configured. |
		| [ERR_NGROK_7166](/error_details/7166) | The "`PROVIDER`" OAuth Provider does not currently have a managed app available, specify a client id and client secret. |
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9021](/error_details/9021) | You may specify at most one of subdomain, hostname, or domain for a tunnel. |
