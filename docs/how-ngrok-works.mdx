...
### Endpoint
An endpoint is a web address. Endpoints can be TCP, TLS, or HTTP/S endpoints depending on the applicable protocol. Any traffic sent to that endpoint will be routed based on how the endpoint is configured. 
