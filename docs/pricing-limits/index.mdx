...
## Usage-based vs free plans

- **free plans** (ngrok for developers) — best for teams, organizations, and developers using ngrok to test and share their apps publicly.
