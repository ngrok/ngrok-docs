...
See [WithRequestHeader](https://pkg.go.dev/golang.ngrok.com/ngrok/config#WithRequestHeader) and [WithRemoveRequestHeader](https://pkg.go.dev/golang.ngrok.com/ngrok/config#WithRemoveRequestHeader) in the Go SDK docs.
...
See [request_header_add](https://ngrok.github.io/ngrok-nodejs/interfaces/Config.html#request_header_add) and [request_header_remove](https://ngrok.github.io/ngrok-nodejs/interfaces/Config.html#request_header_remove) in the NodeJS SDK docs.
...
See [request_header](https://ngrok.github.io/ngrok-python/http_listener_builder.html#ngrok.HttpListenerBuilder.request_header) and [remove_request_header](https://ngrok.github.io/ngrok-python/http_listener_builder.html#ngrok.HttpListenerBuilder.remove_request_header) in the Python SDK docs.
...
See [request_header](https://docs.rs/ngrok/latest/ngrok/config/struct.HttpTunnelBuilder.html#method.request_header) and [remove_request_header](https://docs.rs/ngrok/latest/ngrok/config/struct.HttpTunnelBuilder.html#method.remove_request_header) in the Rust SDK docs.
