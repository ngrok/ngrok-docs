...
ngrok http 80 \
  --oauth google \
  --allow-email kate.libby@gmail.com \
  --allow-domain acme.org
```
...
| Header                           | Description                                                                   |
| -------------------------------- | ----------------------------------------------------------------------------- |
| `ngrok-auth-user-id`             | Provider-defined identified of the authorized user.                           |
...
| Free       | 5                               |
| Personal   | 50                              |
| Pro        | Unlimited, usaged-based-pricing |
| Enterprise | Unlimited, usaged-based-pricing |
