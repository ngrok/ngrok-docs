...
enforcing the use of security headers without modifying upstream applications.
...
See [WithResponseHeader](https://pkg.go.dev/golang.ngrok.com/ngrok/config#WithResponseHeader) and [WithRemoveResponseHeader](https://pkg.go.dev/golang.ngrok.com/ngrok/config#WithRemoveResponseHeader) in the Go SDK docs.
...
See [response_header_add](https://ngrok.github.io/ngrok-nodejs/interfaces/Config.html#response_header_add) and [response_header_remove](https://ngrok.github.io/ngrok-nodejs/interfaces/Config.html#response_header_remove) in the NodeJS SDK docs.
...
See [response_header](https://ngrok.github.io/ngrok-python/http_listener_builder.html#ngrok.HttpListenerBuilder.response_header) and [remove_response_header](https://ngrok.github.io/ngrok-python/http_listener_builder.html#ngrok.HttpListenerBuilder.remove_response_header) in the Python SDK docs.
...
See [response_header](https://docs.rs/ngrok/latest/ngrok/config/struct.HttpTunnelBuilder.html#method.response_header) and [remove_response_header](https://docs.rs/ngrok/latest/ngrok/config/struct.HttpTunnelBuilder.html#method.remove_response_header) in the Rust SDK docs.
...
For example to return to the duration spent dialing the upstream application,
...
`ngrok-agent-ip` header. This header is part of ngrok's abuse deterrance
mechanism.
