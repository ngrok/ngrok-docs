...
<!-- 
    @ceschae
    This is a new version of the error doc that should be created by docgen (future index.mdx)
    I decided to push a new file so we can easily track/compare what should be different.
-->
