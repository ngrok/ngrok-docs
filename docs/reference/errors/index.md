...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_218](/error_details/218) | Your request has not specified an API version. Please include the version you wish to use in the Ngrok-Version header. Supported versions: <code>&lt;SUPPORTED&gt;</code>. |
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_418](/error_details/418) | Your account is limited to <code>&lt;MAX&gt;</code> wildcard domains. Email contact@ngrok.com to purchase additional wildcard domains. |
...
Upgrade to a Pro or Enterprise plan at https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_502](/error_details/502) | Your account is limited to <code>&lt;MAX&gt;</code> reserved addresses. Email contact@ngrok.com to purchase additional addresses. |
		...
		| [ERR_NGROK_509](/error_details/509) | Your account is rate limited for adding <code>&lt;MAX&gt;</code> reserved addresses per <code>&lt;INTERVAL&gt;</code>. |
		...
		| [ERR_NGROK_600](/error_details/600) | Invalid ACL rule. An ACL rule must be '*' or start with 'bind:'. You specified: <code>&lt;RULE&gt;</code>. |
...
<code>&lt;ERR&gt;</code> |
		...
		| [ERR_NGROK_1007](/error_details/1007) | Your subscription was updated, by we failed to charge your card: <code>&lt;MSG&gt;</code>. |
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_1683](/error_details/1683) | Failed to parse the SAML IdP metadata: <code>&lt;ERR&gt;</code>. |
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_1930](/error_details/1930) | Nameservers are not set up correctly for <code>&lt;DOMAIN&gt;</code>, expected <code>&lt;WANT&gt;</code> but got <code>&lt;GOT&gt;</code> |
		...
		| [ERR_NGROK_3002](/error_details/3002) | Error performing TLS handshake: <code>&lt;ERR&gt;</code> |
...
The owner of this application must correct the application configuration before you can continue. |
		| [ERR_NGROK_3127](/error_details/3127) | <code>&lt;PROVIDER&gt;</code> rejected authorization due to invalid or expired credentials.
...
Please refresh the page to log in and try again. |
		| [ERR_NGROK_3151](/error_details/3151) | <code>&lt;PROVIDER&gt;</code> rejected use of your session's OAuth token: "<code>&lt;ERROR&gt;</code>". Your session is invalid and cannot continue. |
		| [ERR_NGROK_3152](/error_details/3152) | An invalid request was sent to <code>&lt;PROVIDER&gt;</code> but its response is required in order to continue. This is a bug and it has been reported; please try again in a couple of hours to see if it has been resolved. |
		| [ERR_NGROK_3160](/error_details/3160) | An unexpected error occurred when communicating with <code>&lt;PROVIDER&gt;</code>. |
		| [ERR_NGROK_3161](/error_details/3161) | <code>&lt;PROVIDER&gt;</code> has throttled this application and cannot be reached right now.

Please try again in a few minutes. |
		| [ERR_NGROK_3162](/error_details/3162) | <code>&lt;PROVIDER&gt;</code> has throttled this application and cannot be reached right now.

Please try again in about an hour. |
		| [ERR_NGROK_3163](/error_details/3163) | An error occurred when finishing authorization with <code>&lt;PROVIDER&gt;</code>. This is likely caused by authorization taking too long.

Please try again. |
		| [ERR_NGROK_3164](/error_details/3164) | An error occurred when authorizing with <code>&lt;PROVIDER&gt;</code>:

<code>&lt;ERROR&gt;</code> |
		| [ERR_NGROK_3165](/error_details/3165) | <code>&lt;PROVIDER&gt;</code> is too busy to handle requests and authorization cannot be completed at this time. |
		| [ERR_NGROK_3166](/error_details/3166) | <code>&lt;PROVIDER&gt;</code> enountered an error and authorization cannot be completed at this time. |
		| [ERR_NGROK_3167](/error_details/3167) | <code>&lt;PROVIDER&gt;</code> is too busy to handle requests and required data cannot be retrieved right now. Wait a few minutes before trying again. |
		| [ERR_NGROK_3200](/error_details/3200) | Tunnel <code>&lt;HOSTNAME&gt;</code> not found |
...
If you are the account owner and believe this is a mistake, please contact support@ngrok.com. |
		...
		| [ERR_NGROK_3309](/error_details/3309) | The route match type `<code>&lt;TYP&gt;</code>` is incompatible with OAuth, OIDC, or SAML. Compatible selector match types are "EXACT_PATH" or "PATH_PREFIX". |
		...
		| [ERR_NGROK_4001](/error_details/4001) | Plan <code>&lt;PLAN_ID&gt;</code> does not exist. |
		| [ERR_NGROK_4003](/error_details/4003) | Account name must not be empty. |
		| [ERR_NGROK_4004](/error_details/4004) | Account name exceeds max length, <code>&lt;LENGTH&gt;</code> bytes, max: <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_4005](/error_details/4005) | Another account is already configured with the GSuite domain <code>&lt;DOMAIN&gt;</code>. |
		| [ERR_NGROK_4011](/error_details/4011) | Your password must be at least <code>&lt;LENGTH&gt;</code> characters. |
		| [ERR_NGROK_4012](/error_details/4012) | Your account does not have access to <code>&lt;FEATURE&gt;</code>.

Upgrade to get access: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_4013](/error_details/4013) | You may not create a new account because you are already a member of the free account "<code>&lt;ACCOUNT_NAME&gt;</code>". Upgrade or delete that account first before creating a new account. |
		| [ERR_NGROK_4014](/error_details/4014) | The account <code>&lt;NAME&gt;</code> was suspended. It may not be deleted. Contact support@ngrok.com if you believe this is an error. |
		| [ERR_NGROK_4015](/error_details/4015) | The account <code>&lt;NAME&gt;</code> was banned for violation of the terms of service. It may not be deleted. Contact support@ngrok.com if you believe this is an error. |
		...
		| [ERR_NGROK_4018](/error_details/4018) | You must signup for ngrok and add your authtoken to perform this operation.
...
Install your authoken: https://dashboard.ngrok.com/get-started/your-authtoken |
		...
		| [ERR_NGROK_4020](/error_details/4020) | Your password must be less then <code>&lt;LENGTH&gt;</code> characters. |
		| [ERR_NGROK_4100](/error_details/4100) | The email or password you entered is not valid. |
		| [ERR_NGROK_4101](/error_details/4101) | A user with the email address <code>&lt;EMAIL&gt;</code> already exists. |
		| [ERR_NGROK_4103](/error_details/4103) | <code>&lt;EMAIL&gt;</code> is not a valid email address. |
		| [ERR_NGROK_4104](/error_details/4104) | User name must not be empty. |
		| [ERR_NGROK_4105](/error_details/4105) | User name exceeds max length, <code>&lt;LENGTH&gt;</code> bytes, max: <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_4106](/error_details/4106) | Your user <code>&lt;EMAIL&gt;</code> was suspended for violation of the terms of service. It may not be deleted. Contact support@ngrok.com if you believe this is an error. |
		| [ERR_NGROK_4107](/error_details/4107) | Your user <code>&lt;EMAIL&gt;</code> was banned for violation of the terms of service. It may not be deleted. Contact support@ngrok.com if you believe this is an error. |
		| [ERR_NGROK_4108](/error_details/4108) | Sign ups are disallowed for the email provider "<code>&lt;DOMAIN&gt;</code>". Please sign up with a different email provider. |
		| [ERR_NGROK_4200](/error_details/4200) | You may not delete all or your logins, you must have at least one. |
		| [ERR_NGROK_4201](/error_details/4201) | This <code>&lt;LOGIN&gt;</code> login is already connected to another ngrok user. |
		| [ERR_NGROK_4300](/error_details/4300) | No user with the email address <code>&lt;EMAIL&gt;</code> exists. |
		| [ERR_NGROK_4301](/error_details/4301) | This account does not support a password reset. |
		| [ERR_NGROK_4302](/error_details/4302) | Unable to redeem password: <code>&lt;REASON&gt;</code> |
		| [ERR_NGROK_4400](/error_details/4400) | An email address is required to invite a new user |
		| [ERR_NGROK_4401](/error_details/4401) | The invited email address is too long: <code>&lt;LENGTH&gt;</code> bytes. Max <code>&lt;MAX&gt;</code> bytes. |
		| [ERR_NGROK_4402](/error_details/4402) | The invited user would exceed your team size limit of <code>&lt;TEAM_SIZE&gt;</code>. Delete unused invitations or users to make room, or upgrade to a Pro or Enterprise plan: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_4404](/error_details/4404) | Unabled to redeem invitation: <code>&lt;REASON&gt;</code> |
		| [ERR_NGROK_4405](/error_details/4405) | <code>&lt;EMAIL&gt;</code> is not a valid email address. |
		| [ERR_NGROK_4407](/error_details/4407) | You are not currently permitted to enroll in the beta. |
		| [ERR_NGROK_4408](/error_details/4408) | Feature request suggestions must be between 1 and <code>&lt;MAXLEN&gt;</code> characters, got <code>&lt;LENGTH&gt;</code>. |
		...
		| [ERR_NGROK_4451](/error_details/4451) | A user with the email address <code>&lt;EMAIL&gt;</code> already exists. |
		| [ERR_NGROK_4452](/error_details/4452) | The email address being verified, <code>&lt;EMAIL&gt;</code>, belongs to another user. |
		| [ERR_NGROK_4500](/error_details/4500) | The URL <code>&lt;URL&gt;</code> is not a valid tcp address or URL.  Please use either hostname:port or a full URL including protocol for HTTP or TLS endpoints. |
		| [ERR_NGROK_4501](/error_details/4501) | The TCP port <code>&lt;PORT&gt;</code> in <code>&lt;HOST&gt;</code> is not a valid numerical TCP port. |
		| [ERR_NGROK_4502](/error_details/4502) | The TCP port <code>&lt;PORT&gt;</code> for <code>&lt;HOST&gt;</code> is not within the range of possible ngrok ports. |
		| [ERR_NGROK_4503](/error_details/4503) | The IP <code>&lt;IP&gt;</code> is not a known ngrok TCP IP. |
		| [ERR_NGROK_4504](/error_details/4504) | The host <code>&lt;HOST&gt;</code> is not a known ngrok TCP hostname. |
		| [ERR_NGROK_5000](/error_details/5000) | Your account is limited to <code>&lt;MAX&gt;</code> <code>&lt;RESOURCE&gt;</code>. |
		| [ERR_NGROK_5001](/error_details/5001) | Your account is rate limited to <code>&lt;MAX&gt;</code> <code>&lt;RESOURCE&gt;</code> per <code>&lt;INTERVAL&gt;</code>. |
		| [ERR_NGROK_5100](/error_details/5100) | An event destination must specify a destination target. Valid targets include: <code>&lt;TYPE&gt;</code>. |
		| [ERR_NGROK_5102](/error_details/5102) | You have reached the maximum of <code>&lt;MAX&gt;</code> destinations for your account. |
		| [ERR_NGROK_5103](/error_details/5103) | No event destinations with ID: <code>&lt;ID&gt;</code> associated with this account. |
		| [ERR_NGROK_5104](/error_details/5104) | Event Destination role ARN "<code>&lt;ARN&gt;</code>" is not a valid ARN for an aws IAM role. Error: <code>&lt;MSG&gt;</code>. |
		...
		| [ERR_NGROK_5112](/error_details/5112) | Event Destination "<code>&lt;ID&gt;</code>" cannot be deleted because it is still in use by at least one Event Stream |
		...
		| [ERR_NGROK_5117](/error_details/5117) | The property <code>&lt;NAME&gt;</code> is an immutable property and may not be updated. Create a new destination instead. |
		| [ERR_NGROK_5118](/error_details/5118) | The partition (<code>&lt;VALUE&gt;</code>) of the provided <code>&lt;FIELD&gt;</code> (<code>&lt;ARN&gt;</code>) is invalid. |
		| [ERR_NGROK_5119](/error_details/5119) | The service (<code>&lt;VALUE&gt;</code>) of the provided <code>&lt;FIELD&gt;</code> (<code>&lt;ARN&gt;</code>) is invalid. |
		| [ERR_NGROK_5120](/error_details/5120) | The provided <code>&lt;FIELD&gt;</code> (<code>&lt;ARN&gt;</code>) is invalid. Please make sure it matches the ARN you obtained from Amazon exactly. |
		| [ERR_NGROK_5122](/error_details/5122) | <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_5123](/error_details/5123) | Event Subscription <code>&lt;ID&gt;</code> not found. |
		| [ERR_NGROK_5124](/error_details/5124) | Your account can't use the event subscriptions feature. |
		| [ERR_NGROK_5125](/error_details/5125) | Source <code>&lt;TYP&gt;</code> not found on Event Subscription <code>&lt;ID&gt;</code>. |
		| [ERR_NGROK_5126](/error_details/5126) | You have reached the maximum of <code>&lt;MAX&gt;</code> destinations on a subscription. |
		...
		| [ERR_NGROK_5129](/error_details/5129) | The ARN (<code>&lt;ARN&gt;</code>) is not valid for the <code>&lt;SERVICE&gt;</code> service. |
		| [ERR_NGROK_5130](/error_details/5130) | The ARN (<code>&lt;ARN&gt;</code>) is not valid for the <code>&lt;RESOURCE&gt;</code> resource type. |
		| [ERR_NGROK_5131](/error_details/5131) | You have reached the maximum of <code>&lt;MAX&gt;</code> event subscriptions for your account. |
		...
		| [ERR_NGROK_5202](/error_details/5202) | Encountered an error while communicating with the OIDC provider:

"<code>&lt;ERROR&gt;</code>". |
		| [ERR_NGROK_5203](/error_details/5203) | The OIDC provider failed to return a OIDC ID Token. |
		| [ERR_NGROK_5204](/error_details/5204) | Failed to verify the OIDC ID Token:

"<code>&lt;ERROR&gt;</code>". |
		| [ERR_NGROK_5205](/error_details/5205) | Failed to extract claims from the OIDC ID Token:

"<code>&lt;ERROR&gt;</code>". |
		| [ERR_NGROK_5206](/error_details/5206) | The endpoint configuration "<code>&lt;ECID&gt;</code>" does not exist. |
		| [ERR_NGROK_5207](/error_details/5207) | OIDC is not enabled on the endpoint configuration "<code>&lt;ECID&gt;</code>". |
		| [ERR_NGROK_5208](/error_details/5208) | Encountered an error while attempting to fetch OIDC provider metadata:
...
"<code>&lt;ERROR&gt;</code>". |
		...
		| [ERR_NGROK_5211](/error_details/5211) | The OIDC provider returned the error code "<code>&lt;ERROR&gt;</code>" with the additional details: "<code>&lt;DETAILS&gt;</code>". Please try authenticating again. |
		| [ERR_NGROK_5212](/error_details/5212) | OIDC is not enabled on the domain "<code>&lt;HOSTNAME&gt;</code>". |
		| [ERR_NGROK_5300](/error_details/5300) | SAML RelayState parameter is invalid. |
		| [ERR_NGROK_5301](/error_details/5301) | The SAML IdP sent an invalid SAML assertion:

"<code>&lt;ERROR&gt;</code>" |
		| [ERR_NGROK_5302](/error_details/5302) | The SAML module for the endpoint configuration "<code>&lt;ECID&gt;</code>" disallows IdP-initiated logins. |
		| [ERR_NGROK_5303](/error_details/5303) | The endpoint configuration "<code>&lt;ECID&gt;</code>" is not attached to any domains. |
		| [ERR_NGROK_5304](/error_details/5304) | Could not find the domain "<code>&lt;DOMAIN&gt;</code>" specified in the IdP-initiated RelayState. |
		| [ERR_NGROK_5305](/error_details/5305) | The SAML IdP sent an invalid SAML assertion:

"<code>&lt;ERROR&gt;</code>" |
		| [ERR_NGROK_5306](/error_details/5306) | SAML RelayState parameter is invalid. |
		| [ERR_NGROK_5307](/error_details/5307) | The domain "<code>&lt;DOMAIN&gt;</code>" specified in the IdP-initiated RelayState is not attached to the endpoint configuration "<code>&lt;ECID&gt;</code>". |
		| [ERR_NGROK_5308](/error_details/5308) | The SAML IdP sent an invalid SAML logout response:
...
"<code>&lt;ERROR&gt;</code>" |
		...
		| [ERR_NGROK_5317](/error_details/5317) | The SAML module for the edge route "<code>&lt;RTEID&gt;</code>" disallows IdP-initiated logins. |
		| [ERR_NGROK_5318](/error_details/5318) | The edge "<code>&lt;EDGID&gt;</code>" is not attached to any domains. |
		| [ERR_NGROK_5319](/error_details/5319) | Failed to complete IdP-initiated SAML login. The RelayState specified an invalid domain "<code>&lt;DOMAIN&gt;</code>" to redirect to. Ensure that the domain "<code>&lt;DOMAIN&gt;</code>" is configured as a hostport for "<code>&lt;EDGID&gt;</code>". |
		| [ERR_NGROK_5320](/error_details/5320) | The edge route "<code>&lt;RTEID&gt;</code>" does not exist. |
		| [ERR_NGROK_5321](/error_details/5321) | The RelayState must be configured with the redirect URL for IdP-initiated logins. |
		| [ERR_NGROK_5322](/error_details/5322) | The domain "<code>&lt;DOMAIN&gt;</code>" specified in the IdP-initiated RelayState is not attached to the edge "<code>&lt;EDGID&gt;</code>". |
		| [ERR_NGROK_5323](/error_details/5323) | The SAML module is not enabled for the configuration "<code>&lt;ID&gt;</code>". |
		| [ERR_NGROK_5324](/error_details/5324) | The ID "<code>&lt;ID&gt;</code>" that was specified is invalid. This usually indicates a malformed URL. |
		| [ERR_NGROK_5325](/error_details/5325) | Failed to complete IdP-initiated SAML login. Edge does not have any attached domains. Please ensure that at least one domain is configured as a hostport for "<code>&lt;EDGID&gt;</code>". |
		| [ERR_NGROK_5326](/error_details/5326) | Failed to complete IdP-initiated SAML login. The RelayState must be configured with the redirect URL for IdP-initiated logins when using a route selector match type of "<code>&lt;MATCHTYP&gt;</code>". |
		| [ERR_NGROK_5400](/error_details/5400) | Event Sources for the "<code>&lt;TYP&gt;</code>" event type must specify fields to capture. |
		| [ERR_NGROK_5401](/error_details/5401) | Event Sources for the "<code>&lt;TYP&gt;</code>" event may not specify fields. |
		| [ERR_NGROK_5402](/error_details/5402) | Event Sources for the "<code>&lt;TYP&gt;</code>" event may not specify a filter. |
		| [ERR_NGROK_5403](/error_details/5403) | Event Sources must be configured with fields that match its event type. "<code>&lt;FIELD&gt;</code>" is not a "<code>&lt;TYP&gt;</code>" field |
		| [ERR_NGROK_5404](/error_details/5404) | Event Source filter is invalid: "<code>&lt;ERR&gt;</code>" |
		| [ERR_NGROK_5405](/error_details/5405) | Invalid Event Field: "<code>&lt;FIELD&gt;</code>" |
		| [ERR_NGROK_5406](/error_details/5406) | Field is not yet supported in event filters: "<code>&lt;FIELD&gt;</code>" |
		...
		| [ERR_NGROK_5502](/error_details/5502) | Authorization with <code>&lt;PROVIDER&gt;</code> succeeded, but these required scopes not were granted: <code>&lt;SCOPES&gt;</code>.
...
Please reauthorize and grant all requested scopes to the application. |
		...
		| [ERR_NGROK_5507](/error_details/5507) | <code>&lt;ERROR_NAME&gt;</code> <code>&lt;DETAILS&gt;</code> |
		| [ERR_NGROK_5508](/error_details/5508) | Authorization with <code>&lt;PROVIDER&gt;</code> succeeded, but these required scopes not were granted: <code>&lt;SCOPES&gt;</code>.

Please reauthorize and grant all requested scopes to the application. |
		| [ERR_NGROK_5510](/error_details/5510) | <code>&lt;PROVIDER&gt;</code> did not provide an email for your account.

Check that you have a primary email and that it's confirmed before trying again. |
		| [ERR_NGROK_5511](/error_details/5511) | Email "<code>&lt;EMAIL&gt;</code>" is not authorized for use by this account. |
		| [ERR_NGROK_5512](/error_details/5512) | Email is malformed. Email "<code>&lt;EMAIL&gt;</code>" is missing an @ sign. |
		| [ERR_NGROK_5513](/error_details/5513) | Email domain failed to normalize to a FQDN "<code>&lt;DOMAIN&gt;</code>":

"<code>&lt;ERROR&gt;</code>" |
		| [ERR_NGROK_5517](/error_details/5517) | <code>&lt;PROVIDER&gt;</code> denied access to your data during the final step of authorization: <code>&lt;DESCRIPTION&gt;</code>.

Please contact the owner of this application to ensure it is properly installed for your organization. |
		| [ERR_NGROK_5518](/error_details/5518) | <code>&lt;PROVIDER&gt;</code> rejected authorization with access denied: <code>&lt;DESCRIPTION&gt;</code>.

You must authorize this application before continuing. |
		| [ERR_NGROK_5520](/error_details/5520) | <code>&lt;PROVIDER&gt;</code> rejected authorization due to a invalid or unknown scope requested by this application: <code>&lt;DESCRIPTION&gt;</code>.

The owner of this application must correct the application configuration before you can continue. |
		| [ERR_NGROK_5521](/error_details/5521) | <code>&lt;PROVIDER&gt;</code> rejected authorization due to an internal server error: <code>&lt;DESCRIPTION&gt;</code>. |
		| [ERR_NGROK_5522](/error_details/5522) | <code>&lt;PROVIDER&gt;</code> is too busy to handle requests and authorization cannot be completed at this time: <code>&lt;DESCRIPTION&gt;</code>. |
		| [ERR_NGROK_5523](/error_details/5523) | <code>&lt;PROVIDER&gt;</code> rejected authorization as the redirect URL for this application is improperly configured: <code>&lt;DESCRIPTION&gt;</code>.

Please contact the owner of this application in order to fix this error. |
		| [ERR_NGROK_5524](/error_details/5524) | <code>&lt;PROVIDER&gt;</code> rejected authorization: <code>&lt;DESCRIPTION&gt;</code>.

The owner of this application should verify the OAuth application client ID and secret are valid before you can continue. |
		| [ERR_NGROK_5525](/error_details/5525) | <code>&lt;PROVIDER&gt;</code> has throttled this application and cannot be reached right now.

Please try again in a few minutes. |
		| [ERR_NGROK_5526](/error_details/5526) | <code>&lt;PROVIDER&gt;</code> rejected access to your information. This is likely caused by expiration or revocation of your authorization. |
		| [ERR_NGROK_5527](/error_details/5527) | <code>&lt;PROVIDER&gt;</code> rejected the final step of authorization due to invalid credentials.

The owner of this application should verify the OAuth application client ID and secret are valid before you can continue. |
		| [ERR_NGROK_5528](/error_details/5528) | The access code from <code>&lt;PROVIDER&gt;</code> has expired and cannot be used.

Please authorize again more quickly. |
		| [ERR_NGROK_5529](/error_details/5529) | <code>&lt;PROVIDER&gt;</code> denied access to your data during the final step of authorization.

Please contact the owner of this application to ensure it is properly installed for your organization. |
		| [ERR_NGROK_5530](/error_details/5530) | OAuth is not enabled on the domain "<code>&lt;HOSTNAME&gt;</code>". |
		| [ERR_NGROK_5531](/error_details/5531) | <code>&lt;PROVIDER&gt;</code> denied access to your account as the correct account could not be chosen automatically.

Please try authorizing again or contacting the owner of this application if the issue persists. |
		| [ERR_NGROK_5532](/error_details/5532) | <code>&lt;PROVIDER&gt;</code> denied access to your account as reauthentication is required.

Please try logging in again or contact the owner of this application if the issue persists. |
		| [ERR_NGROK_5533](/error_details/5533) | <code>&lt;PROVIDER&gt;</code> had an internal server error when refreshing your information.

Please try again or contact the owner of this application if the issue persists. |
		| [ERR_NGROK_5534](/error_details/5534) | Encountered an error while attempting to fetch OIDC provider metadata:

"<code>&lt;ERROR&gt;</code>". |
		| [ERR_NGROK_5535](/error_details/5535) | The OAuth provider "<code>&lt;PROVIDER&gt;</code>" cannot be used without a user-defined client ID and client secret. |
		...
		| [ERR_NGROK_6006](/error_details/6006) | The Event Destination <code>&lt;EDID&gt;</code> required by <code>&lt;ECID&gt;</code> was not found. If these were recently created or removed, this should be temporary and resolve itself. |
		...
		| [ERR_NGROK_6010](/error_details/6010) | Endpoint configuration is incompatible with tunnel; module <code>&lt;MODULE&gt;</code> required by Endpoint Configuration <code>&lt;ECID&gt;</code> is incompatible with <code>&lt;PROTO&gt;</code> tunnels. |
		| [ERR_NGROK_6011](/error_details/6011) | You may not specify <code>&lt;MIDDLEWARE&gt;</code> options from the ngrok agent because this domain has a configured endpoint configuration: <code>&lt;ECID&gt;</code>. Remove the endpoint configuration from this domain or remove the conflicting options when starting the ngrok agent. |
		| [ERR_NGROK_6013](/error_details/6013) | Failed to compile filter for Event Subscription <code>&lt;ESID&gt;</code>. |
		| [ERR_NGROK_6014](/error_details/6014) | Failed to run filter for Event Subscription <code>&lt;ESID&gt;</code>. |
		| [ERR_NGROK_6018](/error_details/6018) | The Endpoint <code>&lt;HOSTPORT&gt;</code> has both an Endpoint Configuration (<code>&lt;EPCID&gt;</code>) and a Tunnel with incompatible configuration (<code>&lt;TUNNELID&gt;</code>) online. |
		| [ERR_NGROK_6019](/error_details/6019) | The Endpoint <code>&lt;HOSTPORT&gt;</code> has both an Edge (<code>&lt;EDGID&gt;</code>) and Endpoint Configuration (<code>&lt;EPCID&gt;</code>) configured. |
		| [ERR_NGROK_6020](/error_details/6020) | The Endpoint <code>&lt;HOSTPORT&gt;</code> has both an Edge (<code>&lt;EDGID&gt;</code>) and Tunnel (<code>&lt;TUNID&gt;</code>) online. |
		...
		| [ERR_NGROK_6024](/error_details/6024) | You are about to visit <code>&lt;HOSTPORT&gt;</code>, served by <code>&lt;SERVINGIP&gt;</code>. This website is served for free through ngrok.com. You should only visit this website if you trust whoever sent the link to you. |
		| [ERR_NGROK_6500](/error_details/6500) | Your account is not authorized to use the backends feature. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_6501](/error_details/6501) | Cannot save backend reference <code>&lt;ID&gt;</code> because it does not exists. |
		...
		| [ERR_NGROK_6503](/error_details/6503) | Description is limited to <code>&lt;MAX&gt;</code> characters; you have entered <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6504](/error_details/6504) | Metadata is limited to <code>&lt;MAX&gt;</code> characters; you have entered <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6505](/error_details/6505) | Static backend requires address in the host:port form. |
		| [ERR_NGROK_6506](/error_details/6506) | Static backend address <code>&lt;ADDR&gt;</code> is invalid (<code>&lt;REASON&gt;</code>). Use host:port as address. |
		| [ERR_NGROK_6507](/error_details/6507) | Static backend address <code>&lt;ADDR&gt;</code> is missing host. Use host:port as address. |
		| [ERR_NGROK_6508](/error_details/6508) | Tunnel group labels count is limited to <code>&lt;MAX&gt;</code>; you have <code>&lt;VAL&gt;</code> labels. |
		| [ERR_NGROK_6509](/error_details/6509) | Tunnel group label key length is limited to <code>&lt;MAX&gt;</code>; key <code>&lt;NAME&gt;</code> has <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6510](/error_details/6510) | Tunnel group label value length is limited to <code>&lt;MAX&gt;</code>; value <code>&lt;NAME&gt;</code> has <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6511](/error_details/6511) | Weighted backends count is limited to <code>&lt;MAX&gt;</code>; you have <code>&lt;VAL&gt;</code> backends. |
		| [ERR_NGROK_6512](/error_details/6512) | Weighted backend <code>&lt;ID&gt;</code> weight <code>&lt;VAL&gt;</code> is out of range; it must be between <code>&lt;MIN&gt;</code> and <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_6513](/error_details/6513) | Failover backends may only contain up to <code>&lt;MAX&gt;</code> failover backends; you have <code>&lt;VAL&gt;</code> failover backends. |
		| [ERR_NGROK_6514](/error_details/6514) | Backend not found. |
		| [ERR_NGROK_6515](/error_details/6515) | Tunnel Group Backend <code>&lt;ID&gt;</code> did not match any tunnels.

Please start tunnels matching its labels in order to serve traffic. |
		| [ERR_NGROK_6516](/error_details/6516) | HTTP Reseponse Backend <code>&lt;ID&gt;</code> had too large of a body.
The maximum is length <code>&lt;MAX&gt;</code> bytes, but the supplied body was <code>&lt;VAL&gt;</code> bytes long. |
		| [ERR_NGROK_6517](/error_details/6517) | HTTP Response Backend <code>&lt;ID&gt;</code> had an invalid status code.
The status code <code>&lt;STATUS&gt;</code> is an invalid HTTP Status Code. |
		| [ERR_NGROK_6522](/error_details/6522) | The header beginning with <code>&lt;PREFIX&gt;</code>...' exceeds the maximum header name length of 128 bytes. |
		| [ERR_NGROK_6523](/error_details/6523) | The header value for <code>&lt;HEADERKEY&gt;</code> beginning with <code>&lt;PREFIX&gt;</code>...' exceeds the maximum header value length of 1024 bytes. |
		| [ERR_NGROK_6524](/error_details/6524) | A Weighted Backend may not reference the backend <code>&lt;ID&gt;</code> because it is a <code>&lt;BACKENDTYPE&gt;</code> backend. |
		| [ERR_NGROK_6525](/error_details/6525) | A Failover Backend may not reference the backend <code>&lt;ID&gt;</code> because it is a <code>&lt;BACKENDTYPE&gt;</code> backend. |
		| [ERR_NGROK_6526](/error_details/6526) | The id <code>&lt;ID&gt;</code> is not a valid backend ID. |
		| [ERR_NGROK_6527](/error_details/6527) | The id <code>&lt;ID&gt;</code> is invalid; expected an id of type <code>&lt;BACKENDTYPE&gt;</code> backend. |
		| [ERR_NGROK_6528](/error_details/6528) | Traffic made it to the ngrok edge, but there are no tunnels online serving an app. |
		| [ERR_NGROK_6529](/error_details/6529) | Your account is not authorized to use the weighted backends feature. 

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_6530](/error_details/6530) | The <code>&lt;ID&gt;</code> header cannot be removed without specifying a replacement. |
		| [ERR_NGROK_6600](/error_details/6600) | The account <code>&lt;NAME&gt;</code> has reached its team size limit and may not add additional users.
Please ask the account owner to upgrade your plan: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_6601](/error_details/6601) | Failed to add <code>&lt;USER_NAME&gt;</code> as a member of account <code>&lt;ACCOUNT_NAME&gt;</code> because they are already a member. |
		...
		| [ERR_NGROK_6608](/error_details/6608) | Could not transfer administrative control to membership <code>&lt;ID&gt;</code> because it could not be found on this account. |
		...
		| [ERR_NGROK_6700](/error_details/6700) | The description is limited to <code>&lt;MAX&gt;</code> characters, but the provided value had <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6701](/error_details/6701) | Metadata is limited to <code>&lt;MAX&gt;</code> characters, but the provided value had <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_6702](/error_details/6702) | No DNS records were returned when querying for an NS record for the domain <code>&lt;DOMAIN&gt;</code>. |
		| [ERR_NGROK_6703](/error_details/6703) | The NS records for the domain <code>&lt;DOMAIN&gt;</code> "<code>&lt;GOT&gt;</code>" do not match the expected targets "<code>&lt;EXPECTED&gt;</code>". |
		| [ERR_NGROK_6704](/error_details/6704) | The specified domain "<code>&lt;DOMAIN&gt;</code>" is not a valid domain name. Enter a valid DNS name. |
		| [ERR_NGROK_6705](/error_details/6705) | The agent ingress domain "<code>&lt;DOMAIN&gt;</code>" must be a third party domain, you may not enter a domain controlled by ngrok. |
		| [ERR_NGROK_6706](/error_details/6706) | The agent ingress domain "<code>&lt;DOMAIN&gt;</code>" already exists, choose another domain. |
		...
		| [ERR_NGROK_7007](/error_details/7007) | The IP Policy ID <code>&lt;ID&gt;</code> specified for the IP Restriction module does not exist. |
		| [ERR_NGROK_7008](/error_details/7008) | Only Pro and Enterprise plans are allowed to use edges.
Your account is not authorized to use edges.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7009](/error_details/7009) | Your account is limited to a maximum of <code>&lt;MAX&gt;</code> edges. |
		| [ERR_NGROK_7011](/error_details/7011) | Invalid edge, circuit breaker error threshold percentage must be between 0.0 and 1.0 inclusive, was <code>&lt;VAL&gt;</code>. |
		| [ERR_NGROK_7012](/error_details/7012) | The auth provider <code>&lt;VAL&gt;</code> does not exist. Specify an auth provider ID or the special value 'agent'. |
		| [ERR_NGROK_7013](/error_details/7013) | The edge module exceeds the max number of IP Policies. You specified <code>&lt;VAL&gt;</code>, the maximum is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7014](/error_details/7014) | The edge module TLS CA certificate size exceeds the max. You specified <code>&lt;VAL&gt;</code>, the maximum is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7015](/error_details/7015) | The edge module exceeds the max number of headers. You specified <code>&lt;VAL&gt;</code>, the maximum is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7016](/error_details/7016) | Invalid edge module, circuit breaker tripped duration must be greater than 0, was <code>&lt;VAL&gt;</code>. |
		| [ERR_NGROK_7017](/error_details/7017) | Invalid edge module, circuit breaker rolling window must be greater than 0, was <code>&lt;VAL&gt;</code>. |
		| [ERR_NGROK_7018](/error_details/7018) | Invalid edge module, circuit breaker num buckets must be greater than 0 and less than <code>&lt;MAX&gt;</code>, was <code>&lt;VAL&gt;</code>. |
		...
		| [ERR_NGROK_7021](/error_details/7021) | The module <code>&lt;NAME&gt;</code> is not supported on an edge of type <code>&lt;TYPE&gt;</code>. |
		| [ERR_NGROK_7022](/error_details/7022) | <code>&lt;NAME&gt;</code> is not a valid edge type. Must be one of 'http', 'https', 'tcp'. |
		| [ERR_NGROK_7023](/error_details/7023) | <code>&lt;KEY&gt;</code> is not a valid HTTP header name because it contains at least one invalid character. |
		| [ERR_NGROK_7024](/error_details/7024) | <code>&lt;VAL&gt;</code> is not a valid HTTP header value: <code>&lt;REASON&gt;</code>. |
		...
		| [ERR_NGROK_7027](/error_details/7027) | Webhook verification for <code>&lt;T&gt;</code> requires a secret. |
		| [ERR_NGROK_7028](/error_details/7028) | There were validation errors while saving the edge:<code>&lt;ERRS&gt;</code> |
		| [ERR_NGROK_7029](/error_details/7029) | You must specify a supported provider name.  Supported providers: [<code>&lt;T&gt;</code>] |
		| [ERR_NGROK_7030](/error_details/7030) | Webhook provider <code>&lt;T&gt;</code> is not supported.  Supported providers: [<code>&lt;TYPE&gt;</code>] |
		| [ERR_NGROK_7031](/error_details/7031) | Only Pro and Enterprise accounts can use edges webhook verification.
Your account is not authorized to use webhook verification.  

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7032](/error_details/7032) | You may not configure the TLS termination parameter <code>&lt;PARAMETER&gt;</code> when the HTTPS module disables TLS termination. |
		...
		| [ERR_NGROK_7035](/error_details/7035) | Invalid edge module, OAuth auth check interval must be at least <code>&lt;MIN&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7036](/error_details/7036) | Invalid edge module, OAuth may only have one provider configuration but multiple are defined: [<code>&lt;PROVIDER_NAMES&gt;</code>]. |
		...
		| [ERR_NGROK_7038](/error_details/7038) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> requires at least the <code>&lt;SCOPE&gt;</code> scope to authenticate by <code>&lt;AUTH_FEATURE&gt;</code>.' |
		| [ERR_NGROK_7039](/error_details/7039) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> contains an invalid email domain: <code>&lt;NAME&gt;</code>. |
		| [ERR_NGROK_7040](/error_details/7040) | Invalid edge module, OAuth GitHub Teams must be listed as either numerical ids or in the format 'org_slug/team_slug', <code>&lt;TEAM&gt;</code> does not match either format. |
		| [ERR_NGROK_7041](/error_details/7041) | Only Pro and Enterprise accounts can use edges OAuth.
Your account is not authorized to use OAuth.  

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7042](/error_details/7042) | Invalid edge module, OAuth cookie prefix <code>&lt;PREFIX&gt;</code> must consist of only alphanumeric characters with periods. |
		| [ERR_NGROK_7043](/error_details/7043) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> contains an invalid email address, <code>&lt;NAME&gt;</code>. |
		| [ERR_NGROK_7044](/error_details/7044) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> contains an email domain with invalid punycode: <code>&lt;NAME&gt;</code>. |
		| [ERR_NGROK_7045](/error_details/7045) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> contains an email address with invalid punycode: <code>&lt;NAME&gt;</code>. |
		| [ERR_NGROK_7046](/error_details/7046) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> email addresses must be unique, but a duplicate is present: <code>&lt;DUPLICATE&gt;</code>. |
		| [ERR_NGROK_7047](/error_details/7047) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> email domains must be unique, but a duplicate is present: <code>&lt;DUPLICATE&gt;</code>. |
		| [ERR_NGROK_7048](/error_details/7048) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> teams must be unique, but a duplicate is present: <code>&lt;DUPLICATE&gt;</code>. |
		| [ERR_NGROK_7049](/error_details/7049) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> organizations must be unique, but a duplicate is present: <code>&lt;DUPLICATE&gt;</code>. |
		| [ERR_NGROK_7050](/error_details/7050) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> groups must be unique, but a duplicate is present: <code>&lt;DUPLICATE&gt;</code>. |
		| [ERR_NGROK_7051](/error_details/7051) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> email addresses must not contain empty values |
		| [ERR_NGROK_7052](/error_details/7052) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> email domains must not contain empty values |
		| [ERR_NGROK_7053](/error_details/7053) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> teams must not contain empty values |
		| [ERR_NGROK_7054](/error_details/7054) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> organizations must not contain empty values |
		| [ERR_NGROK_7055](/error_details/7055) | Invalid edge module, OAuth provider <code>&lt;PROVIDER&gt;</code> groups must not contain empty values |
		| [ERR_NGROK_7056](/error_details/7056) | The edge module exceeds the maximum number of OAuth scopes. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7057](/error_details/7057) | The edge module exceeds the maximum number of OAuth GitHub teams. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7058](/error_details/7058) | The edge module exceeds the maximum number of OAuth GitHub orgs. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7059](/error_details/7059) | The edge module exceeds the maximum number of OAuth Google groups. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7060](/error_details/7060) | The edge module exceeds the maximum number of OAuth emails. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7061](/error_details/7061) | The edge module exceeds the maximum number of OAuth domains. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7062](/error_details/7062) | The edge specifies the following modules which may not be enabled when TLS is not terminated: <code>&lt;MODULE_NAMES&gt;</code>. |
		| [ERR_NGROK_7067](/error_details/7067) | Invalid edge module, email addresses must be lowercase but <code>&lt;EMAIL&gt;</code> is not. |
		| [ERR_NGROK_7068](/error_details/7068) | Invalid edge module, email domains must be lowercase but <code>&lt;DOMAIN&gt;</code> is not. |
		| [ERR_NGROK_7069](/error_details/7069) | Duplicate 'add' header, <code>&lt;HEADER&gt;</code> was provided twice with different casings: <code>&lt;CASE_ONE&gt;</code> and <code>&lt;CASE_TWO&gt;</code>. |
		| [ERR_NGROK_7070](/error_details/7070) | Your account is limited to <code>&lt;MAX&gt;</code> edges. |
		| [ERR_NGROK_7071](/error_details/7071) | Your account is rate limited for adding <code>&lt;MAX&gt;</code> edges per <code>&lt;INTERVAL&gt;</code>. |
		| [ERR_NGROK_7072](/error_details/7072) | The CA ID <code>&lt;ID&gt;</code> specified for the Mutual TLS module does not exist. |
		| [ERR_NGROK_7073](/error_details/7073) | Description is limited to <code>&lt;MAX&gt;</code> characters; you have entered <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_7074](/error_details/7074) | Metadata is limited to <code>&lt;MAX&gt;</code> characters; you have entered <code>&lt;VAL&gt;</code> characters. |
		| [ERR_NGROK_7075](/error_details/7075) | The Mutual TLS configurations exceeds the limit of <code>&lt;LIMIT&gt;</code> attached certificate authorities. |
		...
		| [ERR_NGROK_7080](/error_details/7080) | The SAML metadata exceeds the maximum length of <code>&lt;MAX&gt;</code> bytes, got <code>&lt;NBYTES&gt;</code>. |
		| [ERR_NGROK_7081](/error_details/7081) | You must specify only the SAML IdP metadata or the SAML IdP metadata URL, but not both. |
		| [ERR_NGROK_7082](/error_details/7082) | Failed to connect to IdP metadata URL <code>&lt;MDURL&gt;</code>: <code>&lt;ERR&gt;</code>. |
		| [ERR_NGROK_7083](/error_details/7083) | Failed to parse the SAML IdP metadata: <code>&lt;ERR&gt;</code>. |
		| [ERR_NGROK_7084](/error_details/7084) | Received unexpected status code <code>&lt;STATUSCODE&gt;</code> while fetching metadata URL <code>&lt;MDURL&gt;</code> |
		| [ERR_NGROK_7085](/error_details/7085) | Failed to parse the SAML IdP metadata fetched from URL <code>&lt;MDURL&gt;</code>: <code>&lt;ERR&gt;</code>. |
		| [ERR_NGROK_7086](/error_details/7086) | Encountered an error while reading the response body from the IdP metadata URL <code>&lt;MDURL&gt;</code>: <code>&lt;ERR&gt;</code>. |
		| [ERR_NGROK_7087](/error_details/7087) | The specified OIDC issuer has a maximum length of <code>&lt;MAX&gt;</code> bytes. The specified value is <code>&lt;N&gt;</code> bytes. |
		...
		| [ERR_NGROK_7092](/error_details/7092) | Invalid edge module, session inactivity timeout cannot be more than one year, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7093](/error_details/7093) | Your account is not authorized to use basic auth. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7094](/error_details/7094) | Your account is not authorized to use compression. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7095](/error_details/7095) | Your account is not authorized to use circuit breaker. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7096](/error_details/7096) | Your account is not authorized to use request headers. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7097](/error_details/7097) | Your account is not authorized to use response headers. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7098](/error_details/7098) | Your account is not authorized to use OIDC. 

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7099](/error_details/7099) | Your account is not authorized to use SAML. 

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7100](/error_details/7100) | Your account is not authorized to use TLS termination. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7101](/error_details/7101) | Your account is not authorized to use IP Restrictions. 

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7102](/error_details/7102) | Your account is not authorized to use TCP address backends. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7103](/error_details/7103) | Your account is not authorized to use mutual TLS. 

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7104](/error_details/7104) | Edge has invalid hostports, must be specified in the format 'hostname:portnumber': <code>&lt;INVALID&gt;</code> |
		| [ERR_NGROK_7105](/error_details/7105) | The header beginning with <code>&lt;PREFIX&gt;</code>...' exceeds the maximum header name length of 128 bytes. |
		| [ERR_NGROK_7106](/error_details/7106) | The header value for <code>&lt;HEADERKEY&gt;</code> beginning with <code>&lt;PREFIX&gt;</code>...' exceeds the maximum header value length of 1024 bytes. |
		| [ERR_NGROK_7107](/error_details/7107) | The sendgrid verification key is not a base64 encoded ecdsa public key. The following error was encountered while trying to parse it: "<code>&lt;ERROR&gt;</code>" |
		| [ERR_NGROK_7108](/error_details/7108) | Your account is not authorized to use the websocket to TCP converter. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7109](/error_details/7109) | You may not configure the TLS termination parameter 'terminate_at' for an HTTPS edge. |
		| [ERR_NGROK_7110](/error_details/7110) | The request edge ID <code>&lt;EID&gt;</code> does not match the route edge ID <code>&lt;REID&gt;</code>. |
		| [ERR_NGROK_7111](/error_details/7111) | The edge hostport <code>&lt;HOST&gt;</code>:<code>&lt;PORT&gt;</code> does not exist. |
		| [ERR_NGROK_7112](/error_details/7112) | The hostport <code>&lt;HOSTPORT&gt;</code> has port out of range: <code>&lt;PORT&gt;</code> is not in range 1-65535. |
		| [ERR_NGROK_7113](/error_details/7113) | The address <code>&lt;HOSTPORT&gt;</code> is not reserved. |
		| [ERR_NGROK_7114](/error_details/7114) | The address <code>&lt;HOSTPORT&gt;</code> is not reserved by your account. |
		| [ERR_NGROK_7115](/error_details/7115) | The address <code>&lt;HOSTPORT&gt;</code> has an endpoint configuration which must be removed before it can be used by an edge. |
		| [ERR_NGROK_7116](/error_details/7116) | The domain <code>&lt;HOSTPORT&gt;</code> is unsupported because it does not use port 443. |
		| [ERR_NGROK_7117](/error_details/7117) | The domain <code>&lt;HOSTPORT&gt;</code> is not reserved. |
		| [ERR_NGROK_7118](/error_details/7118) | The domain <code>&lt;HOSTPORT&gt;</code> is not reserved by your account. |
		| [ERR_NGROK_7119](/error_details/7119) | The domain <code>&lt;HOSTPORT&gt;</code> has an endpoint configuration which must be removed before it can be used by an edge. |
		| [ERR_NGROK_7120](/error_details/7120) | TCP edges can only be associated with TCP addresses: <code>&lt;HOSTPORT&gt;</code> is a domain. |
		| [ERR_NGROK_7121](/error_details/7121) | HTTPS edges can only be associated with reserved domains: <code>&lt;HOSTPORT&gt;</code> is a TCP address. |
		| [ERR_NGROK_7122](/error_details/7122) | Hostport <code>&lt;HOSTPORT&gt;</code> already exists for another edge. |
		| [ERR_NGROK_7123](/error_details/7123) | Edge routes require a match expression. |
		| [ERR_NGROK_7124](/error_details/7124) | The edge route <code>&lt;ID&gt;</code> could not be found. |
		| [ERR_NGROK_7125](/error_details/7125) | There is a duplicate route <code>&lt;ID&gt;</code> for HTTPS edge. |
		| [ERR_NGROK_7126](/error_details/7126) | Route match expression <code>&lt;MATCH&gt;</code> must be unique across all routes for HTTPS edge. |
		| [ERR_NGROK_7127](/error_details/7127) | OAuth may not currently be configured for any route except '/', could not configure for route <code>&lt;MATCH&gt;</code>. |
		| [ERR_NGROK_7128](/error_details/7128) | Your account is limited to a maximum of <code>&lt;MAX&gt;</code> routes for a single edge. |
		| [ERR_NGROK_7129](/error_details/7129) | Your account is limited to a maximum of <code>&lt;MAX&gt;</code> hostports for a single edge. |
		| [ERR_NGROK_7130](/error_details/7130) | Invalid match type, valid values are "exact_path" and "path_prefix". |
		| [ERR_NGROK_7131](/error_details/7131) | The route selector expression `<code>&lt;MATCH&gt;</code>` is invalid. Valid route selector match expressions are of the form /path (e.g. "/foo", or "/foo/bar"). |
		| [ERR_NGROK_7132](/error_details/7132) | The hostport `<code>&lt;HOSTPORT&gt;</code>` is already in use by an agent directly. |
		| [ERR_NGROK_7133](/error_details/7133) | TLS edges can only be associated with reserved domains: <code>&lt;HOSTPORT&gt;</code> is a TCP address. |
		...
		| [ERR_NGROK_7135](/error_details/7135) | The route selector expression exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7136](/error_details/7136) | The OAuth Cookie Prefix exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7137](/error_details/7137) | The OAuth Client ID exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7138](/error_details/7138) | The OAuth Client Secret exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7139](/error_details/7139) | The OAuth Email Address exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7140](/error_details/7140) | The OAuth Email Domain exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7141](/error_details/7141) | The OAuth Scope exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7142](/error_details/7142) | The edge module exceeds the maximum number of GitHub teams. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7143](/error_details/7143) | The edge module exceeds the maximum number of GitHub orgs. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7144](/error_details/7144) | The OAuth GitHub team exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7145](/error_details/7145) | The OAuth GitHub org exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7146](/error_details/7146) | The edge module exceeds the maximum number of Google groups. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7147](/error_details/7147) | The OAuth Google group exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7148](/error_details/7148) | The OIDC Client ID exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7149](/error_details/7149) | The OIDC Client Secret exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7150](/error_details/7150) | The edge module exceeds the maximum number of OIDC scopes. You specified <code>&lt;COUNT&gt;</code>, the max is <code>&lt;MAX&gt;</code>. |
		| [ERR_NGROK_7151](/error_details/7151) | The OIDC Scope exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7152](/error_details/7152) | The OIDC Authn URL exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7153](/error_details/7153) | The OIDC cookie prefix exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7154](/error_details/7154) | The Webhook Verification secret exceeds the maximum length of <code>&lt;MAX&gt;</code>, got <code>&lt;SIZE&gt;</code>. |
		| [ERR_NGROK_7155](/error_details/7155) | Enabling OAuth, OIDC, or SAML on more than one route is not supported. |
		| [ERR_NGROK_7156](/error_details/7156) | Failed to attach hostport. The domain <code>&lt;HOSTPORT&gt;</code> is allocated for region <code>&lt;NEW_REGION&gt;</code> but the previous hostport is allocated in <code>&lt;OLD_REGION&gt;</code>. |
		| [ERR_NGROK_7157](/error_details/7157) | Failed to attach hostport. The address <code>&lt;HOSTPORT&gt;</code> is allocated for region <code>&lt;NEW_REGION&gt;</code> but the previous hostport is allocated in <code>&lt;OLD_REGION&gt;</code> |
		| [ERR_NGROK_7158](/error_details/7158) | Invalid edge module, OAuth auth check interval must be no greater than <code>&lt;MAX&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7159](/error_details/7159) | Invalid edge module, OIDC auth check interval must be at least <code>&lt;MIN&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7160](/error_details/7160) | Invalid edge module, OIDC auth check interval must be no greater than <code>&lt;MAX&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7161](/error_details/7161) | Invalid edge module, OAuth max session duration must be no greater than <code>&lt;MAX&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7162](/error_details/7162) | Invalid edge module, OIDC max session duration must be no greater than <code>&lt;MAX&gt;</code>, was <code>&lt;ACTUAL&gt;</code>. |
		| [ERR_NGROK_7163](/error_details/7163) | Your account is not authorized to use the TLS edges. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_7164](/error_details/7164) | The <code>&lt;ID&gt;</code> header cannot be removed without specifying a replacement. |
		| [ERR_NGROK_8000](/error_details/8000) | Failed to resolve host <code>&lt;HOST&gt;</code>: <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_8001](/error_details/8001) | Failed to establish internet connectivity: <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_8002](/error_details/8002) | Failed to establish TCP connection to <code>&lt;HOST&gt;</code> with error: <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_8003](/error_details/8003) | Failed to establish TLS connection to <code>&lt;HOST&gt;</code> with error: <code>&lt;ERR&gt;</code>. Possible Man-in-the Middle. |
		| [ERR_NGROK_8004](/error_details/8004) | Failed to establish tunnel protocol connection to <code>&lt;HOST&gt;</code> with error: <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_8005](/error_details/8005) | Failed to resolve proxy IP with error: <code>&lt;ERR&gt;</code> |
		| [ERR_NGROK_8006](/error_details/8006) | Failed to connect to proxy <code>&lt;URL&gt;</code> with error: <code>&lt;ERR&gt;</code> |
		...
		| [ERR_NGROK_8010](/error_details/8010) | <code>&lt;RESOLVER&gt;</code> was the only resolver to return <code>&lt;IP&gt;</code> for the hostname <code>&lt;HOSTNAME&gt;</code>. This, or the other resolvers, may be returning incorrect results. |
		| [ERR_NGROK_8011](/error_details/8011) | IPV6 errors encountered - it may be disabled. |
		| [ERR_NGROK_8012](/error_details/8012) | Traffic was successfully tunneled to the ngrok agent, but the agent failed to establish a connection to the upstream web service at <code>&lt;ADDR&gt;</code>. |
		| [ERR_NGROK_9000](/error_details/9000) | An account is required to use basic authentication.

Please register for an ngrok account at: https://dashboard.ngrok.com/signup and install your authtoken. |
		| [ERR_NGROK_9001](/error_details/9001) | Your account is not authorized to use compression.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9002](/error_details/9002) | Your account is not authorized to use circuit breaker.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9003](/error_details/9003) | Your account is not authorized to use request headers.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9004](/error_details/9004) | Your account is not authorized to use response headers.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9005](/error_details/9005) | Your account is not authorized to use OIDC.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9006](/error_details/9006) | Your account is not authorized to use SAML. 

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9007](/error_details/9007) | Your account is not authorized to use TLS Termination.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9008](/error_details/9008) | Your account is not authorized to run the agent as a service.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9009](/error_details/9009) | Your account is not authorized to run the agent with http/s proxy.

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9010](/error_details/9010) | Your account is not authorized to run the agent with socks5 proxy.

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9011](/error_details/9011) | Your account is not authorized to run the agent on a custom network interface.

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9012](/error_details/9012) | Your account is not authorized to run the agent with custom CAs.

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9013](/error_details/9013) | Your account is not authorized to run the agent with mutual TLS.

Please contact us at: sales@ngrok.com |
		| [ERR_NGROK_9014](/error_details/9014) | Your account is not authorized to run the agent with proxy proto.

Upgrade to an Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9015](/error_details/9015) | Your account is not authorized to use OAuth.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9016](/error_details/9016) | Your account is not authorized to use webhook verification.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9017](/error_details/9017) | Your account is not authorized to use ip restrictions.

Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		| [ERR_NGROK_9018](/error_details/9018) | An account is required to use host header rewrite.

Please register for an ngrok account at: https://dashboard.ngrok.com/signup and install your authtoken. |
		| [ERR_NGROK_9019](/error_details/9019) | Your account is not authorized to use mutual TLS. 

Please contact us at: sales@ngrok.com |
		| [ERR_NGROK_9020](/error_details/9020) | Your account is not authorized to use the websocket to TCP converter.
...
Upgrade to a Pro or Enterprise plan at: https://dashboard.ngrok.com/billing/subscription |
		...
		| [ERR_NGROK_10011](/error_details/10011) | You have already added the request header name "<code>&lt;NAME&gt;</code>". |
		...
		| [ERR_NGROK_10014](/error_details/10014) | You have already added the response header name "<code>&lt;NAME&gt;</code>". |
		...
		| [ERR_NGROK_10021](/error_details/10021) | Received partition "<code>&lt;PARTITION&gt;</code>" that does not include the word "aws". |
		| [ERR_NGROK_10022](/error_details/10022) | Received service "<code>&lt;SERVICE&gt;</code>" but expected "<code>&lt;TARGETSERVICENAME&gt;</code>". |
		...
		| [ERR_NGROK_10026](/error_details/10026) | Failed to upload Certificate Authority. Invalid file format "<code>&lt;FORMAT&gt;</code>" given. Upload a Certificate Authority in PEM format. |
		| [ERR_NGROK_10027](/error_details/10027) | Failed to upload SAML IdP Metadata. Invalid file format "<code>&lt;FORMAT&gt;</code>" given. Upload SAML IdP Metadata in XML format. |
		| [ERR_NGROK_10028](/error_details/10028) | Failed to upload TLS Certificate. Invalid file format "<code>&lt;FORMAT&gt;</code>" given. Upload a TLS Certificate in PEM format. |
		| [ERR_NGROK_10029](/error_details/10029) | Failed to upload TLS Certificate Private Key. Invalid file format "<code>&lt;FORMAT&gt;</code>" given. Upload a TLS Certificate Private Key in PEM format. |
		...
		| [ERR_NGROK_14000](/error_details/14000) | The <code>&lt;ID&gt;</code> header cannot be removed without specifying a replacement. |
