---
title: Log Exporting Example
sidebar_label: Log Exporting
---

import ConfigExample from "/src/components/ConfigExample.tsx";

With Traffic Policy, you can connect your API to ngrok's [log exporting system](/docs/obs/) for smarter troubleshooting, testing, and integration of logging services like Datadog for your API gateway and upstream services.
