...
With Traffic Policy, you can add or remove headers from requests to provide more context to your upstream service or withhold sensitive information. This page demonstrates a few example rules that do so.
