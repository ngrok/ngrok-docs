...
| [`res.cookies`](#rescookies)                                                | map[string][]cookie | The HTTP cookie objects included in this response. If there are multiple cookies with the same name, they will be ordered by longest path first. |
...
| [`res.cookies[k][i].unparsed_attributes`](#rescookieskiunparsed_attributes) | map[string]string   | Any non-standard attributes of the cookie parsed as an attribute-value map.                                                                      |
...
The HTTP cookie objects included in this response. If there are multiple cookies with the same name, they will be ordered by longest path first.
...
Any non-standard attributes of the cookie parsed as an attribute-value map.
