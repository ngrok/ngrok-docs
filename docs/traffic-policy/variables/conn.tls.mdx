...
| [`conn.tls.server.extensions[i].id`](#conntlsserverextensions[i]id)                       | string      | The identifier that specifies the type of extension.                                                                |
| [`conn.tls.server.extensions[i].critical`](#conntlsserverextensions[i]critical)           | bool        | True if the extension is critical.                                                                                  |
| [`conn.tls.server.extensions[i].value`](#conntlsserverextensions[i]value)                 | []byte      | The data for the extension.                                                                                         |
