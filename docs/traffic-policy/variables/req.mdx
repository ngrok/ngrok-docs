...
| [`req.cookies`](#reqcookies)                                | map[string][]cookie | The HTTP cookie objects included in this request. If there are multiple cookies with the same name, they will remain in the order as set in the Cookie header.                                  |
...
| [`req.url.port`](#requrlport)                               | int32               | The port portion of the URL. If the URL omits the port, the port will be the one implied by the URL scheme (eg 443 for https).                                                                  |
...
The HTTP cookie objects included in this request. If there are multiple cookies with the same name, they will remain in the order as set in the Cookie header.
...
The port portion of the URL. If the URL omits the port, the port will be the one implied by the URL scheme (eg 443 for https).
