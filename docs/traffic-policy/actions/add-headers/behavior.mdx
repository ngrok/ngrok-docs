...
`${expression}`. Check out [this example](#adding-client-ip-headers-to-all-http-requests)
for a demonstration of this in action. 

For a complete list of variables and examples, see [Expressions](/http/traffic-policy/expressions/variables/) and the [Variables](/http/traffic-policy/expressions/) docs.
