...
actions:
  ...
  - type: http-request
    name: Http Request
    description: Sends a http request to a third-party API and returns the response.
    phases:
      - on_http_request
      - on_http_response
    categories:
  ...
  - type: owasp-crs-request
    ...
    description: Adds OWASP CoreRuleSet to incoming HTTP requests to your endpoints
    phases:
      - on_http_request
    categories:
      - security
  ...
  - type: owasp-crs-response
    ...
    description: Adds OWASP CoreRuleSet to outgoing HTTP responses from your endpoints
    phases:
      - on_http_response
    categories:
      - security
