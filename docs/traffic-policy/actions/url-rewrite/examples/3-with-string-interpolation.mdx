...
### Rewrite using String Interpolation
...
policy rule (no expression) by leveraging [String Interpolation](#string-interpolation).
...
this by leveraging [String Interpolation](#string-interpolation) to replace the
