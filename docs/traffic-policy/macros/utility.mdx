...
| [`basic_auth.encode(username, password)`](#basicauthencodeusernamepassword--string)    | `string`        | Encodes the passed username and password strings into a Base64 string for use in HTTP Basic Authentication.                                                                                                             |
