...
| [`string.lower()`](#stringlower--string)                                              | `string`        | Lowercases a string, accepts all UTF-8 characters.                                                                                                                                               |
| [`string.upper()`](#stringupper--string)                                              | `string`        | Uppercases a string, accepts all UTF-8 characters.                                                                                                                                               |
