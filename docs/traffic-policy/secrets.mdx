...
:::info
Secrets and Vaults are currently in Developer Preview, and you must request access to use them.
...
:::info
Vaults and Secrets are currently available as a Developer Preview, and require the ngrok Agent CLI to create.
When this feature becomes generally available you will be able to create new Vaults and Secrets via your ngrok dashboard.
:::
...
```json
{
  ...
  "created_at": "2025-06-11T20:05:23Z",
