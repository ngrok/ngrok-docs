...
To use secrets, you'll need to create a vault to store them in. REST APIs are provided on the ngrok service for both [Vaults](https://ngrok.com/docs/api/resources/vaults/) and [Secrets](https://ngrok.com/docs/api/resources/secrets/).
