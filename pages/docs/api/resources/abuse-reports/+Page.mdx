import AbuseReportsCreateRequest from '@docs/api/resources/examples/_abuse_reports_create_request.md';
import AbuseReportsCreateResponse from '@docs/api/resources/examples/_abuse_reports_create_response.md';
import AbuseReportsGetRequest from '@docs/api/resources/examples/_abuse_reports_get_request.md';
import AbuseReportsGetResponse from '@docs/api/resources/examples/_abuse_reports_get_response.md';
