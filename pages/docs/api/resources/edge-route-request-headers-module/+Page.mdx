import EdgeRouteRequestHeadersModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_request_headers_module_replace_request.md';
import EdgeRouteRequestHeadersModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_request_headers_module_replace_response.md';
import EdgeRouteRequestHeadersModuleGetRequest from '@docs/api/resources/examples/_edge_route_request_headers_module_get_request.md';
import EdgeRouteRequestHeadersModuleGetResponse from '@docs/api/resources/examples/_edge_route_request_headers_module_get_response.md';
import EdgeRouteRequestHeadersModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_request_headers_module_delete_request.md';
import EdgeRouteRequestHeadersModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_request_headers_module_delete_response.md';
