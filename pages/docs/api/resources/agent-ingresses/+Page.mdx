import AgentIngressesCreateRequest from '@docs/api/resources/examples/_agent_ingresses_create_request.md';
import AgentIngressesCreateResponse from '@docs/api/resources/examples/_agent_ingresses_create_response.md';
import AgentIngressesDeleteRequest from '@docs/api/resources/examples/_agent_ingresses_delete_request.md';
import AgentIngressesDeleteResponse from '@docs/api/resources/examples/_agent_ingresses_delete_response.md';
import AgentIngressesGetRequest from '@docs/api/resources/examples/_agent_ingresses_get_request.md';
import AgentIngressesGetResponse from '@docs/api/resources/examples/_agent_ingresses_get_response.md';
import AgentIngressesListRequest from '@docs/api/resources/examples/_agent_ingresses_list_request.md';
import AgentIngressesListResponse from '@docs/api/resources/examples/_agent_ingresses_list_response.md';
import AgentIngressesUpdateRequest from '@docs/api/resources/examples/_agent_ingresses_update_request.md';
import AgentIngressesUpdateResponse from '@docs/api/resources/examples/_agent_ingresses_update_response.md';
