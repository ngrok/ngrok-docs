import TunnelsListRequest from '@docs/api/resources/examples/_tunnels_list_request.md';
import TunnelsListResponse from '@docs/api/resources/examples/_tunnels_list_response.md';
import TunnelsGetRequest from '@docs/api/resources/examples/_tunnels_get_request.md';
import TunnelsGetResponse from '@docs/api/resources/examples/_tunnels_get_response.md';
