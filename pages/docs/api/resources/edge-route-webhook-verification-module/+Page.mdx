import EdgeRouteWebhookVerificationModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_webhook_verification_module_replace_request.md';
import EdgeRouteWebhookVerificationModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_webhook_verification_module_replace_response.md';
import EdgeRouteWebhookVerificationModuleGetRequest from '@docs/api/resources/examples/_edge_route_webhook_verification_module_get_request.md';
import EdgeRouteWebhookVerificationModuleGetResponse from '@docs/api/resources/examples/_edge_route_webhook_verification_module_get_response.md';
import EdgeRouteWebhookVerificationModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_webhook_verification_module_delete_request.md';
import EdgeRouteWebhookVerificationModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_webhook_verification_module_delete_response.md';
