import EdgesHTTPSRoutesCreateRequest from '@docs/api/resources/examples/_edges_https_routes_create_request.md';
import EdgesHTTPSRoutesCreateResponse from '@docs/api/resources/examples/_edges_https_routes_create_response.md';
import EdgesHTTPSRoutesGetRequest from '@docs/api/resources/examples/_edges_https_routes_get_request.md';
import EdgesHTTPSRoutesGetResponse from '@docs/api/resources/examples/_edges_https_routes_get_response.md';
import EdgesHTTPSRoutesUpdateRequest from '@docs/api/resources/examples/_edges_https_routes_update_request.md';
import EdgesHTTPSRoutesUpdateResponse from '@docs/api/resources/examples/_edges_https_routes_update_response.md';
import EdgesHTTPSRoutesDeleteRequest from '@docs/api/resources/examples/_edges_https_routes_delete_request.md';
import EdgesHTTPSRoutesDeleteResponse from '@docs/api/resources/examples/_edges_https_routes_delete_response.md';
