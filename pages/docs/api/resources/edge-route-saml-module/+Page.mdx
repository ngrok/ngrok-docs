import EdgeRouteSAMLModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_saml_module_replace_request.md';
import EdgeRouteSAMLModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_saml_module_replace_response.md';
import EdgeRouteSAMLModuleGetRequest from '@docs/api/resources/examples/_edge_route_saml_module_get_request.md';
import EdgeRouteSAMLModuleGetResponse from '@docs/api/resources/examples/_edge_route_saml_module_get_response.md';
import EdgeRouteSAMLModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_saml_module_delete_request.md';
import EdgeRouteSAMLModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_saml_module_delete_response.md';
