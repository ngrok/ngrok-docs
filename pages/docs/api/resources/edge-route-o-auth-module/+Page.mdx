import EdgeRouteOAuthModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_o_auth_module_replace_request.md';
import EdgeRouteOAuthModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_o_auth_module_replace_response.md';
import EdgeRouteOAuthModuleGetRequest from '@docs/api/resources/examples/_edge_route_o_auth_module_get_request.md';
import EdgeRouteOAuthModuleGetResponse from '@docs/api/resources/examples/_edge_route_o_auth_module_get_response.md';
import EdgeRouteOAuthModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_o_auth_module_delete_request.md';
import EdgeRouteOAuthModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_o_auth_module_delete_response.md';
