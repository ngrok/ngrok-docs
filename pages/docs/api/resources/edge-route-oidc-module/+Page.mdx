import EdgeRouteOIDCModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_oidc_module_replace_request.md';
import EdgeRouteOIDCModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_oidc_module_replace_response.md';
import EdgeRouteOIDCModuleGetRequest from '@docs/api/resources/examples/_edge_route_oidc_module_get_request.md';
import EdgeRouteOIDCModuleGetResponse from '@docs/api/resources/examples/_edge_route_oidc_module_get_response.md';
import EdgeRouteOIDCModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_oidc_module_delete_request.md';
import EdgeRouteOIDCModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_oidc_module_delete_response.md';
