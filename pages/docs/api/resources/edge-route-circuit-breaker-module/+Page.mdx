import EdgeRouteCircuitBreakerModuleReplaceRequest from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_replace_request.md';
import EdgeRouteCircuitBreakerModuleReplaceResponse from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_replace_response.md';
import EdgeRouteCircuitBreakerModuleGetRequest from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_get_request.md';
import EdgeRouteCircuitBreakerModuleGetResponse from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_get_response.md';
import EdgeRouteCircuitBreakerModuleDeleteRequest from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_delete_request.md';
import EdgeRouteCircuitBreakerModuleDeleteResponse from '@docs/api/resources/examples/_edge_route_circuit_breaker_module_delete_response.md';
