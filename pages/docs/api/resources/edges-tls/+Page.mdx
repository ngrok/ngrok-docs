import EdgesTLSCreateRequest from '@docs/api/resources/examples/_edges_tls_create_request.md';
import EdgesTLSCreateResponse from '@docs/api/resources/examples/_edges_tls_create_response.md';
import EdgesTLSGetRequest from '@docs/api/resources/examples/_edges_tls_get_request.md';
import EdgesTLSGetResponse from '@docs/api/resources/examples/_edges_tls_get_response.md';
import EdgesTLSListRequest from '@docs/api/resources/examples/_edges_tls_list_request.md';
import EdgesTLSListResponse from '@docs/api/resources/examples/_edges_tls_list_response.md';
import EdgesTLSUpdateRequest from '@docs/api/resources/examples/_edges_tls_update_request.md';
import EdgesTLSUpdateResponse from '@docs/api/resources/examples/_edges_tls_update_response.md';
import EdgesTLSDeleteRequest from '@docs/api/resources/examples/_edges_tls_delete_request.md';
import EdgesTLSDeleteResponse from '@docs/api/resources/examples/_edges_tls_delete_response.md';
