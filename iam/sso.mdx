...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Okta              | [ngrok's Dashboard SSO guide](/integrations/dashboard-sso/okta-dashboard-sso-saml) and [SCIM provisioning](/integrations/dashboard-sso/okta-dashboard-sso-scim)                                                                                                          |
