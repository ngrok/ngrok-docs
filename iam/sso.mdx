...
<Note>
  This page relates to using SSO and OAuth to sign into the ngrok dashboard. To
  require OAuth for traffic visiting your endpoints, see [the OAuth Traffic
  Policy action documentation](/traffic-policy/actions/oauth).
</Note>
