...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Okta              | [ngrok's Dashboard SSO guide](/integrations/dashboard-sso/okta-dashboard-sso) and [SCIM provisioning](/integrations/dashboard-sso/okta-dashboard-sso-scim)                                                                                                          |
