...
<Note>
	This page relates to using SSO and OAuth to sign into the ngrok dashboard. To require OAuth for traffic visiting your endpoints, see [the OAuth Traffic Policy action documentation](/gateway/traffic-policy/actions/oauth).
</Note>
...
| ----------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Okta              | [ngrok's Dashboard SSO with Okta SAML guide](/integrations/dashboard-sso/okta-dashboard-sso-saml) and [SCIM provisioning](/integrations/dashboard-sso/okta-dashboard-sso-scim)                                                                                                          |
