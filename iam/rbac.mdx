...
applied to an [Invitation](/iam/users/#invitations) when inviting a collaborator to
...
RBAC cannot be applied to [Service Users](/iam/service-users/), who instead function as
...
[ACLs](/gateway/agent/authtokens#authtoken-acls). For instance you may restrict what endpoints a
