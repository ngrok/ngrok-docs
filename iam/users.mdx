...
Multi Factor Authentication (MFA) provides an extra layer of security for logging into your ngrok account. Users may add an additional authentication factor to protect their ngrok logins.
