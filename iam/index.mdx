...
Give each person or system their own credentials so you can rotate or revoke access when needed, and see every change tied to a specific identity in audit logs. 
...
<Columns cols={2}>
	...
	<Card
		...
		icon="code"
		href="/gateway/device-gateway/sdk/"
	>
	...
	<Card
		...
		icon="server"
		href="/gateway/k8s/guides/customer-networks/"
	>
