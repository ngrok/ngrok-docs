...
ngrok provides an identity and access management (IAM) system that enables you to issue, rotate, and revoke unique credentials for each principal in your account, and enforce least-privilege access. 
