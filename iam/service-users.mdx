...
as the [Principal](/obs/events/#principal-object) in the event log. This helps you
isolate what an automated service is doing with your ngrok account, especially
when there are multiple such services.

### Pricing

Service Users are available on Pay-as-you-go plans only. For more information, see the [ngrok Pricing page](https://ngrok.com/pricing).
