...
<Note>
This guide configures mTLS termination at the **ngrok edge** using a Traffic Policy — the ngrok cloud verifies the client certificate and terminates TLS before forwarding traffic on to your agent.
