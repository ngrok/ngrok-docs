...
ngrok lets trusted third-party cloud services like GitHub, Twilio, and Stripe send webhooks to applications running behind your firewall.
ngrok verifies webhook signatures at its network edge, so only legitimate traffic reaches your applications.
...
- **Prevent webhook spoofing.** Signatures are verified at the edge for [70+ providers](/gateway/traffic-policy/actions/verify-webhook/#supported-providers). Spoofed or tampered requests are rejected before they reach any of your compute.
...
<CardGroup cols={3}>
  <Card
    ...
    icon="shield-halved"
<<<<<<< HEAD:guides/webhooks-to-on-prem/overview.mdx
    href="/guides/webhooks-to-on-prem/tutorial"
=======
    href="/gateway/webhooks-to-on-prem/tutorial#6-add-the-guardrail-your-use-case-needs"
>>>>>>> origin/main:gateway/webhooks-to-on-prem/overview.mdx
  >
...
<CardGroup cols={2}>
  <Card
    title="Full tutorial"
    icon="book"
    href="/gateway/webhooks-to-on-prem/tutorial"
  >
  ...
  <Card
    ...
    icon="plus"
    href="/gateway/traffic-policy/actions/verify-webhook/#supported-providers"
  >
  ...
  <Card
    ...
    icon="shield-check"
    href="/gateway/traffic-policy/actions/verify-webhook"
  >
  ...
  <Card
    ...
    icon="lock"
    href="/gateway/traffic-policy/secrets"
  >
