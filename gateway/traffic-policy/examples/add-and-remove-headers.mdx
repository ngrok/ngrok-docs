...
See [the `add-headers` Traffic Policy action docs](/gateway/traffic-policy/actions/add-headers/) for more information.
...
See [the `remove-headers` Traffic Policy action docs](/gateway/traffic-policy/actions/remove-headers/) for more information.
...
See [the `custom-response` Traffic Policy action docs](/gateway/traffic-policy/actions/custom-response/) for more information.
