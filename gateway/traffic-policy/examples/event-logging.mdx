...
description: Learn how to configure event logging in Traffic Policy to export logs to external services like Datadog for monitoring and troubleshooting.
---
...
See [the `log` Traffic Policy action docs](/gateway/traffic-policy/actions/log/) for more information.
