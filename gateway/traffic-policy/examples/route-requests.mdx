...
Traffic Policy uses [CEL expressions](/gateway/traffic-policy/how-it-works#expressions) and [interpolation](/gateway/traffic-policy/how-it-works#cel-interpolation) to dynamically route requests to different internal endpoints.
...
<Note>
All routing examples use the [`forward-internal` action](/gateway/traffic-policy/actions/forward-internal/) to send traffic to internal endpoints.
...
See [connection variables](/gateway/traffic-policy/variables/connection/) for available geo fields.
...
Use [IP Intelligence](/gateway/traffic-policy/variables/ip-intel/) to route traffic based on IP categories, reputation, or autonomous system information.
...
Route mobile users to a mobile-optimized service using [user agent variables](/gateway/traffic-policy/variables/req/#requser-agent).
...
When [Mutual TLS (mTLS)](/gateway/domains/tls-termination/#mutual-tls-mtls) is enabled, route requests based on client certificate details like the common name.
...
- [Traffic Policy variables](/gateway/traffic-policy/variables/)
- [IP Intelligence variables](/gateway/traffic-policy/variables/ip-intel/)
- [CEL expressions](/gateway/traffic-policy/how-it-works#expressions)
- [`forward-internal` action](/gateway/traffic-policy/actions/forward-internal/)
- [A/B testing examples](/gateway/traffic-policy/examples/a-b-tests/)
