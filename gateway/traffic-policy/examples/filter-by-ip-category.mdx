...
See the [full list of AI and crawler categories](/gateway/traffic-policy/variables/ip-intel#crawlers--bots).
</Tip>
...
See the [full list of cloud provider categories](/gateway/traffic-policy/variables/ip-intel#cloud-providers).
...
See the [full list of blocklist categories](/gateway/traffic-policy/variables/ip-intel#blocklists) for all available threat feeds.
...
- [IP Intelligence variable reference](/gateway/traffic-policy/variables/ip-intel): Full list of variables and IP categories
- [Restrict IPs action](/gateway/traffic-policy/actions/restrict-ips): Allow or deny by CIDR or IP Policy
- [Block Unwanted Requests](/gateway/traffic-policy/examples/block-unwanted-requests): More examples for blocking bots, countries, and bad actors
