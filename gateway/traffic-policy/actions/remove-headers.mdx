...
- If you want to add a header use the [`add-headers`](/gateway/traffic-policy/actions/add-headers) action.
- If you want to replace a header, first use this action _then_ use the [`add-headers`](/gateway/traffic-policy/actions/add-headers) action.
