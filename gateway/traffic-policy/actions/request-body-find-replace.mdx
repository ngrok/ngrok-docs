...
- [Response Body Find & Replace](/gateway/traffic-policy/actions/response-body-find-replace) - Modify response bodies
- [SSE Find & Replace](/gateway/traffic-policy/actions/sse-find-replace) - Modify Server-Sent Events streams
