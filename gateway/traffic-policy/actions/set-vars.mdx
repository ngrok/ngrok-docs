...
The following [Traffic Policy](/gateway/traffic-policy/) configuration is an example configuration of the `set-vars` action.
...
The following [Traffic Policy](/gateway/traffic-policy/) configuration is an example of using CEL-interpolation with the `set-vars` action.
...
The following [Traffic Policy](/gateway/traffic-policy/) configuration is an example of setting vars based on previous vars with the `set-vars` action.
