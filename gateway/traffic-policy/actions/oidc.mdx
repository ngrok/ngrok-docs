...
[managed application](/gateway/traffic-policy/actions/oauth/#managed-applications) that allows you to configure OAuth without setting up your own application in your provider. This is useful for testing and
...
- On a periodic interval defined by the [`userinfo_refresh_interval`](/gateway/traffic-policy/actions/oidc/#configuration-fields) parameter.
