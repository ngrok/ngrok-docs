...
### Configuration fields
    ...
    <ConfigField title="bucket_key" type="array of strings" required={true}>
        ...
        <p>Each bucket key is a CEL expression which includes all valid Traffic Policy [variables](/gateway/traffic-policy/variables/) and [macros](/gateway/traffic-policy/macros/).</p>
