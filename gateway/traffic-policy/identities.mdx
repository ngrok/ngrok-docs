...
authenticated to Endpoints via the [OAuth](/gateway/traffic-policy/actions/oauth/),
[OpenID Connect](/gateway/traffic-policy/actions/oidc/) and
[SAML](/gateway/traffic-policy/actions/saml/) Traffic Policy actions. They enable you
to:
...
<img src="/img/docs/identities-app-user-session-diagram.png" alt="Diagram showing users authenticating via OAuth, OpenID Connect, or SAML through ngrok to reach apps, with app and user session data providing identity context" width="1600" height="830" />
