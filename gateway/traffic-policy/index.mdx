...
<Columns cols={2}>
	...
	<Card icon="play" title="Get Started" href="/gateway/traffic-policy/getting-started/agent-endpoints/">
		Create your first Traffic Policy and start an endpoint to see it in action.
	</Card>
	<Card icon="clapperboard" title="Actions" href="/gateway/traffic-policy/actions/">
	...
	<Card icon="grip" title="Examples" href="/gateway/traffic-policy/examples/">
...
- [Actions](/gateway/traffic-policy/actions/) - Transform, redirect, and manage traffic flow with actions like `add-headers`, `rate-limit`, and `jwt-validation`.
- [Variables](/gateway/traffic-policy/variables/) - Predefined values representing things like the IP address associated with a request, the URL of the endpoint accepting the traffic, and more, which can be used to dynamically manage traffic.
- [Macros](/gateway/traffic-policy/macros/) - Apply macros in rule conditions to refine traffic segmentation and configure actions with dynamic precision.
...
<Columns cols={2}>
	<Card
		...
		icon="shield"
		href="/gateway/traffic-policy/examples/block-unwanted-requests/"
	>
	...
	<Card
		...
		icon="key"
		href="/gateway/traffic-policy/examples/add-authentication/"
	>
	...
	<Card
		...
		icon="gauge"
		href="/gateway/traffic-policy/examples/rate-limit-requests/"
	>
	...
	<Card
		title="Rewrite URLs"
		icon="pencil"
		href="/gateway/traffic-policy/examples/url-rewrites/"
	>
...
- Get started by applying a Traffic Policy to your app with the [ngrok agent](/gateway/traffic-policy/getting-started/agent-endpoints/).
- Learn the [key concepts](/gateway/traffic-policy/how-it-works) that make up a Traffic Policy and how it works.
