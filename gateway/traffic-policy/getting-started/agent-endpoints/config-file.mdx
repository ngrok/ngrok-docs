...
The following getting started guide will take you through starting an Agent Endpoint with a Traffic Policy applied via the [Agent Configuration File](/gateway/agent/config/). Note, this guide requires that your agent configuration file is set to [v3](/gateway/agent/config/v3).
...
<Steps titleSize="h2">
  <Step title="Edit your ngrok configuration file">
...
- Learn about the [core concepts](/gateway/traffic-policy/how-it-works) like phases and rules.
- Check out the [examples, use-cases and guides](/gateway/traffic-policy/examples/a-b-tests/).
