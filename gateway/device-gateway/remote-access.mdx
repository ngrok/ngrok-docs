...
<img src="./img/secure-remote-access/ssh-rdp-secure-remote-access-architecture.png" alt="Architecture diagram: one ngrok agent per remote network routing cloud traffic to internal SSH and RDP devices" width="5400" height="1380" />
...
<Steps>
  <Step title="Create a service user and authtoken for isolated network access">
    ...
    <img src="img/secure-remote-access/new-service-user-dialog.png" alt="Service Users page with New Service User button" width="918" height="272" />

<<<<<<< HEAD:guides/device-gateway/remote-access.mdx
    Next, create an authtoken assigned to this specific service user.
=======
<img src="./img/secure-remote-access/new-service-user-dialog.png" alt="Service Users page with New Service User button" width="918" height="272" />
>>>>>>> origin/main:gateway/device-gateway/remote-access.mdx

    <img src="img/secure-remote-access/new-authtoken-service-user-dialog.png" alt="Authtokens page showing a new authtoken assigned to a service user" width="1068" height="424" />
  </Step>
...
>>>>>>> origin/main:gateway/device-gateway/remote-access.mdx
  ...
  <Step title="Reserve a TCP address for each device and server">
    ...
    <img src="img/secure-remote-access/new-tcp-address-dialog.png" alt="Reserved TCP addresses page with a newly reserved address" width="1118" height="660" />
  </Step>

  <Step title="Create your TCP Cloud Endpoints and attach a Traffic Policy">
    ...
    <img src="img/secure-remote-access/new-cloud-endpoint-tcp-dialog.png" alt="Endpoints page with New button to create a TCP Cloud Endpoint" width="1374" height="1042" />
...
>>>>>>> origin/main:gateway/device-gateway/remote-access.mdx
  ...
  <Step title="Use your ngrok TCP endpoints with your SSH and RDP clients">
