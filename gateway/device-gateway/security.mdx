...
- **Create** per-device or per-site [auth tokens](/gateway/agent/index#authtokens)
- **Scope** tokens to [limit which endpoints they can create](/gateway/agent/index#authtokens)
