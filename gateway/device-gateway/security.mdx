...
See the [mTLS Termination](/domains/mtls-termination) documentation for configuration details.
...
Additional security features include [RBAC](/iam/rbac), [SSO & SCIM](/iam/sso), [audit logs](/obs/events), [DDoS protection](/domains/ddos-protection), and [data residency](/domains/region-pinning/) options.
...
- **Data residency:** Control where traffic is processed and is available using [Region pinning](/domains/region-pinning/), available on [Pay-as-you-go](/pricing-limits/#pay-as-you-go-faqs) plans and above.
