...
This guide is specific to ARM64 devices on Linux—if you're using a different device or CPU architecture, first check whether your platform meets the ngrok agent's [system and resource requirements](/gateway/agent/#agent-cli-requirements). Other guides are also available that may fit your use case more precisely:
...
- Any ARM64 device running Linux (see the [system requirements](/gateway/agent/#agent-cli-requirements) for all supported architectures)
