...
- **Access services, not entire devices.** Unlike VPNs, ngrok exposes exactly the service each consumer needs and not a single port or process more. Use [internal endpoints](/endpoints/internal-endpoints/) combined with [Cloud Endpoints](/endpoints/cloud-endpoints/) to control which services are accessible and to whom, and to [forward and load balance traffic](/endpoints/cloud-endpoints/forwarding-and-load-balancing/) across them.
