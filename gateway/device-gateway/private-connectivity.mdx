...
- An ngrok agent installed in a remote IoT-based network. See the [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/) for instructions on how to install the ngrok agent.
...
<Steps>
  ...
  <Step title="Install the ngrok agent within your remote network and configure private Agent Endpoints in ngrok.yml">
    ...
    Follow the [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/) for installation instructions.
