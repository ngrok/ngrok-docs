...
Instead of exposing individual developer endpoints publicly, you can implement a more secure approach: Creating a single, centralized Cloud Endpoint managed by security teams. Known as the [front door pattern](/gateway/examples/front-door-pattern/), this endpoint can be customized with Traffic Policies while keeping developer endpoints private and protected.
