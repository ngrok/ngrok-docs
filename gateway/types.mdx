...
|                                                           | **[Cloud Endpoints](/endpoints/cloud-endpoints/)**                                             | **[Agent Endpoints](/endpoints/agent-endpoints/)**     |
| --------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------- |
...
- All [Endpoint Protocols](/endpoints/protocols/)
  - `http/https`
  - `tcp`
  - `tls`
- All [Endpoint Bindings](/endpoints/bindings/)
  - `public`
  - `internal`
  - `kubernetes`

- [Endpoint Pooling](/endpoints/endpoint-pooling/). You can also pool Agent Endpoints with Cloud Endpoints.

## Get started

- See the [Cloud Endpoints Quickstart](/getting-started/cloud-endpoints-quickstart).
- See the ngrok [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/) to set up an Agent Endpoint.
