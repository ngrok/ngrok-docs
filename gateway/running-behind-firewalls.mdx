...
If you're having trouble using the ngrok agent to start a tunnel, the first step is to run [`ngrok diagnose`](/gateway/agent/diagnose) which will produce a report that will help you identify connection issues.
