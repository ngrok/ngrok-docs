...
- Learn about [Endpoint Pooling](/gateway/endpoint-pooling) for simpler automatic load balancing
- Explore [custom domains](/gateway/custom-domains) to use your own domain instead of ngrok subdomains
