...
<Steps>
  <Step title="Create internal endpoints for your local services">
    Start [Agent Endpoints](/gateway/agent-endpoints/) for your local development services using internal URLs. Replace `$PORT` with your actual service ports.
...
=======
Start [Agent Endpoints](/gateway/endpoints/agent-endpoints/) for your local development services using internal URLs. Replace `$PORT` with your actual service ports.
>>>>>>> origin/main
  ...
  <Step title="Apply Traffic Policy for development gateway">
  ...
  <Step title="Try out your development gateway">
    <TryOut />
...
- Learn about [securing developer environments](/gateway/examples/secure-developer-environments) for team-wide development workflows
...
- Configure [custom domains](/gateway/domains/custom-domains) for more professional development URLs
