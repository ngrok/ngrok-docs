...
<Steps>
  <Step title="Create internal endpoints for your local services">
    Start [Agent Endpoints](/endpoints/agent-endpoints/) for your local development services using internal URLs. Replace `$PORT` with your actual service ports.
...
- Configure [custom domains](/domains/custom-domains) for more professional development URLs
