...
<Steps>
  ...
  <Step title="Add canary routing with Traffic Policy">
  ...
  <Step title="Tweak the distribution to your canary">
  ...
  <Step title="Cut over to the new version and clean up">
...
- Start automating your deployment strategies with the ngrok [API](/api/) or the [Kubernetes Operator](/gateway/k8s/).
