...
This guide follows the style of the [n8n example](/gateway/examples/n8n/) and adds Odoo-specific steps, including using a static domain and applying a Traffic Policy.
...
<Steps titleSize="h2">
  <Step title="Reserve a static domain">
  ...
  <Step title="Start the ngrok endpoint for Odoo">
  ...
  <Step title="(Recommended) Configure Odoo for a proxy and stable URLs">
  ...
  <Step title="Apply a Traffic Policy (secure your admin)">
...
- Layer additional [policies](/gateway/traffic-policy/) (OAuth/OIDC, rate limits, IP allow/deny lists) as needed.
