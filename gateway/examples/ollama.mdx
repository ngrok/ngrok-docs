...
<Steps titleSize="h2">
  ...
  <Step title="Start your Ollama endpoint">
  ...
  <Step title="Try out your Ollama endpoint">
...
- Read more about [Traffic Policy](/traffic-policy), [core concepts](/gateway/traffic-policy/how-it-works), and [actions](/gateway/traffic-policy/actions) you might want to implement next, like [IP restrictions](/gateway/traffic-policy/actions/restrict-ips) instead of Basic Auth.
- Explore other ways to [block unwanted requests](/gateway/traffic-policy/examples/block-unwanted-requests/) from Tor users, search or AI bots, and more to protect your self-hosted LLM.
