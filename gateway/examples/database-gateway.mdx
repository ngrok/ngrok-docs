...
<Steps>
  <Step title="Create an endpoint for your database service">
    Start an internal [Agent Endpoint](/endpoints/agent-endpoints/) for your database proxy or HTTP database interface, replacing `$PORT` based on where it listens.
