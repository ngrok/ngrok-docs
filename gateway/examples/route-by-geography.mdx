...
<Steps>
  <Step title="Start endpoints for your services">
    On a server designated for U.S. traffic, start an internal [Agent Endpoint](/endpoints/agent-endpoints/), replacing `$PORT` based on where your service listens.
...
- Check out [Endpoint Pools](/endpoints/endpoint-pooling/) for dead-simple load balancing.
