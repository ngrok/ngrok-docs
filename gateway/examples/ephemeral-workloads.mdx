...
<Steps>
  <Step title="Reserve a wildcard domain">
    Navigate to the [**Domains** section](https://dashboard.ngrok.com/domains) of the ngrok dashboard and click **New +** to reserve a [custom wildcard domain](/domains/custom-domains/) like `*.preview.example.com`.
  ...
  <Step title="Start an Agent Endpoint from your CI pipeline">
    In your CI/CD workflow, start an internal [Agent Endpoint](/endpoints/agent-endpoints/) that matches the preview URL pattern.
