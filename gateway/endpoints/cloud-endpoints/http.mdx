...
import CloudEndpointQS from "/snippets/gateway/shared/cloud-endpoints-qs.mdx"
...
To configure the use of HTTP/2 when sending traffic to an upstream service, consider [using an Agent Endpoint](/gateway/endpoints/http/#http2-forwarding).
