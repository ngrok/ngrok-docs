...
action](/gateway/traffic-policy/actions/forward-internal/). The Traffic Policy of
...
- [Forwarding Traffic to and Load Balancing Internal Endpoints with Cloud Endpoints](/gateway/endpoints/cloud-endpoints/forwarding-and-load-balancing/)
- [Path-based Routing and Policy Decentralization with Cloud Endpoints](/gateway/endpoints/cloud-endpoints/routing-and-policy-decentralization)
