...
- An [ngrok API key](https://dashboard.ngrok.com/api-keys) configured on your [ngrok agent](/gateway/agent/#api-keys).
...
<Steps titleSize="h2">
  <Step title="Create an internal endpoint">
  ...
  <Step title="Load balancing with Endpoint Pools">
