...
If you are accepting TLS traffic, you may prefer to create a [TLS Endpoint](/gateway/endpoints/tls/).
...
This example forwards traffic from a randomly assigned TCP address such as `tcp://1.tcp.ngrok.io:12345` to a local port.
...
- [Public Endpoint URLs](/gateway/endpoints/public-endpoints/#tcp)
...
create a [TCP Address](/gateway/domains/tcp-addresses). When you create a TCP
...
See [TCP Addresses pricing](/gateway/domains/tcp-addresses/#pricing) for
