...
- It supports [TCP](/endpoints/tcp/), [TLS](/endpoints/tls/), and [HTTP/S](/endpoints/http/).
...
<Columns cols={1}>
	<Card title="Endpoints" icon="globe" href="/endpoints/" horizontal>
	...
	<Card title="TLS Certificate Authorities" icon="people-group" href="/domains/mtls-termination/" horizontal>
