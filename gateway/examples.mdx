---
title: Gateway Examples
sidebarTitle: Overview
description: Browse examples and patterns for using ngrok's Gateway including API gateway patterns, multicloud failover, and integrations.
---
