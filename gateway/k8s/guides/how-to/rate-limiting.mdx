...
description: Configure rate limiting in Kubernetes to protect your services from excessive traffic and ensure fair usage across clients.
---
...
Check out the [rate limit Traffic Policy action](/gateway/traffic-policy/actions/rate-limit/) page for more details about how it functions and the parameters it accepts.
...
<<<<<<< HEAD:k8s/guides/how-to/rate-limiting.mdx
    ```yaml
...
>>>>>>> origin/main:gateway/k8s/guides/how-to/rate-limiting.mdx
