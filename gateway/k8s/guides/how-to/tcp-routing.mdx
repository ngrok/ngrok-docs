...
You must first create a [TCP Address](/gateway/domains/tcp-addresses/). 
When you create a TCP address, a random hostname and port will be assigned to you, for example, `1.tcp.ngrok.io:12345`.
See the [TCP Endpoints page](/gateway/endpoints/tcp/) for more details on how ngrok handles TCP endpoints.
