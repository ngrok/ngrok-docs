...
The [using CRDs guide](/gateway/k8s/guides/using-crds) goes over the details and differences about how to configure each one.
...
If you would like to control TLS termination yourself, you can use the [terminate-tls Traffic Policy action](/gateway/traffic-policy/actions/terminate-tls/).
...
This step is not necessary for internal endpoints. See [the bindings page](/gateway/k8s/guides/bindings) for more information about public/internal/k8s endpoints.
