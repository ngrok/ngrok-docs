...
This guide assumes that you have already installed the Operator and the Gateway API CRDs following the [installation guide](/gateway/k8s/installation/helm).
