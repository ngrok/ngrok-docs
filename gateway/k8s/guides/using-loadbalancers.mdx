---
title: How the ngrok Operator Uses LoadBalancer Services
sidebarTitle: Using LoadBalancer Services
description: Learn how the ngrok Kubernetes Operator automatically exposes LoadBalancer services using TCP or TLS endpoints with reserved addresses.
---
...
See the [TCP Endpoint](/gateway/endpoints/tcp/) and [TLS Endpoint](/gateway/endpoints/tls/) pages for more information about how ngrok handles these kinds of endpoints.
