...
The [endpoint pooling page](/gateway/endpoints/endpoint-pooling/) goes over concepts and details of pooling in more depth.
...
See the [using Ingresses guide](/gateway/k8s/guides/using-ingresses) for more information.
