...
<Columns cols={1}>
	<Card title="How it works" href="/gateway/k8s/how-it-works/" horizontal>
		Learn how the Operator establishes secure connections and routes traffic.
	</Card>
	<Card title="Architecture" href="/gateway/k8s/installation/architecture/" horizontal>
		Understand the Operator's control loops and design.
	</Card>
	<Card title="Load Balancing" href="/gateway/k8s/load-balancing/load-balancing-kubernetes/" horizontal>
...
- [Local cluster options](/gateway/k8s/guides/local-cluster/) - Set up a local Kubernetes cluster for development and testing.
- [Helm configuration](/gateway/k8s/installation/helm/) - Reference for Helm config values when installing the Operator.
- [Observability](/gateway/k8s/installation/observability/) - Monitor and observe your Operator deployment.
...
<Columns cols={2}>
	<Card
		...
		icon="user"
		href="/gateway/k8s/guides/how-to/oauth/"
	>
	...
	<Card
		...
		icon="route"
		href="/gateway/k8s/guides/how-to/request-routing/"
	>
	...
	<Card
		...
		icon="lock"
		href="/gateway/k8s/guides/how-to/tls-routing/"
	>
	...
	<Card
		...
		icon="shield-check"
		href="/gateway/k8s/guides/how-to/rate-limiting/"
	>
...
- Explore the [guides](/gateway/k8s/guides/using-crds/) for common use cases and configurations.
