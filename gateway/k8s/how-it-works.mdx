...
<img src="./assets/images/basic-k8s-diagram.png" alt="Diagram showing a user blocked from accessing pods in a Kubernetes private network, while pods can communicate with each other internally" width="928" height="472" />
...
<img src="./assets/images/basic-k8s-ingress-diagram.png" alt="Diagram showing a Kubernetes ingress controller routing external user traffic into pods within a private Kubernetes network" width="877" height="600" />
...
<img src="./assets/images/basic-ngrok-k8s-ingress-diagram.png" alt="Diagram showing the ngrok Kubernetes ingress controller creating a public endpoint and routing traffic through ngrok Edge into a private Kubernetes cluster" width="1147" height="600" />
...
<img src="./assets/images/basic-k8s-operator-user-diagram.png" alt="Diagram showing an infra team managing the ngrok Kubernetes ingress controller while separate service teams self-service their own ingress configurations" width="1052" height="557" />
