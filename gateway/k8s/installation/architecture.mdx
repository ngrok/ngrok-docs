...
<img src="../assets/images/kubebuilder-architecture-diagram.svg" alt="Kubebuilder architecture diagram showing the Controller Runtime Manager running multiple controllers with shared Kubernetes client caches" width="960" height="720" />
...
For more information about bindings, see [the bindings guide](/gateway/k8s/guides/bindings)
