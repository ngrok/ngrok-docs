...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/gateway/k8s/crds/cloudendpoint/`}>
    ...
    <Link to={`/gateway/k8s/crds/agentendpoint/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/gateway/k8s/crds/ngroktrafficpolicy/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
    ...
    <Link to={`/gateway/k8s/crds/boundendpoint/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/gateway/k8s/crds/domain/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
    ...
    <Link to={`/gateway/k8s/crds/kubernetesoperator/`}>
      <div className="ngrok--card hover:bg-card-hover">
        <div className="ngrok--card-heading">
...
<div className="ngrok--cards ngrok--cards-flex ngrok--cards-row">
    <Link to={`/gateway/k8s/crds/ippolicy/`}>
        <div className="ngrok--card hover:bg-card-hover">
            <div className="ngrok--card-heading">
