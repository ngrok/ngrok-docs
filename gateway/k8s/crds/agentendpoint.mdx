...
See the [ngrok agent CLI configuration page](/gateway/agent/config/v3/#endpoint-definitions), for more information about using the CLI to start Agent Endpoints outside of Kubernetes.
...
**Note:** [Pooling](/gateway/endpoints/endpoint-pooling) is always enabled for `AgentEndpoint` resources.
...
For more information about writing ngrok Traffic Policies, refer to the [Traffic Policy section](/gateway/traffic-policy/).
