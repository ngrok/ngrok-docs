...
Because that certificate is not issued for your hostname, browsers and other TLS clients will show a certificate name-mismatch warning (for example, `NET::ERR_CERT_COMMON_NAME_INVALID` in Chrome) if they connect to your endpoint before provisioning finishes.
