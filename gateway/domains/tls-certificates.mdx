...
connections to [HTTPS endpoints](/gateway/endpoints/http) and [TLS
endpoints](/gateway/endpoints/tls). TLS certificates are attached to
...
See the [TLS Termination](/gateway/domains/tls-termination/)
...
action](/gateway/traffic-policy/actions/terminate-tls/).
