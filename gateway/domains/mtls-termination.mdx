...
If you want the ngrok **agent** to terminate TLS and verify client certificates itself, see [Agent TLS Termination](/agent/agent-tls-termination#optional-require-client-certificates-mtls-at-the-agent) instead.
