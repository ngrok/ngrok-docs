...
By default, [this connect URL](/gateway/agent/connect-url/) is `connect.ngrok-agent.com`, but you can white-label it so that your ngrok agents connect to `connect.acme.com` instead of the default connection hostname.
