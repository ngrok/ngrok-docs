...
The agent can update itself with the [`ngrok update`](/gateway/agent/cli/#ngrok-update) command, even if you didn't install it with a package manager.
...
For more details, see the [Kubernetes Operator](/gateway/k8s/) documentation.
