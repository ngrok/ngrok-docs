...
- An ngrok agent installed in a remote customer network. See the [Agent CLI Quickstart](/gateway/endpoints/agent-cli-quickstart/) for instructions on how to install the ngrok agent.
...
<Steps>
  ...
  <Step title="Test end-to-end connectivity from your local environment to upstream services">
    ...
    ```
<<<<<<< HEAD:guides/site-to-site-connectivity/non-k8s-environment.mdx
  </Step>
</Steps>
=======
  </Tab>
...
psql -h db.example.com -p 5432 -U myuser mydb
```
>>>>>>> origin/main:gateway/site-to-site-connectivity/non-k8s-environment.mdx
