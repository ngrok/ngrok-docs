...
sidebarTitle: API
description: The ngrok agent exposes a local HTTP API for collecting status and metrics, capturing and replaying requests, and starting or stopping endpoints while it runs.
---
## Overview
