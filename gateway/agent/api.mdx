---
title: ngrok Agent CLI API
sidebarTitle: API
description: The ngrok Agent CLI exposes a local HTTP API for collecting status and metrics, capturing and replaying requests, and starting or stopping endpoints while it runs.
---
## Overview
...
Use the [tunnel definitions](/gateway/agent/config/v2/#tunnel-configurations) section as a reference for configuration parameters and their behaviors.
