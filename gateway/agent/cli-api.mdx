...
You can get the initial API key at https://dashboard.ngrok.com/api-keys.
Additional keys can be created through 'ngrok api api-keys create' subcommand.
...
| [api-keys](#ngrok-api-api-keys)    | API Keys are used to authenticate to the ngrok API (https://ngrok                                          |
...
| [networks](#ngrok-api-networks)    | Networks provide private address space for an account.                                          |
...
|  `--filter` | A CEL expression to filter the list results. Supports logical and comparison operators to match on fields such as id, metadata, created_at, and more. See ngrok API Filtering for syntax and field details: https://ngrok.com/docs/api/api-filtering (https://ngrok.com/docs/api/api-filtering). |
|  `--limit` | Constrains the number of results in the dataset. See the API Overview (https://ngrok.com/docs/api/index#pagination) for details. |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
|  `--owner-email` | If supplied at credential creation, ownership will be assigned to the specified User. Only admins may specify an owner other than themselves. Only one of owner_id, owner_email, or scim_user_id may be specified. specified. |
...
|  `--scim-user-id` | If supplied at credential creation, ownership will be assigned to the specified SCIM User. Only admins may specify an owner other than themselves. Only one of owner_id, owner_email, or scim_user_id may be specified. |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
Networks provide private address space for an account.

### SubCommands

| Command                         | Description                                                   |
| ------------------------------- | ------------------------------------------------------------- |
| [create](#ngrok-api-networks-create)    | Create a network                                          |
| [delete](#ngrok-api-networks-delete)    | Delete a network and its IP assignments.                                          |
| [get](#ngrok-api-networks-get)    | Get a network by ID.                                          |
| [ips](#ngrok-api-networks-ips)    | IP assignments reserve addresses in a network.                                          |
| [list](#ngrok-api-networks-list)    | List networks owned by the authenticated account.                                          |
| [update](#ngrok-api-networks-update)    | Update the description or metadata                                          |
...
## ngrok api networks create

Create a network. Omitted CIDRs and the search domain receive defaults.

### Usage

```sh
ngrok api networks create [flags]
```
...
|  `--ipv-4-cidr` | Private IPv4 CIDR. If omitted, the API allocates an RFC 1918 /16. |
|  `--ipv-6-cidr` | Private IPv6 CIDR. If omitted, the API allocates a /56 within the account's unique-local /48. |
|  `--metadata` | User-defined metadata as string key-value pairs. |
|  `--search-domain` | DNS suffix without a leading dot. Defaults to the network ID, with its underscore replaced by a hyphen, under ngrok.network. |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
## ngrok api networks delete

Delete a network and its IP assignments.

### Usage

```sh
ngrok api networks delete <id> [flags]
```
...
```sh
ngrok api networks get <id> [flags]
```
...
## ngrok api networks ips

IP assignments reserve addresses in a network.

### SubCommands

| Command                         | Description                                                   |
| ------------------------------- | ------------------------------------------------------------- |
| [create](#ngrok-api-networks-ips-create)    | Reserve a static IP address in a network.                                          |
| [delete](#ngrok-api-networks-ips-delete)    | Release an IP assignment.                                          |
| [get](#ngrok-api-networks-ips-get)    | Get an IP assignment by ID within its network.                                          |
| [list](#ngrok-api-networks-ips-list)    | List IP assignments in a network.                                          |
| [update](#ngrok-api-networks-ips-update)    | Update an assignment's name                                          |
...
## ngrok api networks ips create

Reserve a static IP address in a network.

### Usage

```sh
ngrok api networks ips create <network-id> [flags]
```
...
| Flag              | Description                             |
| ----------------- | --------------------------------------- |
|  `--address` | Requested address within the network's CIDR. If omitted, the API allocates an address. |
|  `--ip-version` | Address family: 4 or 6. Required without an address. If both are present, they must match. |
|  `--name` | Optional DNS label, unique per address family within the network. Names are case-insensitive and returned in lowercase. |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
```sh
ngrok api networks ips delete <network-id> <id> [flags]
```
...
## ngrok api networks ips get

Get an IP assignment by ID within its network.

### Usage

```sh
ngrok api networks ips get <network-id> <id> [flags]
```
...
## ngrok api networks ips list

List IP assignments in a network.

### Usage

```sh
ngrok api networks ips list <network-id> [flags]
```
...
## ngrok api networks ips update

Update an assignment's name. An empty string clears the name.

### Usage

```sh
ngrok api networks ips update <network-id> <id> [flags]
```
...
## ngrok api networks list

List networks owned by the authenticated account.

### Usage

```sh
ngrok api networks list [flags]
```
...
## ngrok api networks update

Update the description or metadata. An empty string clears the description. An empty map clears metadata.

### Usage

```sh
ngrok api networks update <id> [flags]
```
...
| [delete](#ngrok-api-personal-access-tokens-delete)    | Delete a Personal Access Token by ID                                          |
...
| [revoke](#ngrok-api-personal-access-tokens-revoke)    | Revoke a Personal Access Token by ID                                          |
...
Delete a Personal Access Token by ID. The token immediately stops working and disappears from Get/List, but is not permanently removed -- it may be restored by an ngrok operator as part of a support request.
...
## ngrok api personal-access-tokens revoke

Revoke a Personal Access Token by ID. Unlike Delete, a revoked token remains visible in Get/List responses.

### Usage

```sh
ngrok api personal-access-tokens revoke <id> [flags]
```
...
| Command                         | Description                                                   |
| ------------------------------- | ------------------------------------------------------------- |
| [create](#ngrok-api-ssh-credentials-create)    | Create a new ssh_credential from an uploaded...                                          |
