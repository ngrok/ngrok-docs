---
title: Run the ngrok Agent CLI as a Service
sidebarTitle: Run as a Service
description: Install the ngrok Agent CLI as a native operating system service so it starts on boot and restarts after a crash, then manage it remotely from the API or dashboard.
---
