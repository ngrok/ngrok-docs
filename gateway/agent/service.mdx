...
description: Install the ngrok agent as a native operating system service and manage it remotely.
---
...
Create an ngrok [configuration file](/gateway/agent/config/). For this example,
