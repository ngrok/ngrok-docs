...
configurations.
Defining tunnel configurations is useful because you may then
start pre-configured tunnels by name from your command line without remembering
all of the right arguments every time.
You may also use this method to start as
...
| `ip_restriction.allow_cidrs`                                                           | Array of CIDRs                                                               | Rejects connections that don't match the given CIDRs                                                                                                                                                                                                                                             |
...
| `oauth.provider`                                                                       | String                                                                       | enforce authentication OAuth2 provider on the endpoint, for example, 'google'. For a lit of available providers, see [OAuth2 providers](/gateway/traffic-policy/actions/oauth/#supported-providers).                                                                                                              |
| [`policy.inbound.name`](/gateway/traffic-policy/)                                              | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.expressions`](/gateway/traffic-policy/how-it-works#expressions)                  | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.actions.type`](/gateway/traffic-policy/actions/)                              | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.inbound.actions.config`](/gateway/traffic-policy/actions/)                            | custom                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.name`](/gateway/traffic-policy/)                                             | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.expressions`](/gateway/traffic-policy/how-it-works#expressions)                 | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.actions.type`](/gateway/traffic-policy/actions/)                             | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
| [`policy.outbound.actions.config`](/gateway/traffic-policy/actions/)                           | custom                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
...
| [`traffic_policy.on_http_request.name`](/gateway/traffic-policy/)                              | String                                                                       | The name of an `on_http_request` rule that is part of a Traffic Policy                                                                                                                                                                                                                            |
| [`traffic_policy.on_http_request.expressions`](/gateway/traffic-policy/how-it-works#expressions)  | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_request` policy rule applies to                                                                                                                                                              |
| [`traffic_policy.on_http_request.actions.type`](/gateway/traffic-policy/actions/)              | String                                                                       | The type of action that should be executed when this `on_http_request` policy rule is activated                                                                                                                                                                                                   |
| [`traffic_policy.on_http_request.actions.config`](/gateway/traffic-policy/actions/)            | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
| [`traffic_policy.on_http_response.name`](/gateway/traffic-policy/)                             | String                                                                       | The name of an `on_http_response` rule that is part of a Traffic Policy                                                                                                                                                                                                                           |
| [`traffic_policy.on_http_response.expressions`](/gateway/traffic-policy/how-it-works#expressions) | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_response` policy rule applies to                                                                                                                                                             |
| [`traffic_policy.on_http_response.actions.type`](/gateway/traffic-policy/actions/)             | String                                                                       | The type of action that should be executed when this `on_http_response` policy rule is activated                                                                                                                                                                                                  |
| [`traffic_policy.on_http_response.actions.config`](/gateway/traffic-policy/actions/)           | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                              |
...
| `verify_webhook.provider`                                                              | String                                                                       | Verify webhooks are signed by this provider, for example, 'slack'. For a full list of providers, see [Webhook Verification Providers](/gateway/traffic-policy/actions/verify-webhook/#supported-providers).                                                                                                       |
...
| [`traffic_policy.inbound.name`](/gateway/traffic-policy/)                              | String                         | The name of an inbound rule that is part of a Traffic Policy                                                                                                                                                                  |
| [`traffic_policy.inbound.expressions`](/gateway/traffic-policy/how-it-works#expressions)  | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the inbound policy rule applies to                                                                                                    |
| [`traffic_policy.inbound.actions.type`](/gateway/traffic-policy/actions/)              | String                         | The type of action that should be executed when this inbound policy rule is activated                                                                                                                                         |
| [`traffic_policy.inbound.actions.config`](/gateway/traffic-policy/actions/)            | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
| [`traffic_policy.outbound.name`](/gateway/traffic-policy/)                             | String                         | The name of an outbound rule that is part of a Traffic Policy                                                                                                                                                                 |
| [`traffic_policy.outbound.expressions`](/gateway/traffic-policy/how-it-works#expressions) | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the outbound policy rule applies to                                                                                                   |
| [`traffic_policy.outbound.actions.type`](/gateway/traffic-policy/actions/)             | String                         | The type of action that should be executed when this outbound policy rule is activated                                                                                                                                        |
| [`traffic_policy.outbound.actions.config`](/gateway/traffic-policy/actions/)           | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
...
| Name                                        | Description                                                                                                                                                                                        |
| ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [api_key](#api-key)                         | Specifies the ngrok API key used to connect to the ngrok API. This is only needed when using the `ngrok api` command and should not be confused with the authtoken.                                |
...
| [heartbeat_tolerance](#heartbeat-tolerance) | Reconnect the agent tunnel session if the server doesn't respond to a heartbeat within this tolerance defined as a duration. Default is 15s.                                                      |
...
| [metadata](#metadata)                       | Opaque, user-supplied string that will be returned as part of the ngrok API response to the [list online sessions](/api-reference/tunnelsessions/list) resource for all tunnels started by this agent. |
...
| [root_cas](#root-cas)                       | The root certificate authorities used to validate the TLS connection to the ngrok server.                                                                                                          |
| [server_addr](#server-addr)                 | This is the URL of the ngrok server to connect to. You should only set this if you are using a custom ingress URL.                                                                                 |
| [tunnels](#tunnels)                         | A map of names to tunnel definitions. See [V2 agent config tunnel definitions](/gateway/agent/config/v2/#tunnel-configurations) for more details.                                                          |
...
This option specifies the API key used to access the ngrok API through the [`ngrok api`](/gateway/agent/cli-api) command.
This is only needed when using the [ngrok API](/api) and not the local ngrok agent API (available at `localhost:4040/api`).
You can generate an API Key in the [ngrok Dashboard](https://dashboard.ngrok.com/api-keys) and install it using the `ngrok config add-api-key` command.
...
Reconnect the agent tunnel session if the server doesn't respond to a heartbeat within this tolerance defined as a duration.
The default is 15s.
...
Set this to `true` to allow the ngrok agent to be remotely managed (stop, restart, update) via the [ngrok API](/api-reference/tunnelsessions/restart) or the [ngrok Dashboard](https://dashboard.ngrok.com/agents).
Defaults to `true`.
...
| ------------------ | ------- | -------------------------------------------------------------------------------------------------------------------------------------- |
|                    | default | requests to localhost-bound web interface or API endpoints are checked to have a localhost-like Host such as localhost, 127.0.0.1, or ::1 |
