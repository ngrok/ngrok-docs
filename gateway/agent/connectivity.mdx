...
description: How the ngrok agent reaches the ngrok service, covering addresses, DNS resolution, TLS verification, heartbeats, and how to diagnose a session that won't start.
---
