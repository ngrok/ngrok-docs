...
| Feature                    | Replacement                                                                                                                     |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------------- |
| **Edges**                  | [Cloud Endpoints](/endpoints/cloud-endpoints/)                                                                          |
...
| **Labeled Tunnels**        | [Internal Endpoints](/endpoints/internal-endpoints/)                                                                    |
| **Tunnel Group Backend**   | [Forward Internal Action](/traffic-policy/actions/forward-internal/) and [Endpoint Pools](/endpoints/endpoint-pooling/) |
...
| **Load Balancing**         | [Endpoint Pools](/endpoints/endpoint-pooling/)                                                                          |
