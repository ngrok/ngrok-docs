# Privately connect to your Remote IoT Devices in the Field

### Use ngrok to configure private, remote access to IoT devices and services in the field without a VPN.
...
This guide walks you through how to configure `ngrokd`: An ngrok component meant to enable a private, end-to-end remote access solution for IoT devices. This solution lets you securely access critical systems remotely without exposing them through public, authenticated endpoints. Instead, it leverages private endpoints that are only reachable from your local environment, eliminating your external attack surface while maintaining full access.

## **Architectural reference**

![ngrokd device gw architecture (2).png](Privately%20connect%20to%20your%20Remote%20IoT%20Devices%20in%20th/ngrokd_device_gw_architecture_(2).png)
...
![Screenshot 2026-05-07 at 4.12.47 PM.png](Privately%20connect%20to%20your%20Remote%20IoT%20Devices%20in%20th/Screenshot_2026-05-07_at_4.12.47_PM.png)
...
![Screenshot 2026-05-07 at 4.18.20 PM.png](Privately%20connect%20to%20your%20Remote%20IoT%20Devices%20in%20th/Screenshot_2026-05-07_at_4.18.20_PM.png)

From here, you can curl your HTTP endpoint and ensure you get the expected response. The same can be done for your TCP endpoint by connecting to it at the assigned hostname and port (e.g., `ssh user@camera.example.com -p 22`).
