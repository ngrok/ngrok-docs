...
description: Configure JWT validation in Kubernetes to secure your endpoints by verifying authentication tokens at ngrok.
---

By validating JWTs at ngrok, you can:
...
By performing JWT validation at ngrok, you can offload authentication tasks from your backend and prevent unauthorized access before requests reach your service.
...
- **Reducing Backend Load:** Offload JWT validation to ngrok, reducing unnecessary authentication checks.
