...
🔐 Use your own TLS certificates instead of ngrok-managed certificates. <br /> ⚡ Enforce specific TLS versions for enhanced security. <br /> 🔄 Configure mutual TLS (mTLS) for bidirectional authentication between clients and your services. <br />

## 🔍 What are the benefits of customizing TLS termination?

TLS termination is essential for securing data in transit.
Customizing TLS settings allows you to:
