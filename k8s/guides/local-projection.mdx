...
The ngrok CLI works best for if you're _not_ running the service in a local K8s cluster, like [k3d](https://k3d.io/stable/) or [kind](https://kind.sigs.k8s.io/)—for that, use the ngrok Kubernetes Operator on the local cluster as well.
