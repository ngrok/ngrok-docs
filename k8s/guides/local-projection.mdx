...
If other services in your cluster already communicate with a service you want to replace, you can redirect their traffic to endpoint running on your local machine.
