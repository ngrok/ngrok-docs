...
The ngrok CLI works best for if you're _not_ running the service in a local K8s cluster, like k3d or kind—for that, use the ngrok Kubernetes Operator on the local cluster as well.
