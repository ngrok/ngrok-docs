...
Any resource with these labels will have its lifecycle controlled by the ngrok Operator.
They should never be used on resources you create and manage yourself.
...
You can use these labels to your advantage to list the resources that the Operator manages.
For example, to get all `AgentEndpoint` resources that are created and managed by the Operator:
