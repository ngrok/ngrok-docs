...
### 1. Create a service user (previously called a bot user) and authtoken for Customer 1

First, you will create a service user + associated authtoken for each of your customers.
