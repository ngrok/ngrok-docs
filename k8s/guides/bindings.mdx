...
For a full reference of the available variables, error handling, and usage examples, see [Restricting Access by Kubernetes Pod Identity](/docs/k8s/guides/how-to/pod-identity).
