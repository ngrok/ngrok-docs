...
The `AgentEndpoint` resource is used to create [Agent Endpoints](/endpoints/agent-endpoints/) using the Operator.
...
The `CloudEndpoint` resource is used to create [Cloud Endpoints](/endpoints/cloud-endpoints/) using the Operator.
