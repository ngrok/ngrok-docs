...
If you would like to enforce mutual TLS, you can reference `Secret` objects that contain client certificates that the Operator should use for the `AgentEndpoint` when connecting to the upstream.
