...
![Kubebuilder architecture diagram showing the Controller Runtime Manager running multiple controllers with shared Kubernetes client caches](../assets/images/kubebuilder-architecture-diagram.svg)
