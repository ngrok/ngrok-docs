...
For more information about Cloud Endpoints in ngrok, refer to the [Cloud Endpoints page](/endpoints/cloud-endpoints/)
...
Configures whether [pooling](/endpoints/endpoint-pooling) is always enabled for this `CloudEndpoint`.
