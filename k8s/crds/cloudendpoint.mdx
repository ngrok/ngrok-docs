...
For more information about Cloud Endpoints in ngrok, refer to the [Cloud Endpoints page](/gateway/endpoints/cloud-endpoints/)
...
Configures whether [pooling](/gateway/endpoints/endpoint-pooling) is always enabled for this `CloudEndpoint`.
