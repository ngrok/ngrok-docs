...
[Endpoint Pooling](/endpoints/endpoint-pooling/) makes load
...
Endpoint](/endpoints/cloud-endpoints/) that serves as the "front
door" to all your Kubernetes services, then create a pool of [internal Agent
Endpoints](/endpoints/internal-endpoints/) on a pooled URL like
