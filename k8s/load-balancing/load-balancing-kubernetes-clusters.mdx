...
Pooling](/endpoints/endpoint-pooling/) lets you share traffic between
replicas of your services on any number of clusters by deploying them on the same
[internal](/endpoints/internal-endpoints/) URL. With the addition
of a [Cloud Endpoint](/endpoints/cloud-endpoints) and [Traffic
