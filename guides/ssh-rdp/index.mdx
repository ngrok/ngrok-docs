...
- An ngrok agent, configured on your edge gateway or remote device/service. See the [Agent CLI Quickstart](/gateway/agent-cli-quickstart/) for instructions on how to install the ngrok agent.
