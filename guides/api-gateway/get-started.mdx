...
description: Learn how to set up ngrok as an API gateway with internal agent endpoints and a cloud endpoint with Traffic Policy.
---
...
3. Learn [how to monitor your API traffic](/guides/api-gateway/other-guides/monitor-ngrok), so you'll
