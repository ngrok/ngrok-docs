...
While this guide focuses on exporting to Datadog, we also have quickstarts for [AWS CloudWatch](/integrations/event-destinations/amazon-cloudwatch-event-destination.mdx), [AWS Firehose](/integrations/event-destinations/amazon-firehose-event-destination.mdx), [AWS Kinesis](/integrations/event-destinations/amazon-kinesis-event-destination.mdx), and [Azure Logs](/integrations/event-destinations/azure-logs-ingestion-event-destination.mdx).
