...
While this guide focuses on exporting to Datadog, we also have quickstarts for [AWS CloudWatch](/integrations/amazon-cloudwatch/event-destination/), [AWS Firehose](/integrations/amazon-firehose/event-destination/), [AWS Kinesis](/integrations/amazon-kinesis/event-destination/), and [Azure Logs](/integrations/azure-logs-ingestion/event-destination/).
