...
Load balancing at ngrok is done with [endpoint pooling](https://ngrok.com/docs/universal-gateway/endpoint-pooling/). When multiple ngrok endpoints are created with the same URL and with the *pooling_enabled* flag, ngrok automatically balances traffic across them. 
