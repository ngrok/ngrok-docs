...
![Architecture diagram showing ngrok acting as a multicloud API gateway routing traffic from the public internet through a traffic policy layer to services running in AWS EKS and Google Cloud GKE clusters](./img/ngrok-multicloud-api-gateway-eks-gke-architecture.png)
...
![ngrok dashboard New Cloud Endpoint dialog with Public binding selected and a custom domain URL](./img/new-cloud-endpoint-public-binding-dialog.png)
