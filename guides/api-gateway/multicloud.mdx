...
Load balancing at ngrok is done with [endpoint pooling](https://ngrok.com/docs/universal-gateway/endpoint-pooling/). When multiple ngrok endpoints are created with the same URL and with the _pooling_enabled_ flag, ngrok automatically balances traffic across them.
