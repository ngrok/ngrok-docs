...
Additional security features include [RBAC](/iam/rbac), [SSO & SCIM](/iam/sso), [audit logs](/obs/events), [DDoS protection](/universal-gateway/ddos-protection), and [data residency](/universal-gateway/region-pinning/) options.
...
- **Data residency:** Control where traffic is processed and is available using [Region pinning](/universal-gateway/region-pinning/), available on [Pay-as-you-go](/pricing-limits/#pay-as-you-go-faqs) plans and above.
