...
Limit access to your device endpoints to specific IP addresses or CIDR ranges [using Traffic Policy](/traffic-policy/actions/restrict-ips/):
...
(The opt-in [Traffic Inspector](/agent/traffic-inspection/) Full Capture mode does store request and response headers and bodies for debugging purposes.)
...
- **Data residency:** [Region pinning](/universal-gateway/region-pinning/) lets you control where traffic is processed and is available on Pay-as-you-go and above.
