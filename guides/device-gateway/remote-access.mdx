...
![Architecture diagram: one ngrok agent per remote network routing cloud traffic to internal SSH and RDP devices](img/secure-remote-access/ssh-rdp-secure-remote-access-architecture.png)
...
![Service Users page with New Service User button](img/secure-remote-access/new-service-user-dialog.png)

Next, create an authtoken assigned to this specific service user.

![Authtokens page showing a new authtoken assigned to a service user](img/secure-remote-access/new-authtoken-service-user-dialog.png)
...
![Reserved TCP addresses page with a newly reserved address](img/secure-remote-access/new-tcp-address-dialog.png)
...
![Endpoints page with New button to create a TCP Cloud Endpoint](img/secure-remote-access/new-cloud-endpoint-tcp-dialog.png)
