...
![ngrokd device gateway architecture](img/private-connectivity/device-gateway-private-connectivity-architecture.png)
...
![ngrokctl list output showing private endpoints](img/private-connectivity/ngrokctl-list-bound-endpoints.png)
