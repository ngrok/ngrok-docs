...
Reserve a domain with a wildcard pattern (see [reserved domains API](/api-reference/reserveddomains/list)), which will allow you to
...
Update line `109` with your domain. Since you reserved a domain with a wildcard pattern, you can create endpoints on any subdomain
