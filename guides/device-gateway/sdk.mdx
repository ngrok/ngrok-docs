...
You'll create a service user (previously called a bot user) so that in the next section, you can create an agent authtoken independent of any user account.
