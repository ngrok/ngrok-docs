...
Create a service user (previously called a bot user) so that you can create an agent authtoken independent of any user account. A service user represents a service
