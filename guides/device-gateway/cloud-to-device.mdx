...
![Device GW Arch (1).png](img/cloud-to-device/cloud-to-device-arch.png)
...
![image.png](img/cloud-to-device/cloud-to-device-service-user.png)

Next, create an authtoken assigned to this specific service user.

![Screenshot 2026-01-23 at 12.35.00 PM.png](img/cloud-to-device/cloud-to-device-authtoken.png)
...
![Screenshot 2026-01-23 at 12.37.00 PM.png](img/cloud-to-device/cloud-to-device-tcp-address.png)
...
![Screenshot 2026-02-10 at 1.54.24 PM.png](img/cloud-to-device/cloud-to-device-cloud-endpoint.png)
