...
<Columns cols={1}>
  <Card
    icon="network-wired"
    title="Ingress to IoT Devices"
    href={`/guides/device-gateway/agent/`}
  >
    Learn how to use ngrok to remotely access IoT devices and services. Connect
    remotely without VPN or SSH.
  </Card>
  <Card
  ...
  <Card
    ...
    href={`/using-ngrok-with/minecraft/`}
  >
