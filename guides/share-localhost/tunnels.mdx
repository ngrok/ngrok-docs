...
For more details, see the [protocols documentation](/endpoints/protocols).

## Agent Endpoints

Each tunnel creates an [Agent Endpoint](/endpoints/agent-endpoints/): an endpoint that exists only while the agent is running.
