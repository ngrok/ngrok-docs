...
1. Start your backend API on your development machine
2. Run `ngrok http <port>` to get a public HTTPS URL
3. Point your mobile app at the ngrok URL instead of `localhost`
4. Test your app against your local backend from any device
...
Use the HTTPS forwarding URL in your mobile app's API configuration. Since ngrok provides a valid TLS certificate, your app will work without any certificate pinning workarounds.
...
On paid plans, you can use the `--url` flag to get a consistent domain for your endpoint, so you don't need to update your mobile app's configuration every time you restart ngrok:
