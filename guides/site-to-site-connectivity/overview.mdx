...
<CardGroup cols={2}>
  <Card
    title="Quickstart" icon="rocket" href="/guides/site-to-site-connectivity/quickstart" > {" "} Get a basic site-to-site connection working in minutes
  </Card>
  <Card
    title="Full tutorial" icon="book" href="/guides/site-to-site-connectivity/" > {" "} Walk through a complete setup with multiple endpoints, mTLS, and IP restrictions
  </Card>
  <Card
    title="End customer guide" icon="user" href="/guides/site-to-site-connectivity/end-customers" > {" "} Share this reference with customers who need to understand why ngrok is being installed in their network
  </Card>
  <Card
    title="Running in Kubernetes?" icon="dharmachakra" href="/guides/site-to-site-connectivity/customer-networks" > {" "} Achieve private site-to-site connectivity with the ngrok Kubernetes Operator
  </Card>
</CardGroup>
