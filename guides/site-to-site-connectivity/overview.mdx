...
ngrok helps you securely access APIs, databases, and other private services running in remote networks through [site-to-site connectivity](https://ngrok.com/use-cases/site-to-site-connectivity).
This is useful for securely connecting to your customers' on-prem environments, branch offices, data centers, and more, all without opening inbound ports or managing VPN infrastructure.
