...
<CardGroup cols={2}>
  <Card
    title="Quickstart"
    icon="rocket"
    href="/guides/site-to-site-connectivity/quickstart"
  >
  ...
  >
    Walk through a complete setup with multiple endpoints, mTLS, and IP
    restrictions
  </Card>
  <Card
    title="End customer guide"
    icon="user"
    href="/guides/site-to-site-connectivity/end-customers"
  >
    Share this reference with customers who need to understand why ngrok is
    being installed in their network
  </Card>
  <Card
    title="Running in Kubernetes?"
    icon="dharmachakra"
    href="/guides/site-to-site-connectivity/customer-networks"
  >
