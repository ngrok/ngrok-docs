...
![Domains page showing reserved domains for private agent endpoints](./img/Screenshot_2026-05-08_at_3.50.07_PM.png)
...
## 5. Test end-to-end connectivity from your local environment to upstream services
