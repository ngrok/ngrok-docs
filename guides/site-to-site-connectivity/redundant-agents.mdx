---
title: Configure Automatic Failover with Redundant Agents
sidebarTitle: Configure Automatic Failover
description: Run multiple ngrok agents in a customer's network for high availability and automatic failover.
---
