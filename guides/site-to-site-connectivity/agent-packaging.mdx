...
Install the ngrok agent using your preferred package manager.

| Package manager | Platform | Command |
| --- | --- | --- |
| [Homebrew](https://brew.sh/) | macOS | `brew install ngrok` |
| [APT](https://download.ngrok.com/linux) | Linux (Debian/Ubuntu) | See the [Linux download page](https://download.ngrok.com/linux) |
| [Chocolatey](https://community.chocolatey.org/packages/ngrok) | Windows | `choco install ngrok` |
| [Snap](https://snapcraft.io/ngrok) | Linux | `snap install ngrok` |
