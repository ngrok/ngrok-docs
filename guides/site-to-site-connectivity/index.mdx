...
![Architecture diagram showing a SaaS Platform routing through ngrok Cloud Endpoints and Internal Agent Endpoints to an ngrok Agent in a remote clinic network serving an API and patient database](./img/site-to-site-connectivity-architecture.png)
...
![ngrok dashboard New Cloud Endpoint dialog with Public binding selected and URL set to https://api.acme.com](./img/new-cloud-endpoint-public-binding-dialog.png)
