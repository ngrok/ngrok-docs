...
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- | --------------------------------------- |
| `oauth`                            | [`set-vars`](/traffic-policy/actions/set-vars/), [`oauth`](/traffic-policy/actions/oauth), [`custom-response`](/traffic-policy/actions/custom-response) | [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request)   | Maps OAuth provider and settings.       |
| `oidc`                             | [`oidc`](/traffic-policy/actions/oidc)                                                                                                                            | [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request)   | Maps OpenID Connect settings.           |
| `ip_policy`                        | [`restrict-ips`](/traffic-policy/actions/restrict-ips)                                                                                                            | [`on_tcp_connect`](/traffic-policy/concepts/phases/#on_tcp_connect)     | Maps allowed IPs or policies.           |
| `mutual_tls` and `tls_termination` | [`terminate-tls`](/traffic-policy/actions/terminate-tls)                                                                                                          | [`on_tcp_connect`](/traffic-policy/concepts/phases/#on_tcp_connect)     | Maps mTLS and TLS termination settings. |
| `request_headers`                  | [`add-headers`](/traffic-policy/actions/add-headers), [`remove-headers`](/traffic-policy/actions/remove-headers)                                             | [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request)   | Modify request headers.                 |
| `response_headers`                 | [`add-headers`](/traffic-policy/actions/add-headers), [`remove-headers`](/traffic-policy/actions/remove-headers)                                             | [`on_http_response`](/traffic-policy/concepts/phases/#on_http_response) | Modify response headers.                |
| `compression`                      | [`compress-response`](/traffic-policy/actions/compress-response)                                                                                                  | [`on_http_response`](/traffic-policy/concepts/phases/#on_http_response) | Enable response compression.            |
| `webhook_validation`               | [`verify-webhook`](/traffic-policy/actions/verify-webhook)                                                                                                        | [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request)   | Validate webhook secrets.               |
| `circuit_breaker`                  | [`circuit-breaker`](/traffic-policy/actions/circuit-breaker)                                                                                                      | [`on_http_request`](/traffic-policy/concepts/phases/#on_http_request)   | Define circuit breaking thresholds.     |
