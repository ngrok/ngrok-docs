...
<Warning>These recommendations from ngrok's team do not constitute legal advice. Please consult your own legal and engineering teams to ensure HIPAA compliance.</Warning>
...
You are responsible for ensuring that PHI is only present within the packet payload. ngrok won't store this data in HIPAA workloads but does store other, non-PHI, data.
