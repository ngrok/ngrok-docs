...
<Tip>
  Certificates automatically provisioned from Let's Encrypt are securely
  managed, and their private keys are not accessible to the requester. This
  ensures the security and integrity of the certificate by preventing key
  exposure.
</Tip>
