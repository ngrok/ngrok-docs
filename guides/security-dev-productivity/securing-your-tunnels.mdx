...
You need an API key to authenticate with [the ngrok REST API](/api/). API keys are Base64 encoded strings that you can find [in the dashboard](https://dashboard.ngrok.com/get-started/your-authtoken) or from [an API endpoint](/api/resources/api-keys/#list-api-keys), which makes it easy to rotate your API keys.
