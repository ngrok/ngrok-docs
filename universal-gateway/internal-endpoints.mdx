...
A common practice is to use a [public](/universal-gateway/public-endpoints) [Cloud Endpoints](/universal-gateway/cloud-endpoints/) to manage a centralized Traffic Policy, then forward traffic to one or more internal [endpoints](/universal-gateway/endpoints/).
