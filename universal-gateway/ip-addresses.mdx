...
dedicated IPs for [Domains](/universal-gateway/dedicated-ips/). You may
also set up dedicated IPs for [Agent Connect
URLs](/agent/connect-url/#dedicated-ips).
...
Dedicated, static IPs for public endpoints are in Early Access. [Request access to the
