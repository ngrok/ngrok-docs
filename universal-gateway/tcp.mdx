...
import ProxyProtoAgentConfigExample from "/snippets/examples/agent-config/tcp-proxyproto.mdx";
...
<Info title="Free Plan Usage">TCP endpoints are only available on a free plan after [adding a valid payment method](https://dashboard.ngrok.com/settings#id-verification) to your account.</Info>
