...
<Columns cols={1}>
	...
	<Card title="Domains" href="/universal-gateway/domains/" horizontal>
		Create public endpoints with hostnames matching your domain and configure domain-level behaviors.
	</Card>
	<Card title="TCP Addresses" href="/universal-gateway/tcp-addresses/" horizontal>
		Create public TCP endpoints on a fixed hostname and port.
	</Card>
	<Card title="TLS Certificates" href="/universal-gateway/tls-certificates/" horizontal>
