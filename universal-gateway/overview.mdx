...
<Columns cols={1}>
	...
	<Card title="Pooling" href="/universal-gateway/endpoint-pooling/" horizontal>
		Load-balance traffic for scalability, failover, or to do blue/green and
		canary deployments.
	</Card>
	<Card
		title="Global Load Balancer"
		href="/universal-gateway/global-load-balancer/"
		horizontal
	>
		Choose which points of presence handle traffic to a domain's matching
		endpoints.
	</Card>
	<Card
		title="DDoS protection"
		href="/universal-gateway/ddos-protection/"
		horizontal
	>
		Protect your endpoints from DDoS attacks.
	</Card>
</Columns>
