...
2. Click the domain you wish to modify. Dev domains do not support this functionality.
3. Enter a comma-seperated list of PoPs, region aliases that covers multiple PoPs, or both.
