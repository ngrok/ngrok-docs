...
- [**Dedicated IP address configuration**](/universal-gateway/dedicated-ips/) - Attach static, dedicated IPs for a Domain's matching endpoints receive traffic on.
...
If you configure your Domain to use [dedicated IPs](/universal-gateway/dedicated-ips/), these
...
See the [Dedicated IPs](/universal-gateway/dedicated-ips/) documentation for detailed information on configuration, use cases, and pricing.
...
| Bring-your-own domains | Personal, Pro, Pay-as-you-go                                       |
