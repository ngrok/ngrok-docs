...
keywords: [load balancing, load balancer, traffic distribution, horizontal scaling, blue-green deployment, canary deployment]
---
...
## Endpoint Pooling as a load balancer
