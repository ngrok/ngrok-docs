...
<Note>
  Internal domains are [namespaced](#namespacing) to the accounts that create
  them. Even if another user has the same internal endpoint URL as you, your
  traffic will never flow to their endpoint.
</Note>
