...
sidebarTitle: Path-based Forwarding
...
For the purpose of this guide, we will create an ngrok HTTP domain.
...
## **Step 5** — Create an ngrok Cloud Endpoint

Now we can create an ngrok Cloud Endpoint that points to our
