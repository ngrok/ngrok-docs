...
You can create Cloud Endpoints as a public front door, and use Traffic Policy to orchestrate traffic to multiple internal endpoints. [See the guide for an example](/universal-gateway/cloud-endpoints/forwarding-and-load-balancing).
