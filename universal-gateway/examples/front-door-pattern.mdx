...
It creates a clear boundary between your public-facing gateway and your internal services and creates a consistent interface for exposing them to the public internet.
