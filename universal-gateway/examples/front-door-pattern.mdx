...
- Host any number of services under a single hostname (e.g. `your-company.com`) by routing via path, subdomain, headers, or any other [Traffic Policy variable](/traffic-policy/variables).
