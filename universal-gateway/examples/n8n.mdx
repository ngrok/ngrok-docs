...
It's worth reading the logs that your containers output while starting up; you'll see an error message if there's anything wrong with your ngrok configuration.
