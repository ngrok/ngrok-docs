...
<Tip>This example is focused on securing your Minecraft server using Traffic Policy. For more general instructions on using ngrok with Minecraft, including limitations of our [free plan](/pricing-limits/free-plan-limits/) and troubleshooting common issues, see our [using ngrok with Minecraft](/using-ngrok-with/minecraft/) guide.</Tip>
