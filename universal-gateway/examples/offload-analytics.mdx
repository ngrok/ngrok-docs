...
- Explore our other examples of using the [`http-request`](/traffic-policy/actions/http-request/#examples) and [`forward-internal`](/traffic-policy/actions/forward-internal/#examples) Traffic Policy actions.
- View your traffic in [Traffic Inspector](https://dashboard.ngrok.com/traffic-inspector).
- Add even more logging flexibility, plus access to our entire [eventing system](/obs/), with the [`logs` action](/traffic-policy/actions/log/).
