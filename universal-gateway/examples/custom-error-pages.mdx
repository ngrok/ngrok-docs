...
With ngrok’s Traffic Policy engine, you can define exactly what your users see when your upstream service fails.
This example walks you through how to route requests to your internal service, and then fall back to a branded error page if that service is unavailable.
