...
- Explore our other examples of using the [`forward-internal`](/traffic-policy/actions/forward-internal/#examples) and [`deny`](/traffic-policy/actions/deny/#examples-on_http_request).
