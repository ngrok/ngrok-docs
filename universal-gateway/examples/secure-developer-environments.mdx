...
They can also use one of our [SDKs](/agent-sdks) or the [Kubernetes Operator](/k8s).
...
- Read our [best practices for developer productivity](/guides/security-dev-productivity/) guide for ways to improve this example with developer-specific authtokens and custom connect URLs.
