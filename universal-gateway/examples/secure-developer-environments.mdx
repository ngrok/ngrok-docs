...
Navigate to the [**Domains** section](https://dashboard.ngrok.com/domains) of the ngrok dashboard and click **New +** to reserve a domain with a wildcard pattern (see [custom domains](/universal-gateway/custom-domains/)) like `*.devtest.example.com`.
