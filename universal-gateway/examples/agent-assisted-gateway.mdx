...
Start [Agent Endpoints](/universal-gateway/agent-endpoints/) for your local development services using internal URLs.
Replace `$PORT` with your actual service ports.
...
<Tip>Consider using a subdomain like `dev.yourcompany.com` or `staging.yourproject.com` to clearly distinguish from production.</Tip>
