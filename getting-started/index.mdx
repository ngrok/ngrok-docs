...
<Note>
  All accounts come with a free dev domain that is automatically chosen when you start an endpoint.
  You can add the optional `--url` flag to customize this domain on paid plans.
</Note>
