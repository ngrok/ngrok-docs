...
<Note>
This doc assumes you've already completed the [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/)—if not, you should start there to learn about some of ngrok's fundamental features before continuing here.
</Note>
...
- See [the Cloud Endpoints overview](/endpoints/cloud-endpoints/#use-cases) to learn more about use cases, how they compare to Agent Endpoints, and more.
...
- See [Load Balancing with Cloud Endpoints](/endpoints/cloud-endpoints/forwarding-and-load-balancing/) to learn how to distribute traffic across multiple internal endpoints.
