...
<Note>  This doc assumes you've already completed the [Agent CLI Quickstart](/getting-started/)—if not, you should start there to learn about some of ngrok's fundamental features before continuing here.
</Note>
...
<Info>  Traffic policies are optional for Agent Endpoints but required for Cloud Endpoints, which is why the dashboard generates one for you automatically.
</Info>
