...
Put it to work forwarding traffic to an app running on your local device.
...
Now that you're familiar with the key concepts necessary to work with Cloud Endpoints, create another one using the ngrok API, which you can access via the Agent CLI.
