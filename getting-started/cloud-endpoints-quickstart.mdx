...
<Note>
This doc assumes you've already completed the [Agent CLI Quickstart](/gateway/endpoints/agent-cli-quickstart/)—if not, you should start there to learn about some of ngrok's fundamental features before continuing here.
</Note>
...
<Steps titleSize="h3">
  <Step titleSize="h3" title="Install the ngrok Agent CLI">
...
<Steps titleSize="h3">
  ...
  <Step title="Create your Cloud Endpoint in the dashboard">
    ...
    This takes you to a page where you can manage your new endpoint's [Traffic Policy](/gateway/traffic-policy/).
...
<Steps titleSize="h3">
  <Step title="Start your Agent endpoint">
  ...
  <Step title="Test your Cloud Endpoint">
...
<Steps titleSize="h3">
  <Step title="Create your Traffic Policy">
  ...
  <Step title="Create your Cloud Endpoint">
...
- See [the Cloud Endpoints overview](/gateway/endpoints/cloud-endpoints/#use-cases) to learn more about use cases, how they compare to Agent Endpoints, and more.
...
- See [Load Balancing with Cloud Endpoints](/gateway/endpoints/cloud-endpoints/forwarding-and-load-balancing/) to learn how to distribute traffic across multiple internal endpoints.
- This quickstart barely scratches the surface of what's possible with a Traffic Policy—check out the [Actions overview](/gateway/traffic-policy/actions/) to see what else you can do.
