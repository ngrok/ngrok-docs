...
import K8sPrereq from "/snippets/k8s/_prereq.mdx"; import K8sSetup from "/snippets/k8s/_setup.mdx"; import K8sGWAPI from "/snippets/k8s/_gateway-api.mdx"; import K8sInstall from "/snippets/k8s/_install.mdx"; import Domain from "/snippets/k8s/_domain.mdx"; import K8sSample from "/snippets/k8s/_sample.mdx"; import Request from "/snippets/k8s/_request.mdx";
