...
Find more details on our [pricing page](https://ngrok.com/pricing), or, if you're a free user, the [free plan limits](/pricing-limits/free-plan-limits/).
</Note>
...
- All our [available actions](/traffic-policy/actions/), including a few most relevant to these types of endpoints:
