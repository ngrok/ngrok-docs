If you don't already have an app to try out, try out this sample manifest, which installs the [TinyLlama image](https://github.com/ngrok-samples/tinyllama) onto your cluster.
