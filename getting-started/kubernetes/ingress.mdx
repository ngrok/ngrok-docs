...
description: Learn how to get started with the ngrok Kubernetes Operator to create secure tunnels from your Kubernetes clusters to the internet.
---
...
<Steps>
  ...
  <Step title="Create your Ingress manifest">
...
You can also choose to add it as the backend for a specific rule or the default backend.
See the [Ingresses doc](/gateway/k8s/guides/using-ingresses/#using-ngroktrafficpolicy-with-ingress) for details and why you would choose one option over another.
...
- Read the [guide to using Ingress](/gateway/k8s/guides/using-ingresses) with ngrok
