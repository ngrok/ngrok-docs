...
<Info>
	...
	collection](https://github.com/ngrok-samples/javascript-quickstart). In that
	case, you'll just need to reserve a domain and add your auth token as
	described below to get started.
</Info>
