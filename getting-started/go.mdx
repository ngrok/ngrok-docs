...
sidebarTitle: Go
description: Learn how to get started with the ngrok Go SDK to create secure tunnels from your Go applications to the internet.
---
...
4. Create a `.env` file with NGROK_AUTHTOKEN and NGROK_DOMAIN — ask me for these values
...
You can think of it as the [ngrok Agent CLI](/gateway/endpoints/agent-cli-quickstart/) packaged as a Go library.
