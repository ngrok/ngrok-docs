...
If you're currently using the bot user endpoint, you should switch to the service user endpoint instead.

See the [service users API reference](/api/resources/service-users/).
</Warning>
