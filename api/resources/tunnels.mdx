...
import TunnelsListRequest from "/snippets/api/resources/examples/_tunnels_list_request.mdx";
import TunnelsListResponse from "/snippets/api/resources/examples/_tunnels_list_response.mdx";
import TunnelsGetRequest from "/snippets/api/resources/examples/_tunnels_get_request.mdx";
import TunnelsGetResponse from "/snippets/api/resources/examples/_tunnels_get_response.mdx";
