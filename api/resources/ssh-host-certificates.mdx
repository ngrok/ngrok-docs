---
title: SSH Host Certificates
---

import SSHHostCertificatesCreateRequest from "/snippets/api/resources/examples/_ssh_host_certificates_create_request.mdx";
import SSHHostCertificatesCreateResponse from "/snippets/api/resources/examples/_ssh_host_certificates_create_response.mdx";
import SSHHostCertificatesDeleteRequest from "/snippets/api/resources/examples/_ssh_host_certificates_delete_request.mdx";
import SSHHostCertificatesDeleteResponse from "/snippets/api/resources/examples/_ssh_host_certificates_delete_response.mdx";
import SSHHostCertificatesGetRequest from "/snippets/api/resources/examples/_ssh_host_certificates_get_request.mdx";
import SSHHostCertificatesGetResponse from "/snippets/api/resources/examples/_ssh_host_certificates_get_response.mdx";
import SSHHostCertificatesListRequest from "/snippets/api/resources/examples/_ssh_host_certificates_list_request.mdx";
import SSHHostCertificatesListResponse from "/snippets/api/resources/examples/_ssh_host_certificates_list_response.mdx";
import SSHHostCertificatesUpdateRequest from "/snippets/api/resources/examples/_ssh_host_certificates_update_request.mdx";
import SSHHostCertificatesUpdateResponse from "/snippets/api/resources/examples/_ssh_host_certificates_update_response.mdx";
