---
title: Edges HTTPS Routes
sidebarTitle: HTTPS Routes
---

import EdgesHTTPSRoutesCreateRequest from "/snippets/api/resources/examples/_edges_https_routes_create_request.mdx";
import EdgesHTTPSRoutesCreateResponse from "/snippets/api/resources/examples/_edges_https_routes_create_response.mdx";
import EdgesHTTPSRoutesGetRequest from "/snippets/api/resources/examples/_edges_https_routes_get_request.mdx";
import EdgesHTTPSRoutesGetResponse from "/snippets/api/resources/examples/_edges_https_routes_get_response.mdx";
import EdgesHTTPSRoutesUpdateRequest from "/snippets/api/resources/examples/_edges_https_routes_update_request.mdx";
import EdgesHTTPSRoutesUpdateResponse from "/snippets/api/resources/examples/_edges_https_routes_update_response.mdx";
import EdgesHTTPSRoutesDeleteRequest from "/snippets/api/resources/examples/_edges_https_routes_delete_request.mdx";
import EdgesHTTPSRoutesDeleteResponse from "/snippets/api/resources/examples/_edges_https_routes_delete_response.mdx";
...
| `scopes`          | List&lt;string&gt; | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both `client_id` and `client_secret` to set scopes)                                                                                  |
...
| `teams`           | List&lt;string&gt; | a list of github teams identifiers. users will be allowed access to the endpoint if they are a member of any of these teams. identifiers should be in the 'slug' format qualified with the org name, for example, `org-name/team-name`                                                                                                 |
...
| `allow_idp_initiated` | boolean            | If true, the IdP may initiate a login directly (for example, the user does not need to visit the endpoint first and then be redirected). The IdP should set the `RelayState` parameter to the target URL of the resource they want the user to be redirected to after the SAML login assertion has been processed. |
