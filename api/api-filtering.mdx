...
| **Application Users**           | - `id`<br />- `created_at`<br />- `provider_user_id`<br />- `username`<br />- `email`<br />- `name`<br />- `last_active`<br />- `last_login`                                                               |
| **Application Sessions**        | - `id`<br />- `created_at`<br />- `public_url`<br />- `last_active`<br />- `expires_at`<br />- `application_user_id`                                                                                       |
