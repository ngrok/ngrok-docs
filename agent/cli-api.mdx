...
|  `--url` | The URL of the endpoint to create. the url of the endpoint |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
|  `--filter` |  |
|  `--id` | Filter results by endpoint IDs. |
...
|  `--url` | Filter results by endpoint URLs. |
|  `--api-key` | API key to use |
|  `--config` | path to config files; they are merged if multiple |
|  `--log` | path to log file, 'stdout', 'stderr' or 'false' |
|  `--log-format` | log record format: 'term', 'logfmt', 'json' |
...
|  `--ips` | The region-pinned targets of the reserved domain in JSON format |
