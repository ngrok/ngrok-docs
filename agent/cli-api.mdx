...
| --------------- | ---------------------------------------------------------------------- |
| `--description` | human-readable description of this backend. Optional                   |
| `--labels`      | labels to watch for tunnels on, for example, app->foo, dc->bar         |
| `--metadata`    | arbitrary user-defined machine-readable data of this backend. Optional |
| `--api-key`     | API key to use                                                         |
| `--config`      | path to config files; they are merged if multiple                      |
| `--log`         | path to log file, 'stdout', 'stderr' or 'false'                        |
...
| `--module.provider.facebook.scopes`           | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| `--module.provider.github.scopes`             | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
| `--module.provider.github.teams`              | a list of github teams identifiers. users will be allowed access to the endpoint if they are a member of any of these teams. identifiers should be in the 'slug' format qualified with the org name, for example, org-name/team-name                                                                                                     |
...
| `--module.provider.google.scopes`             | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| `--module.provider.microsoft.scopes`          | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| Flag                           | Description                                                                                                                                                                                                                                                                                                      |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `--module.allow-idp-initiated` | If true, the IdP may initiate a login directly (for example, the user does not need to visit the endpoint first and then be redirected). The IdP should set the RelayState parameter to the target URL of the resource they want the user to be redirected to after the SAML login assertion has been processed. |
...
| `--oauth.provider.facebook.scopes`             | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| `--oauth.provider.github.scopes`               | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
| `--oauth.provider.github.teams`                | a list of github teams identifiers. users will be allowed access to the endpoint if they are a member of any of these teams. identifiers should be in the 'slug' format qualified with the org name, for example, org-name/team-name                                                                                                     |
...
| `--oauth.provider.google.scopes`               | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| `--oauth.provider.microsoft.scopes`            | a list of provider-specific OAuth scopes with the permissions your OAuth app would like to ask for. these may not be set if you are using the ngrok-managed oauth app (that is, you must pass both client_id and client_secret to set scopes)                                                                                            |
...
| `--saml.allow-idp-initiated`                   | If true, the IdP may initiate a login directly (for example, the user does not need to visit the endpoint first and then be redirected). The IdP should set the RelayState parameter to the target URL of the resource they want the user to be redirected to after the SAML login assertion has been processed.                         |
