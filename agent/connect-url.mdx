...
![ngrok dashboard New Connect URL dialog with Domain, Description, and Certificate Issuer fields](/img/docs/new-connect-url-dialog.png)
...
![ngrok dashboard certificate provisioning delayed warning banner with a link to contact support](/img/docs/certificate-provisioning-delayed-banner.png)
