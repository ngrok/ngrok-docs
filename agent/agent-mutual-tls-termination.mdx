...
Although ngrok can [automatically provision your certificates](/universal-gateway/tls-certificates) when you use standard TLS, you'll have to provide your own TLS certificate authority (CA) for mTLS.
...
<Note>Most organizations have their own certificate management infrastructure, so this step is optional if you already have a CA and client certificates to work with.</Note>
