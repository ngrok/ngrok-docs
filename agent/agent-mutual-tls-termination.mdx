...
![Diagram showing the 7-step mutual TLS handshake between a client and the ngrok agent, including certificate exchange and verification](./img/agent-mutual-tls-handshake-diagram.png)
