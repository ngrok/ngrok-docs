...
<Note>  Most organizations have their own certificate management infrastructure, so this step is optional if you already have a CA and client certificates to work with.
</Note>
