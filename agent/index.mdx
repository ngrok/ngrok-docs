...
[`dns_resolver_ips`](/agent/config/v3/#dns-resolver_ips) configuration option.
...
[inspection in the configuration file](/agent/config/v3/#inspect-db_size).
...
start and stop endpoints on the agent while it is running. Consult the
