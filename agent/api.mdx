...
If you need to programmatically control the ngrok agent, consider using one of the more flexible and powerful [Agent SDKs](/agent-sdks/) instead of the API.
...
201 status code with a response body describing the started tunnel. 
...
200 status code with a JSON response containing an array of endpoint objects.
...
200 status code with endpoint JSON for success.
