...
| | | | -------------- | --------------------------- | | Base URL | `http://127.0.0.1:4040/api` | | Authentication | **None** |
...
<Warning>
  ...
  Use the [list endpoints API](#list-endpoints) instead.
</Warning>
...
| | | | --------- | ------------------------------------------------------------------------------------------------------------------------------- | | `tunnels` | List of all running tunnels.
See the [Tunnel detail](#tunnel-detail) resource for docs on the parameters of each tunnel object. |
...
| | | | ------------- | ----------------------------------------------- | | `limit` | Maximum number of requests to return. | | `tunnel_name` | Filter requests only for the given tunnel name. |
...
See the [Captured Request Detail](#captured-request-detail) resource for docs on the request objects. |
...
| | | | ------------- | --------------------------------------------------------------------------------------------------------------------------------- | | `id` | ID of request to replay. | | `tunnel_name` | Name of the tunnel to play the request against.
If unspecified, the request is played against the same tunnel it was recorded on. |
