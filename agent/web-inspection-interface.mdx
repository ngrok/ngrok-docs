...
![ngrok agent web inspection interface showing HTTP request and response detail with Summary, Headers, Raw, and Binary tabs](/img/docs/web-inspection-request-detail.png)
...
![ngrok web inspection interface showing a JSON syntax error with the problematic key highlighted in orange](/img/docs/web-inspection-json-syntax-error.png)
...
![ngrok web inspection interface filter dropdown showing options including Path, ResponseSize, and StatusCode](/img/docs/web-inspection-filter-dropdown.png)
...
![ngrok web inspection interface showing filtered requests matching path and status code filters with one result](/img/docs/web-inspection-filtered-requests.png)
...
![ngrok web inspection interface showing a captured request with the Replay button in the top right corner](/img/docs/web-inspection-replay-button.png)
...
![ngrok web inspection interface showing the Replay button dropdown with the Replay with Modifications option](/img/docs/web-inspection-replay-with-modifications-dropdown.png)
...
![ngrok web inspection Modify Request dialog showing editable method, path, headers, and body fields](/img/docs/web-inspection-modify-request-dialog.png)
...
![ngrok agent status page showing Configuration section with tunnel URLs, addresses, and global settings](/img/docs/agent-status-configuration-page.png)
...
![ngrok agent status page showing Metrics section with connection counts, connection duration percentiles, and HTTP request rates](/img/docs/agent-status-metrics-page.png)
