...
- Added support for the [Datadog event destination](/integrations/event-destinations/datadog-event-destination.mdx) in `ngrok api`
...
For more information about upgrading from previous versions of the agent to v3.0, see our [upgrade guide](/agent/upgrade-v2-v3/).
