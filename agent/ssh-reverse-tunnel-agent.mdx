...
- You can't [forward to upstream https services](/gateway/http/#https-forwarding)
- You can't create multiple endpoints over the same connection
- You can't [serve file system directories](/gateway/http/#serving-file-directories) with the `file://` protocol
- You can't terminate TLS at the agent when using [end-to-end encryption](/gateway/tls-termination/#end-to-end-encryption)
