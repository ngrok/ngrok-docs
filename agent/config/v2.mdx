...
| [`policy.inbound.expressions`](/traffic-policy/how-it-works#expressions)                  | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
...
| [`policy.outbound.expressions`](/traffic-policy/how-it-works#expressions)                 | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                            |
...
| [`traffic_policy.on_http_request.expressions`](/traffic-policy/how-it-works#expressions)  | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_request` policy rule applies to                                                                                                                                                              |
...
| [`traffic_policy.on_http_response.expressions`](/traffic-policy/how-it-works#expressions) | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_response` policy rule applies to                                                                                                                                                             |
...
| [`traffic_policy.outbound.expressions`](/traffic-policy/how-it-works#expressions) | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the outbound policy rule applies to                                                                                                   |
