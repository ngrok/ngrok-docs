...
| `oauth.provider`                                                                       | String                                                                       | enforce authentication OAuth2 provider on the endpoint, for example, 'google'. For a lit of available providers, see [OAuth2 providers](/traffic-policy/actions/oauth/#supported-providers).                                                                                                            |
| [`policy.inbound.name`](/traffic-policy/)                                              | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.inbound.expressions`](/traffic-policy/concepts/expressions/)                  | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.inbound.actions.type`](/traffic-policy/actions/)                              | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.inbound.actions.config`](/traffic-policy/actions/)                            | custom                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.outbound.name`](/traffic-policy/)                                             | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.outbound.expressions`](/traffic-policy/concepts/expressions/)                 | Array of Strings                                                             | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
| [`policy.outbound.actions.type`](/traffic-policy/actions/)                             | String                                                                       | `policy` has been renamed to `traffic_policy` in agent version 3.14.0.                                                                                                                                                                                                                                  |
...
| [`traffic_policy.on_http_request.name`](/traffic-policy/)                              | String                                                                       | The name of an `on_http_request` rule that is part of a Traffic Policy                                                                                                                                                                                                                                  |
| [`traffic_policy.on_http_request.expressions`](/traffic-policy/concepts/expressions/)  | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_request` policy rule applies to                                                                                                                                                                    |
| [`traffic_policy.on_http_request.actions.type`](/traffic-policy/actions/)              | String                                                                       | The type of action that should be executed when this `on_http_request` policy rule is activated                                                                                                                                                                                                         |
| [`traffic_policy.on_http_request.actions.config`](/traffic-policy/actions/)            | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                                    |
| [`traffic_policy.on_http_response.name`](/traffic-policy/)                             | String                                                                       | The name of an `on_http_response` rule that is part of a Traffic Policy                                                                                                                                                                                                                                 |
| [`traffic_policy.on_http_response.expressions`](/traffic-policy/concepts/expressions/) | Array of Strings                                                             | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the `on_http_response` policy rule applies to                                                                                                                                                                   |
| [`traffic_policy.on_http_response.actions.type`](/traffic-policy/actions/)             | String                                                                       | The type of action that should be executed when this `on_http_response` policy rule is activated                                                                                                                                                                                                        |
| [`traffic_policy.on_http_response.actions.config`](/traffic-policy/actions/)           | custom                                                                       | The configuration required for the specific type of action specified                                                                                                                                                                                                                                    |
...
| `verify_webhook.provider`                                                              | String                                                                       | Verify webhooks are signed by this provider, for example, 'slack'. For a full list of providers, see [Webhook Verification Providers](/traffic-policy/actions/verify-webhook/#supported-providers).                                                                                                     |
...
| [`traffic_policy.inbound.expressions`](/traffic-policy/concepts/expressions/)  | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the inbound policy rule applies to                                                                                                    |
...
| [`traffic_policy.inbound.actions.config`](/traffic-policy/actions/)            | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
| [`traffic_policy.outbound.name`](/traffic-policy/)                             | String                         | The name of an outbound rule that is part of a Traffic Policy                                                                                                                                                                 |
| [`traffic_policy.outbound.expressions`](/traffic-policy/concepts/expressions/) | Array of Strings               | Expressions written using [CEL](https://github.com/google/cel-spec) that filter traffic the outbound policy rule applies to                                                                                                   |
| [`traffic_policy.outbound.actions.type`](/traffic-policy/actions/)             | String                         | The type of action that should be executed when this outbound policy rule is activated                                                                                                                                        |
| [`traffic_policy.outbound.actions.config`](/traffic-policy/actions/)           | custom                         | The configuration required for the specific type of action specified                                                                                                                                                          |
