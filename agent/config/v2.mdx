...
| `oauth.provider`                                                                       | String                                                                       | enforce authentication OAuth2 provider on the endpoint, e.g. 'google'. For a lit of available providers, see [OAuth2 providers](/traffic-policy/actions/oauth/#supported-providers).                                                                                                              |
...
| `verify_webhook.provider`                                                              | String                                                                       | Verify webhooks are signed by this provider, e.g. 'slack'. For a full list of providers, see [Webhook Verification Providers](/traffic-policy/actions/verify-webhook/#supported-providers).                                                                                                       |
