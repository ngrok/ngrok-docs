...
The allowed values are `internal`, `public`, and `kubernetes` which allow you to create [public](/endpoints/public-endpoints/), [internal](/endpoints/internal-endpoints/), and [kubernetes endpoints](/endpoints/kubernetes-endpoints/).
