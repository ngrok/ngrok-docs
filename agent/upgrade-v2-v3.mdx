...
Before upgrading, we highly encourage you to make sure you have the latest version of the ngrok agent. If you don't, please [update to the latest version](/agent/cli#ngrok-update) before proceeding.
...
Before proceeding, please ensure that you've already [updated to the latest version](/agent/cli#ngrok-update) of the ngrok agent.

=======
>>>>>>> 3516e1544 (changing to h2)
### Configuration file
