...
If you don't, please [update to the latest version](/agent/cli#ngrok-update) before proceeding.
...
Check out the [full list of supported regions](/universal-gateway/points-of-presence/).
...
$ ngrok config upgrade -h
  ...
  DESCRIPTION: Upgrade a configuration file to a version.
  The default configuration file is located at /home/ubuntu/.config/ngrok/ngrok.yml
...
Run `ngrok -h` for help or check out the [ngrok agent reference documentation](/agent/cli/).