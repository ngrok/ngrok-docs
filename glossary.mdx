...
A tunnel is a secure, persistent connection between your local environment (or any network) and ngrok's global cloud service that enables traffic to flow from ngrok's public endpoints to your applications without requiring public IP addresses or open firewall ports.
