...
If you want to change the [matching domain](/domains/) for your active Cloud Endpoint without any downtime to your services, you can use the [ngrok API](/api/) to update its values instead of deleting and recreating the endpoint in the dashboard.
...
<Steps>
  ...
  <Step title="Get the ID of the endpoint you want to modify">
  ...
  <Step title="Update the endpoint with the new domain">
  ...
  <Step title="Test your new endpoint URL">
