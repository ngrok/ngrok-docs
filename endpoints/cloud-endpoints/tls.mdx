...
To learn more about terminating TLS at the agent, see the [Agent Endpoint TLS documentation](/endpoints/tls#termination).
...
When performing [end-to-end encryption](/domains/tls-termination/#end-to-end-encryption) by terminating at the upstream service, you become responsible for provisioning, managing, and distributing certificates.
