...
- [Forwarding Traffic to and Load Balancing Internal Endpoints with Cloud Endpoints](/endpoints/cloud-endpoints/forwarding-and-load-balancing/)
- [Path-based Routing and Policy Decentralization with Cloud Endpoints](/endpoints/cloud-endpoints/routing-and-policy-decentralization)
...
Cloud endpoints are available on the pay-as-you-go plan. Consult the [Endpoints Pricing](/endpoints/#pricing) documentation for billing details.
