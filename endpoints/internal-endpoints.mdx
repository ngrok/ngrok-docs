...
A common practice is to use a [public](/endpoints/public-endpoints) [Cloud Endpoints](/endpoints/cloud-endpoints/) to manage a centralized Traffic Policy, then forward traffic to one or more internal [endpoints](/endpoints/). See [the guide on using Cloud Endpoints with internal endpoints](/endpoints/cloud-endpoints/forwarding-and-load-balancing//) to learn more.
