...
<Note>
  For more details, see [Don Simpson's blog post about using ngrok with
  CGNAT](https://www.donaldsimpson.co.uk/using-ngrok-to-work-around-carrier-grade-nat-cgnat).
</Note>
