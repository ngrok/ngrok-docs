...
Before tunneling, enable authentication (`requirepass` or ACL users in Redis 6+), use a strong secret, and consider combining the tunnel with [IP restrictions](/gateway/traffic-policy/concepts/ip-policies/) or other access controls on your endpoint.
For long-lived or production-style access, prefer [site-to-site connectivity](/gateway/site-to-site-connectivity/) patterns.
...
- [TCP endpoints](/gateway/endpoints/tcp/)
- [Configure site-to-site connectivity for databases](/gateway/site-to-site-connectivity/)
