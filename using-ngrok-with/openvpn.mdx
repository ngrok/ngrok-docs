...
For a detailed community walkthrough, see [Tunneling openvpn server out from behind cgnat](https://forums.openvpn.net/viewtopic.php?t=30787) on the OpenVPN forums.
