...
<Note>For users on the latest MacOS, there is an issue where the default port 5000 (and 7000) is used by Apple AirPlay Receiver. You can use a different port for your Flask app or disable the Apple AirPlay receiver by disabling it in **System Settings > General > AirDrop & Handoff > AirPlay Receiver**.</Note>
