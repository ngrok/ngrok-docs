...
- The ngrok agent installed directly on the machine (VM, server, or container) running your local MCP server.
See the [downloads page](https://ngrok.com/downloads/) for installation instructions.
