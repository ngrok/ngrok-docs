...
Feedback is welcome!
Sign up for early access to [ngrok's AI Gateway](https://ngrok.ai) and the team will reach out to learn more about your needs.
</Tip>
...
Copy the HTTPS forwarding URL (for example, `https://abc123.ngrok.io`) which will be used in the next step.
...
Limit access to your MCP server only to Claude by only allowing the Anthropic IPs.
