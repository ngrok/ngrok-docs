...
<Steps>
  ...
  <Step title="Create a public Cloud Endpoint">
    [Cloud Endpoints](../endpoints/cloud-endpoints/) are persistent, always-on endpoints whose creation, deletion and configuration is managed centrally via the Dashboard or API.
