...
You need [Docker Desktop](https://docs.docker.com/desktop/) installed first. Once it's running, [add the ngrok extension to Docker Desktop](https://open.docker.com/extensions/marketplace?extensionId=ngrok/ngrok-docker-extension).
...
3. Optionally specify a custom URL and [Traffic Policy](/gateway/traffic-policy/).
