...
[Cloud Endpoints](/network-edge/cloud-endpoints/) can now be created and managed by the operator via a new `CloudEndpoint` CRD.
...
- Support for [Traffic Policies](/traffic-policy/) [#334](https://github.com/ngrok/ngrok-operator/pull/334)
