...
<Note>
  For information on how wildcard endpoints are billed, including endpoint hours
  and Traffic Policy charges when forwarding to internal endpoints, see the
  [wildcard endpoints pricing
  documentation](/pricing-limits/#wildcard-endpoints).
</Note>
