...
<Note>
Free plans include HTTPS endpoints with automatic TLS certificates and encryption. The **TLS endpoints** row above refers to [raw TLS endpoints](/endpoints/tls/) that you terminate yourself, which require a paid plan.
</Note>
