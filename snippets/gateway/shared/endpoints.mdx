...
An endpoint's [binding](/gateway/bindings) defines _where traffic originates_:
...
To learn more, follow ngrok's [Agent CLI Quickstart](/gateway/agent-cli-quickstart/).
