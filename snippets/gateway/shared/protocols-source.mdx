...
- [HTTP/S Endpoints](/gateway/endpoints/http) - `http`, `https`
- [TCP Endpoints](/gateway/endpoints/tcp) - `tcp`
- [TLS Endpoints](/gateway/endpoints/tls) - `tls`
...
Learn more about in the [Endpoints documentation](/endpoints).
