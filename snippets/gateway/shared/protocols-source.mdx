...
- [HTTP/S Endpoints](/gateway/http) - `http`, `https`
- [TCP Endpoints](/gateway/tcp) - `tcp`
- [TLS Endpoints](/gateway/tls) - `tls`
...
Learn more about in the [Endpoints documentation](/gateway/endpoints).
