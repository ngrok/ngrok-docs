...
- Use either a [Domain](/domains/) or [TCP Address](/domains/tcp-addresses/)
- Use the `public` [binding](/endpoints/bindings/)
...
Follow the [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/) to set up an ngrok account and create your first public endpoint.
...
- The hostname must match a [Domain](/domains/) in your account.
...
- The hostname and port must match the address of a [TCP
  Address](/domains/tcp-addresses) in your account.
