...
[binding](/gateway/endpoints/bindings). Consult the
following documentation for details on valid URLs for TCP endpoints:

- [Public Endpoint URLs](/gateway/endpoints/public-endpoints/#urls)
- [Internal Endpoint URLs](/gateway/endpoints/internal-endpoints/#urls)
- [Kubernetes Endpoint URLs](/gateway/endpoints/kubernetes-endpoints/#urls)
...
[Domain](/domains) on your account. Domains help you set up
...
Domains](/domains#ngrok-managed-domains) to your endpoint.
...
Attach [Traffic Policy](/gateway/traffic-policy/) to endpoints to route, authenticate and transform the traffic through the endpoint.
...
- [Basic Auth](/gateway/traffic-policy/actions/basic-auth)
- [OAuth](/gateway/traffic-policy/actions/oauth)
- [IP Restriction](/gateway/traffic-policy/actions/restrict-ips/)
- [Webhook Verification](/gateway/traffic-policy/actions/verify-webhook/)
- [JWT](/gateway/traffic-policy/actions/jwt-validation/)
- [Mutual TLS](/gateway/traffic-policy/actions/terminate-tls/)
- [OpenID Connect](/gateway/traffic-policy/actions/oidc/)
- [SAML](/gateway/traffic-policy/actions/saml/)

### Basic auth example

Adds a username and password with the [Basic
Auth](/gateway/traffic-policy/actions/basic-auth) Traffic Policy action.
...
[OAuth](/gateway/traffic-policy/actions/oauth) Traffic Policy action.
...
the [`add-headers`](/gateway/traffic-policy/actions/add-headers) Traffic Policy action.
Adding the `Host` header [is a special
case](/gateway/traffic-policy/actions/add-headers/#special-cases) that replaces the existing
...
The [ngrok agent](/gateway/agent/) and [Agent
...
`upstream-tls-verify-cas`](/gateway/agent/cli/#ngrok-http).
...
| ------------------- | --------------------------------- | ----------------------------------------- |
| Agent               | `--upstream-protocol`             | [Agent CLI flags](/gateway/agent/cli/#ngrok-http) |
...
[Domain](/domains) with automated certificate management
...
application, use a [TLS Endpoint](/gateway/endpoints/tls) instead.
...
- [TLS Certificates](/gateway/domains/tls-certificates)
- [TLS Termination](/gateway/domains/tls-termination)
...
Headers](/gateway/traffic-policy/actions/remove-headers/) Traffic Policy action.
...
Pricing](/pricing-limits/#endpoint-limits) documentation for
billing details.
