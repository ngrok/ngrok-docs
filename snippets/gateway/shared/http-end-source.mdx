...
[binding](/endpoints/bindings). Consult the
following documentation for details on valid URLs for TCP endpoints:

- [Public Endpoint URLs](/endpoints/public-endpoints/#urls)
- [Internal Endpoint URLs](/endpoints/internal-endpoints/#urls)
- [Kubernetes Endpoint URLs](/endpoints/kubernetes-endpoints/#urls)
...
a DNS CNAME record](/domains/#branded-domains). Then
...
matching a wildcard pattern like `*.example.com`. To create a public wildcard endpoint, you must first reserve a [wildcard domain](/domains/#wildcard-domains).
...
application, use a [TLS Endpoint](/endpoints/tls) instead.
...
- [TLS Certificates](/domains/tls-certificates)
- [TLS Termination](/domains/tls-termination)
...
Pricing](/endpoints/#pricing) documentation for
billing details.

See [Domains pricing](/domains/#pricing) for details on
