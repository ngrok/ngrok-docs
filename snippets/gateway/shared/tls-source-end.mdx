...
See [TLS Termination at the Agent for End-to-End Encryption](/gateway/tls-termination#end-to-end-encryption) for additional details.
...
When performing [end-to-end encryption](/gateway/tls-termination/#end-to-end-encryption) by terminating at the agent or upstream service, you become responsible for provisioning, managing, and distributing certificates.
