...
<img
  src="../img/docs/region_pinning_diagram_how_it_works.png" alt="Region Pinning diagram -- how it works" style={{ height: "auto", width: "50%" }} />
...
You can "un-pin" a domain. Removing Regional Resolution settings restores the domain to its _default_ IP resolution behavior: [global load balancing](https://ngrok.com/docs/universal-gateway/global-load-balancer) across _all_ ngrok points of presence.
...
When a domain uses dedicated IPs, you can create matching [endpoints](https://dashboard.ngrok.com/endpoints) on any inbound port. Today, you are [restricted](https://ngrok.com/docs/faq#can-i-choose-a-different-port-to-receive-traffic-on-my-ngrok-domains) to ports 80 and 443.
