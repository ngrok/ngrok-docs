...
<Info>
The same configuration will soon support [dedicated IP addresses](/gateway/domains/dedicated-ips/) [preview feature], in addition to Points of Presence.
</Info>
...
You can specify a list of ngrok physical PoPs (like "Frankfurt" or "California"), [dedicated IPs](/gateway/domains/dedicated-ips/), or both.
...
See the [Dedicated IPs](/gateway/domains/dedicated-ips/) documentation for configuration examples, use cases, and pricing:
...
- Dedicated IPs: yes, dedicated IPs are available for any [ngrok-supported protocol](/gateway/endpoints/protocols), including HTTP/S, TCP, and TLS.
