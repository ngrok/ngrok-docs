...
The `resolves_to` property tells your domain how to resolve requests. You can specify a list of ngrok physical PoPs (like "Frankfurt" or "California"), [dedicated IPs](/universal-gateway/dedicated-ips/), or both. 
...
For detailed information about Dedicated IPs, including configuration examples, use cases, and pricing, see the [Dedicated IPs](/universal-gateway/dedicated-ips/) documentation.
...
Dedicated IPs and Regional Resolution ("region pinning") share the same `resolves_to` field on the domain. See the [Dedicated IPs](/universal-gateway/dedicated-ips/) documentation for detailed configuration examples.
