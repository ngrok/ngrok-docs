...
You are limited to 100 region-pinned domains, but this matches the limit for _total_ domains, so most customers won't notice. [Learn more about limits](https://ngrok.com/docs/pricing-limits)

<Warning>
Note: this feature is temporarily free to use on the Pay-as-you-Go plan. 

Billing & metering will be enabled soon, so if you use this feature, be aware you may start seeing these charges at any time. When that happens, we will update these docs; but you can always monitor your ngrok usage [in the dashboard](https://dashboard.ngrok.com/billing). 
</Warning>
