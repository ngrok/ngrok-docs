...
This command updates the `authtoken` property in your [ngrok configuration file](/gateway/agent/config).

Use a separate authtoken for each agent you configure. You can [provision additional authtokens on your ngrok dashboard](https://dashboard.ngrok.com/authtokens) or [via API](/gateway/agent/config/v3/#authtoken). Separate authtokens isolate the security risk
