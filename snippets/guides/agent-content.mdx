...
Follow the [Agent CLI Quickstart](/gateway/endpoints/agent-cli-quickstart/) or visit the [download page](https://download.ngrok.com) to install and set up the ngrok agent.
