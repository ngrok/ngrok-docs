...
Follow the [Agent CLI Quickstart](/gateway/endpoints/agent-cli-quickstart/#install-the-ngrok-agent-cli) or visit the [download page](https://download.ngrok.com) to install and set up the ngrok agent.
