...
ngrok has exclusive access to its infrastructure and only ngrok software is distributed via it.
See [the FAQ page](/faq#does-ngrok-own-bin-equinox-io) for more.
</Note>
