...
Follow the [Agent CLI Quickstart](/endpoints/agent-cli-quickstart/#1-install-the-ngrok-agent-cli) or visit the [download page](https://download.ngrok.com) to install and set up the ngrok agent.
...
connects to the ngrok service. This address resolves to a [dynamic set of IP Addresses](/domains/ip-addresses/).
