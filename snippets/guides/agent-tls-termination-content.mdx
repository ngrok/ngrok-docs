...
<Tip>
If your service doesn't support TLS termination, you can still use Agent TLS termination with [Zero-Knowledge TLS](/domains/tls-termination/#end-to-end-encryption).
</Tip>
...
<Note>
This is different from mTLS terminated at the ngrok edge via [the `terminate-tls` Traffic Policy action](/domains/mtls-termination/).
