...
When you use [endpoint pooling](/endpoints/endpoint-pooling), ngrok will automatically distribute traffic to the closest upstream if you run geographically distributed copies of your upstream application or service.
