...
![Architecture diagram showing Kubernetes Bindings with ngrok routing from an Acme Cloud cluster through ngrok Cloud Endpoints and Internal Agent Endpoints to a customer on-premises network](/img/guides/k8s-bindings-architecture-diagram.png)
...
![ngrok dashboard New Service User dialog with a name field set to Service User for Customer 1](/img/guides/new-service-user-dialog-customer.png)
...
![ngrok New Authtoken dialog with owner set to a Service User and an ACL rule restricting it to bind:*.cust1.internal endpoints](/img/guides/new-authtoken-service-user-acl-binding.png)
...
![ngrok New Cloud Endpoint dialog with Kubernetes Operator binding selected and URL set to http://webapp-cust1.acme-customers](/img/guides/new-cloud-endpoint-kubernetes-binding.png)
