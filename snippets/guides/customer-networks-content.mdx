...
- An ngrok agent configured on a server within customer 1's network. See the [Agent CLI Quickstart](/gateway/agent-cli-quickstart/) for instructions on how to install the ngrok agent.
