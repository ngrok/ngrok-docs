...
ngrok's [Traffic Identities](/traffic-policy/identities/) feature can be used to observe all of the authenticated user activity across your account in the ngrok dashboard or via the API.
Whenever a user authenticates or accesses an endpoint with a configured OAuth action, their Traffic Identity record is created or updated.
