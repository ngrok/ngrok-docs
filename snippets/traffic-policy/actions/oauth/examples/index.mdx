import BasicExample from "/snippets/traffic-policy/actions/oauth/examples/basic-example.mdx"; import CustomProviders from "/snippets/traffic-policy/actions/oauth/examples/custom-providers.mdx";
