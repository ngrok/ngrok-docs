<Config>
  ...
  <ConfigField
    title="actions.ngrok.oauth.identity.provider_user_id" type="string" >
    <p>Identifier for the authorized user from the provider.</p>
  </ConfigField>
  <ConfigField
    title="actions.ngrok.oauth.identity.current_provider_session_id" type="string" >
  ...
  <ConfigField
    title="actions.ngrok.oauth.session_max_duration_reached" type="boolean" >
