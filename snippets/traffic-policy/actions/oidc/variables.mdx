<Config>
  ...
  <ConfigField
    title="actions.ngrok.oidc.identity.provider_user_id" type="string" >
    <p>Identifier for the authorized user from the provider.</p>
  </ConfigField>
  <ConfigField
    title="actions.ngrok.oidc.identity.current_session_id" type="string" >
  ...
  <ConfigField
    title="actions.ngrok.oidc.session_max_duration_reached" type="boolean" >
