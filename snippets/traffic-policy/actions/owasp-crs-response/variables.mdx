import { Config, ConfigChildren, ConfigField, ConfigEnum, ConfigEnumOption, } from "/snippets/ConfigTable.jsx";
...
<Config>
  ...
  <ConfigField
    title="actions.ngrok.owasp_crs_response.anomaly_score" type="int" >
    <p>
  ...
  <ConfigField
    title="actions.ngrok.owasp_crs_response.anomaly_score_threshold" type="int" >
    <p>
  ...
  <ConfigField
    title="actions.ngrok.owasp_crs_response.error.code" type="string" >
    <p>
      A machine-readable code describing an error that occurred during the action's execution.
    </p>
  </ConfigField>
  <ConfigField
    title="actions.ngrok.owasp_crs_response.error.message" type="string" >
    <p>
