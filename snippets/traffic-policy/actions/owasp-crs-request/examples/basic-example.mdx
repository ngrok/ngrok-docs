...
In this example, we attempt to connect to `example.ngrok.app` using the `curl` command, and ngrok blocks the request returning back [ERR_NGROK_3700](/errors/err_ngrok_3700/)
