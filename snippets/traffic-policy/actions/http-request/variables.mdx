...
<Config>
  <ConfigField
    title="actions.ngrok.http_request.error.code" type="string" ></ConfigField>
  ...
  <ConfigField
    title="actions.ngrok.http_request.attempts" type="array of objects" >
    ...
    <ConfigChildren>
      ...
      <ConfigField title="attempts[i].response_time_ms" type="string">
        <p>Time it took to receive the response.</p>
      </ConfigField>
    </ConfigChildren>
  </ConfigField>
  ...
  <ConfigField title="actions.ngrok.http_request.res" type="object">
    <p>
      The last attempted HTTP response.
      Unlike `actions.ngrok.attempts[i]` this variable also contains the response body.
    </p>
    <ConfigChildren>
