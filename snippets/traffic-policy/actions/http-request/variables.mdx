...
<Config>
  <ConfigField title="actions.ngrok.http_request.error.code" type="string"></ConfigField>
  ...
  <ConfigField title="actions.ngrok.http_request.res" type="object">
    <p>The last attempted HTTP response. Unlike `actions.ngrok.attempts[i]` this variable also contains the response body.</p>
    <ConfigChildren>
