...
It is recommended to check this variable at the start of any policy that relies on pod identity. See [Restricting Access by Kubernetes Pod Identity](/gateway/k8s/guides/how-to/pod-identity) for guidance on handling missing identity.
