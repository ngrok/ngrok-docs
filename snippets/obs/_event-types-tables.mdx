...
import HTTPRequestComplete from "/snippets/obs/events/reference/_http-request-complete.mdx";
...
import TCPConnectionClosed from "/snippets/obs/events/reference/_tcp-connection-closed.mdx";
