...
| conn.client_ip | string | The source IP of the TCP connection to the ngrok edge | Yes |
| conn.server_ip | string | The IP address of the server that received the request | Yes |
| conn.server_name | string | The hostname associated with this connection. | Yes |
| conn.server_port | int32 | The port that the connection for this request came in on | Yes |
...
| ja4_fingerprint | string | The JA4 fingerprint of the client TLS handshake |
...
| oauth.user.application_user_id | string | The ngrok application user ID for the authenticated OAuth user |
| oauth.user.email | string | The authenticated user's email returned by the OAuth provider |
...
| principal.email | string | The ngrok IAM principal email for the private endpoint connection |
| principal.id | string | The ngrok IAM principal ID for the private endpoint connection |
| principal.name | string | The ngrok IAM principal name for the private endpoint connection |
