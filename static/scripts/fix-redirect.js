...
const redirects = [
    ...
    [ fromIncludes(`/docs/cloud-edge/zero-knowledge-tls/`), `/docs/agent/agent-tls-termination/` ],
    [ fromIncludes(`/docs/tls/tls/termination/`), `/docs/agent/agent-tls-termination/` ],
